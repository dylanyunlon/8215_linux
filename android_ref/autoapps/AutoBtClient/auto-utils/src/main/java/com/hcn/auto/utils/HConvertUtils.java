...
public class HConvertUtils {
    ...
    public static double byte2MemorySize(long byteSize, int unit) {
        return byteSize < 0L ? -1.0 : (double)byteSize / (double)unit;
    }
    ...
    public static String byte2FitMemorySize(long byteSize, int precision) {
        if (precision < 0) {
            ...
            return byteSize < 1073741824L ? String.format("%." + precision + "fMB", (double)byteSize / 1048576.0) : String.format("%." + precision + "fGB", (double)byteSize / 1.073741824E9);
        }
    }
    ...
    public static int dp2px(float dpValue) {
        return HSizeUtils.dp2px(dpValue);
    }

    public static int px2dp(float pxValue) {
        return HSizeUtils.px2dp(pxValue);
    }

    public static int sp2px(float spValue) {
        return HSizeUtils.sp2px(spValue);
    }

    public static int px2sp(float pxValue) {
        return HSizeUtils.px2sp(pxValue);
    }
