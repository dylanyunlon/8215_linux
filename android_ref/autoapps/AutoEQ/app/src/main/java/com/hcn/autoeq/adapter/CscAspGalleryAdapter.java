 ...
 * 可无限循环的 adapter
 */
public class CscAspGalleryAdapter extends PagerAdapter {

    private static final String TAG = CscAspGalleryAdapter.class.getSimpleName();
    ...
    public CscAspGalleryAdapter(Context context, List<Drawable> drawableList, String[] nameList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        View view = SkinUtils.inflate(R.layout.csc_asp_gallery_band_reverb_item);
