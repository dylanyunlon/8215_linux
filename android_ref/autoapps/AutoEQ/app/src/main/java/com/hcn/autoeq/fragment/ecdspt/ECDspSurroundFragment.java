...
public class ECDspSurroundFragment extends BaseFragment implements CompoundButton.OnCheckedChangeListener {

    private static final String TAG = ECDspSurroundFragment.class.getSimpleName();
    ...
    public ECDspSurroundFragment() {
    }

    public static ECDspSurroundFragment newInstance() {
        ECDspSurroundFragment fragment = new ECDspSurroundFragment();
        return fragment;
    }

    @Override
    public int getLayoutRes() {
        if (checkLayoutExists(R.layout.ext_c_dsp_fragment_surround)) {
            return R.layout.ext_c_dsp_fragment_surround;
        } else {
