 ...
 * author：zjk
 */
public class ExtDspBandSecondFragment extends BaseFragment
        implements ConstantExtDsp
        , SeekBar.OnSeekBarChangeListener
        , View.OnClickListener {

    private static final String TAG = ExtDspBandSecondFragment.class.getSimpleName();
    ...
    public ExtDspBandSecondFragment() {
    }

    public static ExtDspBandSecondFragment newInstance() {
        ExtDspBandSecondFragment fragment = new ExtDspBandSecondFragment();
        return fragment;
    }
    ...
    private void refreshBtnTopReverbActivityStatus(int reverb) {
        ...
        switch (reverb) {
            case ConstantExtDsp.EXT_DSP_REVERB_NEWS:
            case ConstantExtDsp.EXT_DSP_REVERB_JAZZ:
            case ConstantExtDsp.EXT_DSP_REVERB_CITY:
            case ConstantExtDsp.EXT_DSP_REVERB_POP:
            case ConstantExtDsp.EXT_DSP_REVERB_ELECTRONIC:
            case ConstantExtDsp.EXT_DSP_REVERB_CLASSIZ:
            case ConstantExtDsp.EXT_DSP_REVERB_MOVIE:
            case ConstantExtDsp.EXT_DSP_REVERB_ROCK:
            case ConstantExtDsp.EXT_DSP_REVERB_TECHNO:
