...
import com.hcn.autoeq.fragment.siextdsp.SIExtDspHLPFFragment;
import com.hcn.autoeq.util.EqUtils;
import com.hcn.autoeq.util.SkinUtils;

import java.util.ArrayList;

public class ExtDspFilterFragment extends BaseFragment {
    ...
    public ExtDspFilterFragment() {
    }

    public static ExtDspFilterFragment newInstance() {
        ExtDspFilterFragment fragment = new ExtDspFilterFragment();
        return fragment;
    }
    ...
    public int getLayoutRes() {
        if (EqUtils.DSP_CHIP_SI47925.equals(EqUtils.getEqChipType())) {
            return R.layout.siextdsp_fragment_filter;
        }
    ...
    private void initFragment() {
        ...
        if (EqUtils.DSP_CHIP_SI47925.equals(EqUtils.getEqChipType())) {
            fragments.add(SIExtDspHLPFFragment.newInstance());
        } else {
            fragments.add(ExtDspHLPFFragment.newInstance());
        }
        fragments.add(ExtDspDbbFragment.newInstance());
        fragments.add(ExtDspSurroundFragment.newInstance());
    }
