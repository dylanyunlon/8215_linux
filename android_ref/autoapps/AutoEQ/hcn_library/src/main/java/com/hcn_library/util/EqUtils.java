...
public class EqUtils {
    ...
    public static final String DSP_CHIP_7739 = "ak7739";

    public static final String DSP_CHIP_SI47925 = "si479x";
    public static final String DSP_CHIP_SI47925_DTS = "si479xDts";
    ...
    public final static String KEY_SKIN_GB04 = "gb04";
    public final static String KEY_SKIN_GB05 = "gb05";
    ...
    private static String eqChipType = null;
    public static String getEqChipType() {
        if (eqChipType == null) {
            eqChipType = SystemUtils.getSystemProperty(KEY_DSP_CHIP, "NULL");
        }
        return eqChipType;
    }
    ...
    public static int getBandTotal() {
        ...
        if (String.valueOf(BAND_TOTAL_32).equals(band)) {
            ...
            if (DSP_CHIP_SI47925.equals(getEqChipType()) || DSP_CHIP_SI47925_DTS.equals(getEqChipType())
            || EqUtils.isChip7739()) {
...
//        Configuration config = SkinCompatResources.getInstance().getSkinResources().getConfiguration();
    ...
    static public boolean isChip7739() {
        return EqUtils.DSP_CHIP_7739.equals(EqUtils.getEqChipType());
    }
}
