...
/**
 * GLView 渲染器
 * <p> 在 VidEffects 的基础上调整的;
 * @author 65821
 */
@SuppressLint("ViewConstructor")
public class FunVideoGLViewSimpleRender extends FunVideoGLViewBaseRender {
    ...
    private FunVideoShotListener mVideoShotListener;

    private FunVideoGLView.ShaderInterface mEffect = new NoEffect();

    public FunVideoGLViewSimpleRender() {
        ...
        if (mTakeShotPic) {
            ...
            if (mVideoShotListener != null) {
                Bitmap bitmap = createBitmapFromGLSurface(
                        0, 0, mSurfaceView.getWidth(), mSurfaceView.getHeight(), glUnused);
