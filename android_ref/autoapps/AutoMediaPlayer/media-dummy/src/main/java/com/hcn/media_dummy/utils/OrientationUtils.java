...
public class OrientationUtils {
    ...
    private FunBaseVideoPlayer mVideoPlayer;
     ...
     * 构造函数
     *
     * @param activity 活动组件对象
     * @param funVideoPlayer 播放器
     */
    public OrientationUtils(Activity activity,
                            FunBaseVideoPlayer funVideoPlayer) {
        this(activity, funVideoPlayer, null);
    }
    ...
    public OrientationUtils(Activity activity,
        ...
        this.mVideoPlayer = funVideoPlayer;
    ...
    protected void init() {
        ...
        mOrientationEventListener = new OrientationEventListener(context) {
            ...
            public void onOrientationChanged(int rotation) {
                boolean autoRotateOn = (Settings.System.getInt(
                            ...
                            if (!mIsOnlyRotateLand) {
                                ...
                                if (mVideoPlayer.getFullscreenButton() != null) {
                                    if (mVideoPlayer.isIfCurrentIsFullscreen()) {
                                        mVideoPlayer.getFullscreenButton()
                                                .setImageResource(mVideoPlayer.getShrinkImageRes());
                                    } else {
                                        mVideoPlayer.getFullscreenButton()
                                                .setImageResource(mVideoPlayer.getEnlargeImageRes());
                                    }
                                }
                                mIsLand = LAND_TYPE_NULL;
                            }
    ...
    private void setRequestedOrientation(int requestedOrientation) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.O
                ...
                LogUtils.wTag("OrientationUtils", exception);
            } else {
