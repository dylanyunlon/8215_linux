...
/**
 * 下载视图
 * <p> https://github.com/codeestX/ENViews
 *
 * @author 65821
 */
        ...
        switch (mCurrentState) {
            case STATE_PRE:
                if (mFraction <= 0.4f) {
                    ...
                    canvas.drawLine(
                            mCenterX,
                            mCenterY + mBaseLength - 1.3f * mBaseLength / 0.4f * mFraction,
                            mCenterX,
                            mCenterY - 1.6f * mBaseLength + 1.3f * mBaseLength / 0.4f * mFraction,
                            mPaint);
                } else if (mFraction <= 0.6f) {
                    canvas.drawCircle(mCenterX, mCenterY, mCircleRadius, mBgPaint);
                    canvas.drawCircle(
                            mCenterX,
                            mCenterY - 0.3f * mBaseLength,
                            2,
                            mPaint);
                    canvas.drawLine(
                    ...
                    canvas.drawCircle(
                            mCenterX,
                            mCenterY - mCircleRadius - mBaseLength * 3 * (mFraction - 1),
                            3,
                            mPaint);
                    canvas.drawLine(
                            mCenterX - mBaseLength * 2.2f,
            ...
            case STATE_DOWNLOADING:
                ...
                for (int i = 0; i < 4; i++) {
                    mPath.rQuadTo(mBaseRippleLength,
                            -(1 - mFraction) * mBaseRippleLength,
                            mBaseRippleLength * 2,
                            0);
                    mPath.rQuadTo(mBaseRippleLength,
                            (1 - mFraction) * mBaseRippleLength,
                ...
                if (mUnit != DownloadUnit.NONE && mCurrentSize > 0) {
                    /// canvas.drawText(
                    ///          String.format("%.2f", mCurrentSize) + getUnitStr(mUnit),
                    ///          mCenterX ,
                    ///          mCenterY + 1.4f * mBaseLength ,
                    ///          mTextPaint);
                }
                break;
            case STATE_END:
                ...
                canvas.drawLine(
                        mCenterX - mBaseLength * 2.2f + mBaseLength * 1.2f * mFraction,
                        mCenterY,
                        mCenterX - mBaseLength * 0.5f,
                ...
                canvas.drawLine(
                        ...
                        mCenterY - mBaseLength * mFraction * 1.3f,
                        mPaint);
                break;
            case STATE_RESET:
                canvas.drawCircle(mCenterX, mCenterY, mCircleRadius, mBgPaint);
                ...
                canvas.drawLine(mCenterX - mBaseLength * 0.5f + mBaseLength * 0.5f * mFraction,
                        mCenterY + mBaseLength * 0.65f + mBaseLength * 0.35f * mFraction,
                        mCenterX - mBaseLength * 0.5f + mBaseLength * 0.5f * mFraction,
                        mCenterY + mBaseLength * 0.65f - mBaseLength * 2.25f * mFraction,
                        mPaint);
                break;
            default:
                break;
