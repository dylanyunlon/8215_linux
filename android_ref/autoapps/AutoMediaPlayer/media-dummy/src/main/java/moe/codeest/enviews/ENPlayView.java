...
public class ENPlayView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mRectF = new RectF(
                ...
                mCenterY + 0.6f * mCircleRadius,
                mCenterX + mCircleRadius,
                mCenterY + 2.6f * mCircleRadius);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawCircle(mCenterX, mCenterY, mWidth / 2.0f, mBgPaint);
        ...
        if (mFraction < 0) {
            ...
            canvas.drawLine(
                    ...
                    mCenterX - mCircleRadius,
                    mCenterY + 1.6f * mCircleRadius, mPaint);
