...
public class MediaScanner {
    private static final String[] VIDEO_PROJECTION =
            new String[]{Video.Media._ID, Video.Media.DATA, Video.Media.DATE_MODIFIED,};
    ...
    private class MyMediaScannerClient implements MediaScannerClient {
        ...
        public void handleStringTag(String name, byte[] valueBytes, String valueEncoding) {
            ...
            if ("title".equalsIgnoreCase(name)) {
                ...
                mArtist = value.trim();
            } else if ("albumartist".equalsIgnoreCase(name)) {
        ...
        public void addNoMediaFolder(String path) {
            ...
            try {
                mProvider.update(Video.Media.CONTENT_URI,
                        values, MediaStore.MediaColumns.DATA + " LIKE ?", pathSpec);
            } catch (RemoteException e) {
