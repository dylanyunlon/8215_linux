...
public class OutlineTextView extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        @SuppressLint("DrawAllocation")
        Layout layout = new StaticLayout(getText(), mTextPaintOutline, getWidth(),
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Layout layout = new StaticLayout(getText(), mTextPaintOutline,
                measureWidth(widthMeasureSpec), Layout.Alignment.ALIGN_CENTER, mSpacingMult, mSpacingAdd, mIncludePad);
