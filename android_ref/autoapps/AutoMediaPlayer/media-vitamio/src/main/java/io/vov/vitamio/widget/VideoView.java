...
public class VideoView extends SurfaceView
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                new AlertDialog.Builder(mContext)
                        ...
                        .setMessage(message)
                        .setPositiveButton(
                                getResources().getIdentifier("VideoView_error_button", "string", mContext.getPackageName()),
    ...
    public void setVideoLayout(int layout, float aspectRatio) {
        ...
        Log.d("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f",
                mVideoWidth, mVideoHeight, mVideoAspectRatio, mSurfaceWidth, mSurfaceHeight,
    ...
    private void openVideo() {
        ...
        try {
            ...
            mMediaPlayer.setVideoChroma(
                    mVideoChroma == MediaPlayer.VIDEOCHROMA_RGB565 ?
    ...
    public void setVideoChroma(int chroma) {
        // PixelFormat.RGB_565
        getHolder().setFormat(
                chroma == MediaPlayer.VIDEOCHROMA_RGB565 ?
    ...
    public SparseArray<MediaFormat> getAudioTrackMap(String encoding) {
        if (mMediaPlayer != null) {
            return mMediaPlayer.findTrackFromTrackInfo(
                    TrackInfo.MEDIA_TRACK_TYPE_AUDIO, mMediaPlayer.getTrackInfo(encoding));
        }
        return null;
    }
