...
static const char* const kClassPathName = "com/hcn/metadata/FFmpegMediaMetadataRetriever";
...
static void
com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSourceAndHeaders(
...
static void com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSource(
        JNIEnv *env, jobject thiz, jstring path) {
    com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSourceAndHeaders(
...
static void com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSourceFD(JNIEnv *env, jobject thiz, jobject fileDescriptor, jlong offset, jlong length)
{
    __android_log_write(ANDROID_LOG_VERBOSE, LOG_TAG, "setDataSource");
    MediaMetadataRetriever* retriever = getRetriever(env, thiz);
    if (retriever == 0) {
...
static jbyteArray com_hcn_metadata_FFmpegMediaMetadataRetriever_getFrameAtTime(JNIEnv *env, jobject thiz, jlong timeUs, jint option)
{
...
static jbyteArray com_hcn_metadata_FFmpegMediaMetadataRetriever_getScaledFrameAtTime(JNIEnv *env, jobject thiz, jlong timeUs, jint option, jint width, jint height)
{
...
static jbyteArray com_hcn_metadata_FFmpegMediaMetadataRetriever_getEmbeddedPicture(JNIEnv *env, jobject thiz)
{
...
static jobject com_hcn_metadata_FFmpegMediaMetadataRetriever_extractMetadata(JNIEnv *env, jobject thiz, jstring jkey)
{
...
static jobject com_hcn_metadata_FFmpegMediaMetadataRetriever_extractMetadataFromChapter(JNIEnv *env, jobject thiz, jstring jkey, jint chapter)
{
...
static jobject
com_hcn_metadata_FFmpegMediaMetadataRetriever_getMetadata(JNIEnv *env, jobject thiz, jboolean update_only,
...
static void com_hcn_metadata_FFmpegMediaMetadataRetriever_release(JNIEnv *env, jobject thiz)
{
...
// set the surface
static void com_hcn_metadata_FFmpegMediaMetadataRetriever_setSurface(JNIEnv *env, jclass thiz, jobject surface)
{
...
static void com_hcn_metadata_FFmpegMediaMetadataRetriever_native_finalize(JNIEnv *env, jobject thiz)
{
    //__android_log_write(ANDROID_LOG_INFO, LOG_TAG, "native_finalize");
    // No lock is needed, since Java_com_hcn_metadata_FFmpegMediaMetadataRetriever_release() is protected
    com_hcn_metadata_FFmpegMediaMetadataRetriever_release(env, thiz);
}

static void com_hcn_metadata_FFmpegMediaMetadataRetriever_native_init(JNIEnv *env, jobject thiz)
{
...
static void com_hcn_metadata_FFmpegMediaMetadataRetriever_native_setup(JNIEnv *env, jobject thiz)
{
...
static JNINativeMethod nativeMethods[] = {
    {"setDataSource", "(Ljava/lang/String;)V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSource},
    
    {
         "_setDataSource",
         "(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V",
         (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSourceAndHeaders
    },
    
    {"setDataSource", "(Ljava/io/FileDescriptor;JJ)V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_setDataSourceFD},
    {"_getFrameAtTime", "(JI)[B", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_getFrameAtTime},
    {"_getScaledFrameAtTime", "(JIII)[B", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_getScaledFrameAtTime},
    {"extractMetadata", "(Ljava/lang/String;)Ljava/lang/String;", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_extractMetadata},
    {"extractMetadataFromChapter", "(Ljava/lang/String;I)Ljava/lang/String;", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_extractMetadataFromChapter},
    {"native_getMetadata", "(ZZLjava/util/HashMap;)Ljava/util/HashMap;", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_getMetadata},
    {"getEmbeddedPicture", "()[B", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_getEmbeddedPicture},
    {"release", "()V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_release},
    {"setSurface", "(Ljava/lang/Object;)V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_setSurface},
    {"native_finalize", "()V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_native_finalize},
    {"native_setup", "()V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_native_setup},
    {"native_init", "()V", (void *)com_hcn_metadata_FFmpegMediaMetadataRetriever_native_init},
};

// This function only registers the native methods, and is called from
// JNI_OnLoad in com_hcn_metadata_FFmpegMediaMetadataRetriever.cpp
int register_com_hcn_metadata_FFmpegMediaMetadataRetriever(JNIEnv *env)
{
    int numMethods = (sizeof(nativeMethods) / sizeof( (nativeMethods)[0]));
    jclass clazz = env->FindClass("com/hcn/metadata/FFmpegMediaMetadataRetriever");
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    if (register_com_hcn_metadata_FFmpegMediaMetadataRetriever(env) < 0) {
