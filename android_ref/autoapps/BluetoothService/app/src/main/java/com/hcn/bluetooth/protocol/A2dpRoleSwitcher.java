...
public class A2dpRoleSwitcher {
    ...
    private A2dpRoleSwitcher(Context context) {
        mContext = context;
        LocalBluetoothManager mBluetoothManager=LocalBluetoothManager.getInstance(
                mContext,null);
        mProfileManager = mBluetoothManager.getProfileManager();
        mDeviceManager = mBluetoothManager.getCachedDeviceManager();
