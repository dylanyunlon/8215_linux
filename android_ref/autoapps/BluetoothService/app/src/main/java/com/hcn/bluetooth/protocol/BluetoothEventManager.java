...
import com.hcn.bluetooth.MyApplication;
...
public final class BluetoothEventManager {
    ...
    BluetoothEventManager(LocalBluetoothAdapter adapter,
        ...
        //10.0版本系统去掉了BluetoothDevice.ACTION_DISAPPEARED,为兼容旧版本，直接用定义的字符串
    ...
    private class BondStateChangedHandler implements Handler {
        ...
        private void showUnbondMessage(Context context, String name, int reason) {
            ...
            showError(context, name, errorMsg);
        }
        
        public void showError(Context context, String name, int messageResId) {
