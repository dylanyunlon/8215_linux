...
public class PhoneCallView extends PhoneCallViewBase implements OnClickListener {
    ...
    //ZXUI通话动画
    private static AnimationDrawable _animaition = null;
    private ImageView bt_calling_image = null;

    public PhoneCallView(Context context, WindowManager wm, AudioManager am) {
        super(context, wm, am);
...
//                break;
    ...
    protected void initView() {
        ...
        setTextMarquee(callingNameView);
        //add lhr
//        if(BtUtils.isZXUI()) {
//            bt_calling_image = findViewById(R.id.bt_calling_image);
//        }
        //end
...
//        mMicMuteBtn = findViewById(R.id.btn_disable_mic);
//        if (null != mMicMuteBtn) {
...
//        }
    ...
    /**
     * 设置跑马灯效果:解决8581平台xml配置跑马灯效果不生效的问题
     *
     * @param textView
     */
    public static void setTextMarquee(TextView textView) {
        if (textView != null) {
            Log.d(TAG, "setTextMarquee: " + textView.getEllipsize());
...
//                    if(BtUtils.isZXUI()){
//
//                        bt_calling_image.setBackground(getResources().getDrawable(R.drawable
//                        .zx_calling_animation));
//                        _animaition=(AnimationDrawable)bt_calling_image.getBackground();
//                        _animaition.start();
//                    }
                    break;
...
//        if (mute) {
//            mMicMuteBtn.setBackgroundResource(R.drawable.skpad_mic_disable);
//        } else {
//            mMicMuteBtn.setBackgroundResource(R.drawable.skpad_mic_enable);
//        }
