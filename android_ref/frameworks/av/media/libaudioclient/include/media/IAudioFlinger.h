...
public:
    ...
    // @Tag: HCN2024_T
    virtual     void        setSessionVolume(audio_session_t session, int percentage) = 0;
    virtual     void        setSessionFadeout(audio_session_t session, int duration) = 0;
    virtual     void        setStreamsMute(int32_t mask) = 0;
...
public:
    ...
    // @Tag: HCN2024_T
    void setSessionVolume(audio_session_t session, int percentage) override;
    void setSessionFadeout(audio_session_t session, int duration) override;
    void setStreamsMute(int32_t mask) override;
...
public:
    ...
    public:
        ...
        enum class TransactionCode {
            ...
            // @Tag: HCN2024_T
            SET_SESSION_VOLUME = media::BnAudioFlingerService::TRANSACTION_setSessionVolume,
            SET_SESSION_FADEOUT = media::BnAudioFlingerService::TRANSACTION_setSessionFadeout,
            SET_STREAMS_MUTE = media::BnAudioFlingerService::TRANSACTION_setStreamsMute,
        };
    ...
    // @Tag: HCN2024_T
    Status setSessionVolume(int32_t session, int32_t percentage) override;
    Status setSessionFadeout(int32_t session, int32_t duration) override;
    Status setStreamsMute(int32_t mask) override;
private:
