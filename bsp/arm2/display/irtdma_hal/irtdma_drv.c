...
extern unsigned int irt_dma_base ;
...
static INT32 IrtDmaHwRotateMirror(UINT32 *u4SrcYSa,UINT32 *u4SrcCSa,UINT32 *u4DstYSa, UINT32 *u4DstCSa,UINT32 u4Width, UINT32 u4Height, IRT_DMA_MODE_T eMode)
{
	...
	if((u4SrcYSa == NULL) || (u4SrcCSa == NULL) || (u4DstYSa == NULL) || (u4DstCSa == NULL)) 
	{
		IRD_LOG(IRD_LOG_LVL_ERR, "buffer is null \r\n");
		return -1;
	}
...
{
	IRD_LOG(IRD_LOG_LVL_DBG,"call irtdma_rotate\n");
