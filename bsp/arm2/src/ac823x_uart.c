...
#define SOURCE_CLOCK             27000000    //32400000
//------------------------------------------------------------------------------
//
...
static BOOL SetBaudRate(ULONG baudRate)
{
	...
	{
	    case 115200:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_115200 << 8);
			break;
			
		case 230400:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_230400 << 8);
			break;
			
		case 460800:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_460800 << 8);
			break;
			
		case 921600:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_921600 << 8);
			break;
			
		case 57600:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_57600 << 8);
			break;

		case 38400:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_38400 << 8);
			break;

		case 19200:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_19200 << 8);
			break;

		case 9600:
			pUartRegs->U4_CCR = (pUartRegs->U4_CCR &(~(0xf << 8))) | (UART_9600 << 8);
			break;
...
{	
	...
	{
		case 1:
			g_pUart1Regs = (AC83XX_UART_REG *)(0x1000C040);
			break;
			
		case 2:
			g_pUart1Regs = (AC83XX_UART_REG *)(0x1000C0c0);
			break;
			
		case 3:
			g_pUart1Regs = (AC83XX_UART_REG *)(0x1000C100);
			break;
			
		case 4:
			g_pUart1Regs = (AC83XX_UART_REG *)(0x1000C140);
			break;
			
		case 5:
			g_pUart1Regs = (AC83XX_UART_REG *)(0x1000C180);
			break;
	}
    g_pUart1Regs->U4_BCR = 0xFFF0100;
