 ...
 *   kernel tree.
 *
 *   $Id: //CNB/AC8317/DEV_BR/linux/atc_linux/bootloader/uboot/uboot-83xx/common/cmd_mtdparts.c#1 $
...
#ifdef CONFIG_CMD_MTDPARTS_SHOW_NET_SIZES
/**
...
/*
			parts = getenv("mtdparts");
			if (parts !=NULL || strcmp(parts,"<NULL>"))
			{
			    printf("do_mtdparts use env mtdparts string:%s \r\n",parts);
			}
			else
			{
			     printf("do_mtdparts use static mtdparts string:%s\r\n",mtdparts_default);
