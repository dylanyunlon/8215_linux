 ...
 * Name: mmcGetImage
 *
 * Description: Get  image (such as DVD.bin, xxx_linux_demo_dbg.bin) from USB
 *
 * Inputs:    	None
 ...
 * Name: mmcFindFile
 *
 * Description: find file by name(such as DVD.bin, xxx_linux_demo_dbg.bin) from MMC/directory
 *
 * Inputs:    	None
