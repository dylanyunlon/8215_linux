 ...
 * Name: usbGetImage
 *
 * Description: Get  image (such as DVD.bin, ac83xx_linux_demo_dbg.bin) from USB
 *
 * Inputs:    	None
 ...
 * Name: usbFindFile
 *
 * Description: find file by name(such as DVD.bin, ac83xx_linux_demo_dbg.bin) from USB/directory
 *
 * Inputs:    	None
