...
#define PDWNC_UCV_BASE 0
//wj add
#define GPIO_PDWNC_READ(i4Addr)                ReadReg32((PDWNC_UCV_BASE + (i4Addr))) 
#define GPIO_PDWNC_WRITE(i4Addr, u4Val)        WriteReg32((PDWNC_UCV_BASE + (i4Addr)),(u4Val))
