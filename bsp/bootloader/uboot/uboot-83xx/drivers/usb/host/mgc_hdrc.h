...
#define MUSB_BASE                            (0x0E000)
#define MUSB_BASE2	        				(0x3C000)
...
#define USB_DMA_OFFSET				(0x00200)
#define USB_BASE_OFFSET				(0x00000)
...
#define MOTG_PHY_REG_READ32(r) (\
	((UINT32)USB_ADDR == (IO_BASE_USB + (UINT32)MUSB_BASE))?\
	*((volatile UINT32 *)(((IO_BASE_USB + (UINT32)MUSB_BASE) + MUSB_PHYBASE)+ (MUSB_PORT0_PHYBASE) + (r))):\
	*((volatile UINT32 *)(((IO_BASE_USB + (UINT32)MUSB_BASE) + MUSB_PHYBASE)+ (MUSB_PORT1_PHYBASE) + (r)))\
	)

extern void printf(const char *format, ...);
#define MOTG_PHY_REG_WRITE32(r, v) { \
	if((UINT32)USB_ADDR == (IO_BASE_USB + (UINT32)MUSB_BASE)){ \
    printf("USB PHY Port 0\n");\
    *((volatile uint32_t *)(((IO_BASE_USB + (UINT32)MUSB_BASE) + MUSB_PHYBASE)+(MUSB_PORT0_PHYBASE) + (r))) = (v);\
    printf("USB PHY@0x%08X = 0x%08X\n", ((UINT32)(((IO_BASE_USB + (UINT32)MUSB_BASE) + MUSB_PHYBASE)+(MUSB_PORT0_PHYBASE) + (r))), (UINT32)(v));\
    }\
    else if((UINT32)USB_ADDR == (IO_BASE_USB + (UINT32)MUSB_BASE2)){\
    printf("USB PHY Port 1\n");\
    *((volatile uint32_t *)(((IO_BASE_USB + (UINT32)MUSB_BASE) + MUSB_PHYBASE)+ (MUSB_PORT1_PHYBASE) + (r))) = (v);\
    printf("USB PHY@0x%08X = 0x%08X\n", ((UINT32)(((IO_BASE_USB + (UINT32)MUSB_BASE) + MUSB_PHYBASE)+(MUSB_PORT1_PHYBASE) + (r))), (UINT32)(v));\
    }\
}
#else
#define MOTG_PHY_REG_READ32(r)\
...
#define MOTG_REG_WRITE8(r,v)\
    ...
    temp = *((volatile UINT32 *)(USB_ADDR + USB_BASE_OFFSET + ((r) & 0xFFFFFFFC))); \
    temp &= ~(0xFF << (8*((r) & 0x03)));\
    temp |= (volatile UINT32)((v) << (8*((r) & 0x03)));\
    *((volatile UINT32 *)(USB_ADDR + USB_BASE_OFFSET + ((r) & 0xFFFFFFFC))) = temp; \
    }while(0)
