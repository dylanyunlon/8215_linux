...
#define MSDC_SLOT2				(2)
	...
	#define CONFIG_BOOT_SD_SLOT		(MSDC_SLOT2)
	#endif
#endif
...
* TrustZone support
*************************************************************************/
//now trustzone is not ready, do not open it 10.26
#define CONFIG_TRUSTZONE_SUPPORT

//for reduce boot time
/************************************************************************
* use real size to read Image frome emmc/nand  
* otherwise we'll use partition size
*************************************************************************/
#define READ_IMAGE_USE_REAL_SIZE


/************************************************************************
* we will not use ramdisk sooner, so open this MACRO,if so  
*************************************************************************/
#define CONFIG_NOT_USE_RAMDISK



/************************************************************************
* use zImage/Image format for kernel 
*************************************************************************/
//
#define CONFIG_KERNEL_ZIMAGE
#define KERNEL_LOAD_ADDR 0x1008000 
#define FDT_LOAD_ADDR  0x2000000
/************************************************************************
* MACRO for use New partition design or lot
* with it ,some partition flags are added
*************************************************************************/
#define NEW_PARTITION_DESIGN

#define CONFIG_COPY_UPGRADE_SUPPORT 1

/************************************************************************
* define the oldest ATC Upgrade Tool Version that can work with this uboot
* e.g.   0x1700 means Version 1.7.0.0
*************************************************************************/
#define CONFIG_AUT_VERSION  0x1703

/************************************************************************
* MACROS For Config Special Recovery System From Ext SD Card
*************************************************************************/
#define CONFIG_SDAGENT_RECOVERY_MODE   2
#define CONFIG_BOOTUP_IMG_INFO_ON_SD_ADDR   (0x600000)
#define CONFIG_IMG_START_ADDR_ON_SD         0x800000



/************************************************************************
* MACROS For support Feature 
* For config reserve memory node in dts and other feature
*************************************************************************/
//#define CONFIG_DVP_SUPPORT
...
#define MTDIDS_DEFAULT	"nand0=atcnand"
...
//#define MTDPARTS_DEFAULT	"mtdparts=nand0:128k@0(preloader),128k(datazone),1m(uboot),128k(env),1m(arm2),1m(logo),6m(kernel),2m(dvp),-(usrdata)"
//#define MTDPARTS_DEFAULT	"mtdparts=nand0:0x400000@0x0(boot),0x200000@0x400000(env),0x200000@0x600000(arm2),0x400000@0x800000(kernel),0x700000@0x1200000(rootfs),50M@0x2600000(swap),0x400000@0x5800000(dvp),-(usrdata)"
//#define MTDPARTS_DEFAULT	"mtdparts=nand0:0x400000@0x0(boot),0x200000@0x400000(env),0x200000@0x600000(arm2),0x400000@0x800000(kernel),0x700000@0x1200000(rootfs),50M@0x2600000(swap),0x400000@0x5800000(dvp),0x800000@0x5c00000(logo),0x400000@0x6400000(metazone),-(usrdata)"
//#define MTDPARTS_DEFAULT	"mtdparts=nand0:0x400000@0x0(boot),0x200000@0x400000(env),0x200000@0x600000(arm2),0x400000@0x800000(logo),0x600000@0xc00000(kernel),0x200000@0x1200000(rootfs),0x25800000@0x1400000(system),-(usrdata)"
//#define MTDPARTS_DEFAULT	"mtdparts=nand0:0x400000@0x0(boot),0x200000@0x400000(env),0x200000@0x600000(arm2),0x400000@0x800000(logo),0x600000@0xc00000(kernel),0x200000@0x1200000(rootfs),0x25800000@0x1400000(system),0x12c00000@0x26c00000(data),0x6400000@0x39800000(cache),0x400000@0x3fc00000(recovery),0x200000@0x40000000(misc),0x3200000@0x40200000(backup),0x400000@0x43400000(metazone),0x400000@0x43800000(dvp),0x12c00000@0x43c00000(data4write),-(usrdata)"
//only for uboot to find env when do nand boot or upgrade
//#define MTDPARTS_DEFAULT	"mtdparts=nand0:0x400000@0x0(boot),0x200000@0x400000(env),-(usrdata)"
#define MTDPARTS_DEFAULT	"mtdparts=atcnand:0x400000@0x0(boot),0x100000@0x400000(env),-(usrdata)"
...
#define MMCPARTS_DEFAULT	"parts=0x400000@0x0(boot)0,0x200000@0x400000(env)0,0x200000@0x600000(arm2)0,0x400000@0x800000(logo)0,0x400000@0xc00000(kernel)0,0x200000@0x1000000(rootfs)0,600M@0x1200000(system)1,300M@0x26A00000(data)1,100M@0x39600000(cache)1,300M@0x3FA00000(swap)0,0x400000@0x52600000(recovery)0,0x200000@0x52A00000(misc)0,0x3200000@0x52C00000(backup)0,0x400000@0x55E00000(metazone)0,0x400000@0x56200000(dvp)0,300M@0x56600000(data4write)1,-(usrdata)1"

#ifdef CONFIG_BOOT_MMC//EMMC_UPGRADE
#define CONFIG_BOOTARGS		"initrd=0x07000000,0x210000 root=/dev/ram console=ttyMT0,115200 init=/init "MMCPARTS_DEFAULT""
#else
#define CONFIG_BOOTARGS		"initrd=0x07000000,0x210000 root=/dev/ram console=ttyMT0,115200 init=/init "MTDPARTS_DEFAULT""
#endif

//#ifdef CONFIG_CMD_AC83XX_BOOT
//#define CONFIG_BOOTCOMMAND	"nand read 0x8000000 kernel\;nand read 0x8f00000 rootfs\;bootm 0x8000000"
...
#define CONFIG_BOOTCOMMAND	"nand read 0x6000000 kernel\;nand read 0x7000000 rootfs\;bootm 0x6000000"
	...
	#define CONFIG_RECOVERY_BOOTCMD  "mmc read 0 0x6000000 0x6000 0x2000\;mmc read 0 0x7000000 0x293000 0x1000\;bootm 0x6000000"
	...
	#define CONFIG_RECOVERY_BOOTCMD  "mmc read 2 0x6000000 0x6000 0x2000\;mmc read 2 0x7000000 0x293000 0x1000\;bootm 0x6000000"
#endif
...
//#define CONFIG_MSDC_ETT		/* Build MSDC ETT uboot binary */
#define CONFIG_NAND_DEBUG_VERSION	/* Build for nand uboot test binary */
//#define CONFIG_NAND_UPDATE_CHECK	/* verify while updating from sd card */

#define CFG_LONGHELP	/* undef to save memory	    */
#ifdef CONFIG_MSDC_ETT
#define CONFIG_SYS_PROMPT	"AC83XX MSDC => "	/* Monitor Command Prompt   */
#else
...
#define CONFIG_AC83XX_INPUT	    1

#define CONFIG_AC83XX_I2C       1
#define CONFIG_AC83XX_TOUCH     1
#define CONFIG_AC83XX_TP        1

#define CONFIG_DVP_RESERVED_MEM 1

#define CONFIG_SUPPORT_CHAR	0 //0 --> english 1 --> chinese 2 --> ohter

#if (defined CONFIG_BOOT_MMC) && (defined NEW_PARTITION_DESIGN)
#define CONFIG_EMMC_WRITE_PROTECT_ENABLE  1
#endif

/**************************************************************************
* MACROS For DRAM ADDRESS
* All Address Macros Need to Unify Here to Prevent "Memory Stompping Error"
***************************************************************************/
#define BASE_ADDR               0x1100000
#define NAND_WRITE_BASE_ADDR    0x1100000 //0x19400000 - 0x800000 when using 'write_nand_ex'
#define DATAZONE_LOAD_ADDR      CONFIG_DATAZONE_START  //save partition table
