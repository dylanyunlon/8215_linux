...
{	
//	printk("\n A new nand_read, ofs = 0x%x, len = %d\r\n", (u32)ofs, *len);
	return info->read(info, ofs, *len, (size_t *)len, buf);
}

static inline int nand_write(nand_info_t *info, loff_t ofs, size_t *len, u_char *buf)
{
//	printk("\n A new nand_write, ofs = 0x%x\r\n", (u32)ofs);	
...
{	
//	printf("\n A new nand erase, off = %ld, size = %d\r\n", off, size);
...
int nand_write_ext_image(nand_info_t *nand, u_char *part_name, ulong offset, ulong part_size, 
...
#define RESERVED_FLAG_PART_SIZE   128
#define RESERVED_FLAG_SIZE        48

#define MIN_PARTION_BLOCK_NUM       1024
#define RESERVED_DATA_SIZE          6
#define RESERVED_PAGE_SIZE          2048
#define RESERVED_NUM                3
#define GET_RESERVED_BLOCK_NUM(x)   (((x * RESERVED_DATA_SIZE)/ RESERVED_PAGE_SIZE) + RESERVED_NUM)
