...
CFLAGS += -fPIC -O2 -Wall --sysroot=$(DA_SYSROOT) $(DEBUG_FLAG)
CPPFLAGS += -fPIC -O2 -Wall --sysroot=$(DA_SYSROOT) $(DEBUG_FLAG)
...
all: LOCAL_MODULE
	@$(RM) $(CDEPS) 
	@$(RM) $(CPPDEPS)
	@$(CP) $(LOCAL_MODULE) $(DA_LIBDIR)/bin
	@$(CP) $(LOCAL_MODULE) $(DA_SYSROOT)/usr/bin
...
$(LOCAL_MODULE): $(COBJS) $(CPPOBJS)
	$(CXX) $(CPPFLAGS) $(LFLAGS)  $^ -o $@ $(STATIC_FLAG) $(LOCAL_SHARE_LIBRARIES) -Wl,-soname,$(notdir $@) -Wl,--whole-archive $(LOCAL_STATIC_LIBRARIES) -Wl,--no-whole-archive
