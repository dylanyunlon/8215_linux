...
include $(DA_TOP)/$(TOP_MAKE)/definition.mak
include $(DA_TOP)/$(TOP_MAKE)/path.mak
include $(DA_TOP)/$(TOP_MAKE)/host.mak
include $(DA_TOP)/$(TOP_MAKE)/toolchain.mak
#include $(OSS_ROOT)/source/mak/oss_version.mak
include $(DA_TOP)/$(TOP_MAKE)/3rd_policy.mak
include $(DA_TOP)/$(TOP_MAKE)/oss_policy.mak

ifneq "$(3RD_BUILD_EXIST)" ""
include $(DA_TOP)/$(TOP_MAKE)/3rd_build.mak
endif
