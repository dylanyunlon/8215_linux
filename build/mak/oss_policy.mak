...
################################################################################
################################################################################
# $RCSfile: oss_policy.mak,v $
# $Revision: #4 $
# $Date: 2015/07/15 $
# $Author: jianghong.lin $
# $SWAuthor: Jianghong Lin $
#
# Description:
#         Open source software pcakge version parameter for setting.
#
#         Note: this file provide the default version for OSS
#         and their options for the default developer environment
#         (Linux/GNUWIN).
#
#
################################################################################
...
#For customized
-include $(THIS_ROOT)/oss_policy_cust.mak
ifndef OSS_LIST
OSS_LIST += busybox
OSS_LIST += kmod
OSS_LIST += tslib
