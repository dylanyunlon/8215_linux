...
define EUDEV_REMOVE_CUSTOM_HWDB
    rm -f $(TARGET_DIR)/etc/udev/hwdb.d/20-OUI.hwdb
    rm -f $(TARGET_DIR)/etc/udev/hwdb.d/20-net-ifname.hwdb
    rm -f $(TARGET_DIR)/etc/udev/hwdb.d/20-pci-classes.hwdb
    rm -f $(TARGET_DIR)/etc/udev/hwdb.d/20-pci-vendor-model.hwdb
endef

EUDEV_POST_INSTALL_TARGET_HOOKS += EUDEV_REMOVE_CUSTOM_HWDB
