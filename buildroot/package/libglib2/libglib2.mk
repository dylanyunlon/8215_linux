...
# 屏蔽空字符串%s格式化报错
HOST_LIBGLIB2_CONF_OPTS += CPPFLAGS="-Wno-error=format-overflow -Wno-error=format-nonliteral"
HOST_LIBGLIB2_CONF_OPTS += CFLAGS="-Wno-error=format-overflow -Wno-error=format-nonliteral"