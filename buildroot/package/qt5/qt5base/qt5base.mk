...
else ifeq ($(BR2_PACKAGE_MALI_T72X),y)
QT5BASE_CONFIGURE_OPTS += -gbm
QT5BASE_DEPENDENCIES += mali-t72x
else ifeq ($(BR2_PACKAGE_MALI_T82X),y)
QT5BASE_CONFIGURE_OPTS += -gbm
QT5BASE_DEPENDENCIES += mali-t82x
else ifeq ($(BR2_PACKAGE_MALI_T400),y)
QT5BASE_DEPENDENCIES += mali-t400
else
...
QT5BASE_CONFIGURE_OPTS += $(if $(BR2_PACKAGE_QT5BASE_JPEG),-qt-libjpeg,-no-libjpeg)
