...
{
	struct atc_clk_pll *pll = to_atc_clk_pll(hw);
	int r;
...
const struct clk_ops atc_clk_sdm_pll_ops = {
...
const struct clk_ops atc_clk_arm_pll_ops = {
	.is_enabled	= clk_pll_is_enabled,
	.enable		= clk_pll_enable,
	.disable	= clk_pll_disable,
	...
	unsigned long parent_rate)
{
	...
	if (hw != NULL) {
		pr_debug("[CCF] %s, rate: %lu, pcw: %u, postdiv_idx: %u\n",
...
const struct clk_ops atc_clk_mm_pll_ops = {
	.is_enabled	= clk_pll_is_enabled,
	.enable		= clk_pll_enable,
	.disable	= clk_pll_disable,
	.recalc_rate	= clk_arm_pll_recalc_rate,
...
const struct clk_ops atc_clk_univ_pll_ops = {
	.is_enabled	= clk_pll_is_enabled,
...
const struct clk_ops atc_clk_aud_pll_ops = {
	.is_enabled	= clk_pll_is_enabled,
