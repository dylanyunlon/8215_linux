...
#define AUD_CLI_APCM_GRP		0x1000
...
void AudCliDumpAfifo(u32 u4Cmdid,const s8 ** filename)
{
    ...
    if (0 == u4Cmdid)
    {
        sprintf(szFilePath_dump[0],"%s%s", "//sdcard//", (s8*)filename);
...
void AudCliDeconlyDump(u32 arg1,const s8 ** filename)
{
    ...
    sprintf(szDeconlyFilePath,"%s%s", "/sdcard/", (s8*)filename);
...
void vDeconlyDumpDataForDbg(u32 u4Addr, u32 u4Size)
{
...
void  AudSetCliCmd(AUD_DEC_CLI_TYPE eAudCli,u32 arg1,u32 arg2,u32 arg3,u32 arg4,const s8 **pfilename)
{
    ...
    case AUD_DEC_CLI_DEBUG:
    	if (arg1 > AUD_CLI_APCM_GRP) {
    		LOG(LOG_CTRLF, TEXT("to do apcm cli ..... \r\n"));
		ioctrl_cli_srv(arg1, arg2, arg3, arg4, pfilename);
    	} else {
