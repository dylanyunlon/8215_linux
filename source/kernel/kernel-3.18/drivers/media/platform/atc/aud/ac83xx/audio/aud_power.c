...
void vAud_PowerDown(void)
{
	...
	// avoid the case: next time power on, dsp is not power on, but arm error handle is work.
	u4AdspErrProcStateSet(DSP_PROC_INIT);
    ...
    IoClk_SetGateResetEnable(0);
    IoClk_SetGateClock(0);
#endif
