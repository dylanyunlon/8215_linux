...
static void InitNotifyInfo(void)
{
    g_aNotifyInfo.prDspSrcParam = DspGetSrcParam();
    g_aNotifyInfo.prDspOutputParam = DspGetOutParam();
    g_aNotifyInfo.prDspSrcParam->u1Aud_Sampling_Rate = FS_48K;
    g_aNotifyInfo.prDspSrcParam->u1Aud_Input_Chan_Cnt = AUD_INPUT_2_0;
    g_aNotifyInfo.u4FreqIdx = SAMPLE_48K;
}
