...
bool fgCodecNofityReset[MAX_AUDDRV_NUM];
...
u32 u4AdspErrProcInit(void)
{
    ...
    fgCodecNofityReset[SWMIX_DEC] = 0;
...
u32 u4AdspErrHandle(void)
{
    ...
    u4AdspErrProcNotifyFlagSet(SWMIX_DEC, 1);
    LOG(LOG_FAIL, TEXT("u4AdspErrProcNotifyFlagSet SWMIX_DEC\n"));
