...
void AudmhlMsgToMW(u32 u4Msg, u8  u1MsgArg)
{
	...
	if (audio_register_isr) {
		isr_data.isr(&dwMsg);
		LOG(LOG_CTRLF, "hdmiaudio: isr_data.isr call success\n");
			}
	else {
		LOG(LOG_FAIL, "hdmiaudio: isr_data.isr call fail\r\n");
	}
...
{
    LOG(LOG_ADSP_INFO, TEXT("HDMI-RX audio para status: \r\n"));
    LOG(LOG_ADSP_INFO, TEXT("---------------------------------------------------; \r\n"));
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1HBRAudio = %d; \r\n"), g_rHdmiAudInfo.u1HBRAudio);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1DSDAudio = %d; \r\n"), g_rHdmiAudInfo.u1DSDAudio);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1RawSDAudio = %d; \r\n"), g_rHdmiAudInfo.u1RawSDAudio);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1PCMMultiCh = %d; \r\n"), g_rHdmiAudInfo.u1PCMMultiCh);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1FsDec = %d; \r\n"), g_rHdmiAudInfo.u1FsDec);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1I2sChanValid = %d; \r\n"), g_rHdmiAudInfo.u1I2sChanValid);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1I2sCh0Sel = %d; \r\n"), g_rHdmiAudInfo.u1I2sCh0Sel);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1I2sCh1Sel = %d; \r\n"), g_rHdmiAudInfo.u1I2sCh1Sel);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1I2sCh2Sel = %d; \r\n"), g_rHdmiAudInfo.u1I2sCh2Sel);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1I2sCh3Sel = %d; \r\n"), g_rHdmiAudInfo.u1I2sCh3Sel);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfo.u1MCLKRatio = %d; \r\n"), g_rHdmiAudInfo.u1MCLKRatio);
    LOG(LOG_ADSP_INFO, TEXT("---------------------------------------------------; \r\n"));
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.Type = %d; \r\n"), g_rHdmiAudInfFrame.info.Type);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.Ver = %d; \r\n"), g_rHdmiAudInfFrame.info.Ver);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.Len = %d; \r\n"), g_rHdmiAudInfFrame.info.Len);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.AudioChannelCount = %d; \r\n"), g_rHdmiAudInfFrame.info.AudioChannelCount);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.RSVD1 = %d; \r\n"), g_rHdmiAudInfFrame.info.RSVD1);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.AudioCodingType = %d; \r\n"), g_rHdmiAudInfFrame.info.AudioCodingType);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.SampleSize = %d; \r\n"), g_rHdmiAudInfFrame.info.SampleSize);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.SampleFreq = %d; \r\n"), g_rHdmiAudInfFrame.info.SampleFreq);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.Rsvd2 = %d; \r\n"), g_rHdmiAudInfFrame.info.Rsvd2);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.FmtCoding = %d; \r\n"), g_rHdmiAudInfFrame.info.FmtCoding);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.SpeakerPlacement = %d; \r\n"), g_rHdmiAudInfFrame.info.SpeakerPlacement);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.Rsvd3 = %d; \r\n"), g_rHdmiAudInfFrame.info.Rsvd3);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.LevelShiftValue = %d; \r\n"), g_rHdmiAudInfFrame.info.LevelShiftValue);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudInfFrame.info.DM_INH = %d; \r\n"), g_rHdmiAudInfFrame.info.DM_INH);
    LOG(LOG_ADSP_INFO, TEXT("---------------------------------------------------; \r\n"));
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.rev = %d; \r\n"), g_rHdmiAudChSts.rev);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.ISLPCM = %d; \r\n"), g_rHdmiAudChSts.ISLPCM);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.CopyRight = %d; \r\n"), g_rHdmiAudChSts.CopyRight);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.AdditionFormatInfo = %d; \r\n"), g_rHdmiAudChSts.AdditionFormatInfo);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.ChannelStatusMode = %d; \r\n"), g_rHdmiAudChSts.ChannelStatusMode);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.CategoryCode = %d; \r\n"), g_rHdmiAudChSts.CategoryCode);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.SourceNumber = %d; \r\n"), g_rHdmiAudChSts.SourceNumber);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.ChannelNumber = %d; \r\n"), g_rHdmiAudChSts.ChannelNumber);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.SamplingFreq = %d; \r\n"), g_rHdmiAudChSts.SamplingFreq);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.ClockAccuary = %d; \r\n"), g_rHdmiAudChSts.ClockAccuary);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.rev2 = %d; \r\n"), g_rHdmiAudChSts.rev2);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.WorldLen = %d; \r\n"), g_rHdmiAudChSts.WorldLen);
    LOG(LOG_ADSP_INFO, TEXT("g_rHdmiAudChSts.OriginalSamplingFreq = %d; \r\n"), g_rHdmiAudChSts.OriginalSamplingFreq);
...
static s32 AudmhlGetAudMsg(u32 *pr_u4Msg)
{
    ...
    AUD_VERIFY((i4MsgRet == OSR_OK) || (i4MsgRet == OSR_NO_MSG));
    return (i4MsgRet);
}
...
s32 AudmhlTaskMain(void* pvArg)
{
    ...
    AUD_VERIFY(x_msg_q_delete(g_hAudInCmdQueue) == OSR_OK);
    g_hAudInCmdQueue = 0;
...
static s32 AudmhlTaskInit(void)
{
    ...
    AUD_VERIFY(x_msg_q_create(&g_hAudInCmdQueue, AUDINTASK_SPDIFIN_CMD_Q_NAME, sizeof(u32), 30) == OSR_OK);
