...
s32 AudGpsMix_CmdPause()
{
    ...
    AUD_VERIFY(AudGpsMix_DrvCmd(AUD_GPS_MIX_CMD_PAUSE));
...
s32 AudGpsMix_CmdStart()
{
    ...
    AUD_VERIFY(AudGpsMix_DrvCmd(AUD_GPS_MIX_CMD_START));
    return GPSMIX_RET_OK;
}
...
s32 AudGpsMix_CmdStop()
{
    ...
    AUD_VERIFY(AudGpsMix_DrvCmd(AUD_GPS_MIX_CMD_STOP));
    return GPSMIX_RET_OK;
...
s32 AudGpsMix_CmdResume()
{
    ...
    AUD_VERIFY(AudGpsMix_DrvCmd(AUD_GPS_MIX_CMD_RESUME));
    return GPSMIX_RET_OK;
