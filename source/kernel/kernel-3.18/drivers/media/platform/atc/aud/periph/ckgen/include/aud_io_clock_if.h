...
#define audio_clock_standardization
/**********************************************************************************
*
*   macros
*
...
typedef enum
{
    AUD_GATE_FS_PWM_CLK,
    AUD_GATE_RS_PWM_CLK,
    AUD_GATE_MP_MLIN_MCLK,
    AUD_GATE_MLIN2_MCLK,
    AUD_GATE_AUD_IEC_CLK,
    AUD_GATE_AUD2_CLK,
    AUD_GATE_APLL_CLK_AP_ASRC_CLK,
    AUD_GATE_APLL_CLK_GPS_ASRC_CLK,
    AUD_GATE_AFE_26M_CLK,
    AUD_ARM_GATE_CLK_NUM
}AUD_ARM_GATE_CLK_ID;
#endif
