...
extern void vAudWrapSendPTSQueue(u8 u1DecId, uintptr_t u4PtsAddr, u64 u8Pts);
extern void vAudWrapSetBufWPts(u8 u1DecId, u8 u1BufType, uintptr_t u4WPtrVal);
...
extern void vAudWrapResetAFIFO(u8 u1DecId, u8 u1BufType, uintptr_t u4Start, uintptr_t u4End);
...
extern void vAudWrapSetStartRdPtr(u8 u1DecId, uintptr_t u4Addr);
