...
extern void DspCfgSetSrcVolumeGain(AUD_MEDIA_SOURCE_TYPE_T eSrc, AUD_MEDIA_OUT_TYPE_T eType, u32 u4Value);
...
extern void DspSetDeconlyCtrl(AUD_DECONLY_CTRL_T eCtrl);
extern AUD_DECONLY_CTRL_T DspGetDeconlyCtrl(void);
extern void DspSetDeconlyReady(u32 u4Val);
extern u32 DspGetDeconlyReady(void);
extern void DspSetDeconlySemp(u32 u4Val);
extern u32 DspGetDeconlySemp(void);
u32 DspGetDeconlyFS(void);
u32 DspGetDeconlyChCfg0(void);
u32 DspGetDeconlyChCfg1(void);
u32 DspGetDeconlyChNum(void);
uintptr_t DspGetDeconlyBaseAddr(void);
u32 DspGetDeconlyChSize(void);
u32 DspGetDeconlyAputBank(void);
u32 DspGetDeconlyAoutBank(void);
void DspSetDeconlyAoutBank(u32 u4Val);
u32 DspGetDeconlyReadBank(void);
void DspSetDeconlyReadBank(u32 u4Val);
u32 DspGetDeconlyBankMax(void);
u64 DspGetDeconlyPts(void);
bool DspGetDeconlyChkFrmSz(void);
#endif
uintptr_t DspGetSpectrumBaseAddr(void);
...
extern void DspSetPtsNormalMode(AUD_PTS_QUEUE_INFO_T *prInfo, uintptr_t u4PtsAddr, u32 u4PtsVal);
extern void DspSetFirstPtsValue(u32 u4PtsVal);
extern void DspSetPtsWptr(u32 u4PtsVal);
extern void DspResetInternalPTS(u8 u1DecId);  


/******************************************************************************
*    share memory functions
******************************************************************************/
extern uintptr_t g_u4DspShareMem;
...
extern void DspGetMicBufInfo(AUD_MIC_BUF_FOR_BT_INFO *prBufInfo, uintptr_t u4wkPhyAdr,uintptr_t  u4PagePhyAdr);
...
extern void DspSetSwMixWptr(u32 u4Len);

extern void DspSetSwMixRptr(u32 u4Len);
extern u32  DspGetSwMixRptr(void);
/******************************************************************************
