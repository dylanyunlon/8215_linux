...
*[Author]              
*[Description]
*    DSP UOP service routine ID definition
******************************************************************************/
...
//src volume
#define UOP_DSP_SRC_VOL_FS_DEC1           (DSP_UOPID1 + (0x19 << 8))
#define UOP_DSP_SRC_VOL_FS_DEC4           (DSP_UOPID1 + (0x1A << 8))
#define UOP_DSP_SRC_VOL_FS_DEC5           (DSP_UOPID1 + (0x1B << 8))
#define UOP_DSP_SRC_VOL_FS_MIXER          (DSP_UOPID1 + (0x1C << 8))
#define UOP_DSP_SRC_VOL_FS_MIXER2         (DSP_UOPID1 + (0x1D << 8))
#define UOP_DSP_SRC_VOL_FS_DVP            (DSP_UOPID1 + (0x1E << 8))

#define UOP_DSP_SRC_VOL_RS_DEC1           (DSP_UOPID1 + (0x1F << 8))
#define UOP_DSP_SRC_VOL_RS_DEC4           (DSP_UOPID1 + (0x20 << 8))
#define UOP_DSP_SRC_VOL_RS_DEC5           (DSP_UOPID1 + (0x21 << 8))
#define UOP_DSP_SRC_VOL_RS_MIXER          (DSP_UOPID1 + (0x22 << 8))
#define UOP_DSP_SRC_VOL_RS_MIXER2         (DSP_UOPID1 + (0x23 << 8))
#define UOP_DSP_SRC_VOL_RS_DVP            (DSP_UOPID1 + (0x24 << 8))
...
//add for swmix
#define UOP_DSP_MEDIA_FS_USB_ON             (DSP_UOPID10 + (0x4C << 8))
#define UOP_DSP_MEDIA_FS_USB_OFF            (DSP_UOPID10 + (0x4D << 8))
#define UOP_DSP_MEDIA_FS_DEC4_ON            (DSP_UOPID10 + (0x4E << 8))
#define UOP_DSP_MEDIA_FS_DEC4_OFF           (DSP_UOPID10 + (0x4F << 8))
#define UOP_DSP_MEDIA_FS_DEC5_ON            (DSP_UOPID10 + (0x50 << 8))
#define UOP_DSP_MEDIA_FS_DEC5_OFF           (DSP_UOPID10 + (0x51 << 8))
#define UOP_DSP_MEDIA_FS_MIXER_ON           (DSP_UOPID10 + (0x52 << 8))
#define UOP_DSP_MEDIA_FS_MIXER_OFF          (DSP_UOPID10 + (0x53 << 8))
#define UOP_DSP_MEDIA_FS_MIXER2_ON          (DSP_UOPID10 + (0x54 << 8))
#define UOP_DSP_MEDIA_FS_MIXER2_OFF         (DSP_UOPID10 + (0x55 << 8))
#define UOP_DSP_MEDIA_FS_DVP_ON             (DSP_UOPID10 + (0x56 << 8))
#define UOP_DSP_MEDIA_FS_DVP_OFF            (DSP_UOPID10 + (0x57 << 8))
#define UOP_DSP_MEDIA_RS_USB_ON             (DSP_UOPID10 + (0x58 << 8))
#define UOP_DSP_MEDIA_RS_USB_OFF            (DSP_UOPID10 + (0x59 << 8))
#define UOP_DSP_MEDIA_RS_DEC4_ON            (DSP_UOPID10 + (0x5A << 8))
#define UOP_DSP_MEDIA_RS_DEC4_OFF           (DSP_UOPID10 + (0x5B << 8))
#define UOP_DSP_MEDIA_RS_DEC5_ON            (DSP_UOPID10 + (0x5C << 8))
#define UOP_DSP_MEDIA_RS_DEC5_OFF           (DSP_UOPID10 + (0x5D << 8))
#define UOP_DSP_MEDIA_RS_MIXER_ON           (DSP_UOPID10 + (0x5E << 8))
#define UOP_DSP_MEDIA_RS_MIXER_OFF          (DSP_UOPID10 + (0x5F << 8))
#define UOP_DSP_MEDIA_RS_MIXER2_ON          (DSP_UOPID10 + (0x60 << 8))
#define UOP_DSP_MEDIA_RS_MIXER2_OFF         (DSP_UOPID10 + (0x61 << 8))
#define UOP_DSP_MEDIA_RS_DVP_ON             (DSP_UOPID10 + (0x62 << 8))
#define UOP_DSP_MEDIA_RS_DVP_OFF            (DSP_UOPID10 + (0x63 << 8))
//end for swmix
...
//smix uop
#define DSP_UOPID1E                       (UOP_DSP + 0x1E)
#define UOP_DSP_SMIX_ON                   (DSP_UOPID1E + (0x01 << 8))
#define UOP_DSP_SMIX_OFF                  (DSP_UOPID1E + (0x02 << 8))
