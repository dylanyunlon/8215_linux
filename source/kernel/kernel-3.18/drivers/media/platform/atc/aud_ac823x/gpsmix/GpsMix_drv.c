...
static uintptr_t _AudGpsMixCmdQueue;
...
static void _AudGpsMixWaitEvent(u32 * pu4Event)
{
	...
	u32* u4Event = kzalloc(zMsgSize, GFP_KERNEL);
    AUD_DRV_GPS_MIX_CMD_T eGpsMixCmd;
    s32 i4CmdOk;
	pr_debug("QK _AudGpsMixWaitEvent\n");
    do
    {
		...
		pr_err("QK u4Event:%d,_GpsMixDecInfo.eGpsMixDecState:%d,flag:%d\n",eGpsMixCmd,_GpsMixDecInfo.eGpsMixDecState,_GpsMixDecInfo.u4GpsMixEventFlag);
