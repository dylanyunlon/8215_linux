...
#else
extern unsigned long io_base_aud;

#define WriteREG(addr,value)       writel(value, io_base_aud + (addr << 2))// IO_WRITE32(io_base_aud, (addr << 2), value)
#define ReadREG(addr)              readl(io_base_aud + (addr << 2))//IO_READ32(io_base_aud, (addr << 2))
//#define WriteREGC(addr,value)       IO_WRITE32(ADSP3_UCV_BASE, (addr << 2), value)
//#define ReadREGC(addr)              IO_READ32(ADSP3_UCV_BASE, (addr << 2))
...
extern uintptr_t u4AudHalGetBufRPtr(u8 u1DecId, u8 u1BufType);
extern void vAudHalSetBufWPtr(u8 u1DecId, u8 u1BufType, uintptr_t u4WPtrVal);
extern void vAudHalResetBufWPtr(u8 u1DecId);
extern void vAudHalSetBufEndAddr(u8 u1DecId, u8 u1BufType, uintptr_t u4Addr);
extern void vAudHalSetBufStartAddr(u8 u1DecId, u8 u1BufType, uintptr_t u4Addr);
...
extern u32 u4AudHalGetPbsBufDspOffset(uintptr_t u4Addr);
extern void u4AudHalSetPbsBufRPtr(uintptr_t u4RPtr);
extern uintptr_t u4AudHalGetPbsBufWPtr(void);
extern uintptr_t u4AudHalGetPbsBufRPtr(void);
extern uintptr_t u4AudHalGetPbsBufEndAddr(void);
extern uintptr_t u4AudHalGetPbsBufStartAddr(void);
extern uintptr_t u4AudHalGetPbsBufBaseAddr(void);
