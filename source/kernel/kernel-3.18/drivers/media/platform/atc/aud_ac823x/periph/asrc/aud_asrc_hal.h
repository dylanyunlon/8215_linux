...
typedef struct 
{
    uintptr_t u4IPhyAddr;
    uintptr_t u4IVirAddr;
    u32 u4ISz;                 // Total size of input buffer (in bytes)
    u32 u4IChSz;
    
    uintptr_t u4OPhyAddr;
    uintptr_t u4OVirAddr;
...
{ 
    ...
    uintptr_t u4IVirSAdr[2];       // Virtual Start address of input buffer of each channel
    uintptr_t u4OVirSAdr[2];       // Virtual start address of output buffer of each channel
