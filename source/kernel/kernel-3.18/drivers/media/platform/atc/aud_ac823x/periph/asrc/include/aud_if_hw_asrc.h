...
#define ASRCLOG_ERR(exp)                AUDLOG(_u4AsrcLog & ALOG_ERR,  (T("<***AUD_ASRC_ERR***>")), exp)
#define ASRCLOG_WARN(exp)               AUDLOG(_u4AsrcLog & ALOG_WARN, (T("<AUD_ASRC_WARN>")), exp)
#define ASRCLOG_INFO(exp)               AUDLOG(_u4AsrcLog & ALOG_INFO, (T("[AUD_ASRC]")), exp)
#define ASRCLOG_CLI(exp)                AUDLOG(_u4AsrcLog & ALOG_CLI,  (T("[AUD_ASRC_CLI]")), exp)

#define ASRCLOG_DBG(exp)                AUDLOG(_u4AsrcLog & ALOG_DBG,  (T("[AUD_ASRC]")), exp)

#define ASRCLOG_TEST(exp)               AUDLOG(_u4AsrcLog & ALOG_BIT8,  (T("[AUD_ASRC_TEST]")), exp)
