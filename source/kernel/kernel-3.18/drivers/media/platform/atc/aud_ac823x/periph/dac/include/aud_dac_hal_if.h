...
#define DACLOG_ERR(exp)                 AUDLOG(_u4DacLog & ALOG_ERR,  (T("<***AUD_DAC_ERR***>")), exp)
#define DACLOG_WARN(exp)                AUDLOG(_u4DacLog & ALOG_WARN, (T("<AUD_DAC_WARN>")), exp)
#define DACLOG_INFO(exp)                AUDLOG(_u4DacLog & ALOG_INFO, (T("[AUD_DAC]")), exp)
#define DACLOG_CLI(exp)                 AUDLOG(_u4DacLog & ALOG_CLI,  (T("[AUD_DAC_CLI]")), exp)
#define DACLOG_DBG(exp)                 AUDLOG(_u4DacLog & ALOG_DBG,  (T("[AUD_DAC]")), exp)

#define DACLOG_TEST(exp)                AUDLOG(_u4DacLog & ALOG_TEST, (T("[AUD_DAC_TEST]")), exp)
