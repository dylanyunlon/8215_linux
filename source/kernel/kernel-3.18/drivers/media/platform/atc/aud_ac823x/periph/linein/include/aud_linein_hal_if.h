...
#define LINLOG_ERR(exp)                AUDLOG(_u4LinLog & ALOG_ERR,  (T("<***AUD_LIN_ERR***>")), exp)
#define LINLOG_WARN(exp)               AUDLOG(_u4LinLog & ALOG_WARN, (T("<AUD_LIN_WARN>")), exp)
#define LINLOG_INFO(exp)               AUDLOG(_u4LinLog & ALOG_INFO, (T("[AUD_LIN]")), exp)
#define LINLOG_CLI(exp)                AUDLOG(_u4LinLog & ALOG_CLI,  (T("[AUD_LIN_CLI]")), exp)
#define LINLOG_DBG(exp)                AUDLOG(_u4LinLog & ALOG_DBG,  (T("[AUD_LIN]")), exp)

#define LINLOG_TEST(exp)               AUDLOG(_u4LinLog & ALOG_TEST, (T("[AUD_LIN_TEST]")), exp)
