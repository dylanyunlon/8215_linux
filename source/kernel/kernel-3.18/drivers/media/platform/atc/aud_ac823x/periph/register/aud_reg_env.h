...
#define REGENV_SPLIN_CTRL       (AUD_REG_ENV_BASE + 0x020)
    ...
    #define BIT_STR_SPDFLIN_BANK    16 //(16 -27)
    #define BIT_NUM_SPDFLIN_BANK    12 //SPDIF-in/Line-in bank (in 1M bytes unit)
...
#define REGENV_AUD_DRAM_BANK        (AUD_REG_ENV_BASE + 0x3A0)
    #define BIT_STR_ADSP_BANK               0 //(0 - 11)
    #define BIT_NUM_ADSP_BANK               12//
    
    #define BIT_STR_AFIFO_BANK              13//(13 - 24)
    #define BIT_NUM_AFIFO_BANK              12//
