...
#define REGENV_RGBK2_CFG5           (AUD_REG_ENV_BASE2 + 0x094)
    ...
    #define BIT_STR_PCM_INT_CLR             5 //(5)//modify add
    #define BIT_NUM_PCM_INT_CLR             1 //pcm risc interrupt clear
...
//Buffer1 mix NSADR
#define REGENV_AOUT1_MIX1_NSADR     (AUD_REG_ENV_BASE2 + 0x0464)
    #define BIT_STR_AOUT1_MIX1_NSADR            8 //(8 - 23)
    #define BIT_NUM_AOUT1_MIX1_NSADR            23//buffer1 mix data next start address

#define REGENV_AOUT1_MIX2_NSADR     (AUD_REG_ENV_BASE2 + 0x0468)
    #define BIT_STR_AOUT1_MIX2_NSADR            8 //(8 - 23)
    #define BIT_NUM_AOUT1_MIX2_NSADR            23//buffer2 mix data next start address
...
#define REGENV_PCM_CTRL             (AUD_REG_ENV_BASE2 + 0x04C4)
    ...
    #define BIT_NUM_SYNC_CYCLE                  2 //pcm sync cycle select
        //0 : 32 pcm_clk cycle,  1 : 64 pcm_clk cycle

    #define BIT_STR_SYNC_MODE_SEL               8 //(6)
    #define BIT_NUM_SYNC_MODE_SEL               1 //pcm sync mode select                                                                                                                  
        //0 : 32 pcm_clk cycle  , 1 : 64 pcm_clk cycle

    #define BIT_STR_SYNC_LENGTH                 9 //(8 - 9)
...
//pcm tx intr num
#define REGENV_PCMTX_INTR_SAMPLE_NUM           (AUD_REG_ENV_BASE2 + 0x04E4)//modify add
    #define BIT_STR_TX_SAMPLE_NUM               0 //(0 - 23)
    #define BIT_NUM_TX_SAMPLE_NUM               24 //pcm tx output data number and remain the value of this number

//pcm tx intr num
#define REGENV_PCMTX_INTR           (AUD_REG_ENV_BASE2 + 0x04E8)
    #define BIT_STR_TX_INTR_RENUM               0//8 //(8 - 15)
    #define BIT_NUM_TX_INTR_RENUM               24//8 //BT out remain the value of sample to gen interrupt
