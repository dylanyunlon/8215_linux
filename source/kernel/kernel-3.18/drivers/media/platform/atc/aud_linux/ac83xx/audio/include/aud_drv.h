...
#define AUD_DRV_AFIFO_MM_SIZE               (0x8000) //(0x104000)
#define AUD_DRV_AVIN_A2DP_SZIE              (0x6000 * 3)
#define AUD_DRV_AVIN2_SIZE                  (0x6000)

#define MT3360_ADSP_BUF_SZ                  (0x260000) //need same as DSP_WORK_BUF_SIZE
...
#define AUD_HDMI_RX_BUF_SIZE                (SYS_AFIFO_PART_SND_HDMI_SIZE)
