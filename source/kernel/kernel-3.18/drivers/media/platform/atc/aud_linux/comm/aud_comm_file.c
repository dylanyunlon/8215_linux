...
static bool PhyFile_Open(void * pThis, bool fgRead, void * pParams)
{
    ...
    COMMLOG_DBG(T("[PhyFile(0x%x)]Open: fgRead(%d), ChSize(%d) Chn(%d) BW(%d) SAdr(0x%x)\r\n"), (u32)prThis, 
        (s32)prThis->fgRead, (s32)prThis->rBuf.u4ChBufSz, (s32)prThis->rBuf.u4Chn, (s32)prThis->rBuf.u4BW, (u32)prThis->rBuf.u4VirSAdr);
