...
extern void vAudHalGetBlkAddr(AUD_HAL_DRAM_BLOCK eBlockNum,u32* pu4Addr);
...
extern void vAudHalSetDspWorkingDramBlock(u32 u4DspStartAddr);
...
extern u32 u4AudHalGetAFIFOBaseAddr(u32 u4DecId);     // add by water -- (2010-3-19) for AFIFO monitor cli debug used
...
extern u32 u4AudHalGetDSPDataPageStartAddr(u32 u4PageId); // add by water -- (2010-3-19) for AOUT monitor cli debug used
