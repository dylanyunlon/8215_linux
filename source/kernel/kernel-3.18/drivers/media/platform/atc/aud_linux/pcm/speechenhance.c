...
s32 SpeechEnhance_GetEnhanceParam(PCM_SPEECH_CONF *prSpeechConf)
{
	...
	PCM_DEBUG(LOG_TAG, "SpeechEnhance_GetEnhanceParam: AEC Param = ");
	for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
		if (0 == (u4Idx % 10U)) {
			PCM_DEBUG(LOG_TAG, "\r\n");
		}
	...
	PCM_DEBUG(LOG_TAG, "\r\n");
	PCM_DEBUG(LOG_TAG, "rSphParam.error_flag = %d\r\n",
		(s32)g_prSpeechEnhance.m_prShareMem->rSphParam.error_flag);

	PCM_DEBUG(LOG_TAG, "SpeechEnhance_GetEnhanceParam: AEC Param2 = ");
	for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
		if (0 == (u4Idx % 10U)) {
			PCM_DEBUG(LOG_TAG, "\r\n");
		}
	...
	PCM_DEBUG(LOG_TAG, "\r\n");
	PCM_DEBUG(LOG_TAG, "rSphParam2.error_flag = %d\r\n",
...
s32 SpeechEnhance_SetEnhanceParam(const PCM_SPEECH_CONF *prSpeechConf)
{
	...
	if (g_prSpeechEnhance.m_prShareMem) {
		...
		PCM_DEBUG(LOG_TAG, "SpeechEnhance_SetEnhanceParam: AEC Param = ");
		for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
			if (0 == (u4Idx % 10U)) {
				PCM_DEBUG(LOG_TAG, "\r\n");
			}
		...
		PCM_DEBUG(LOG_TAG, "SpeechEnhance_SetEnhanceParam: AEC Param2 = ");
		for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
			if (0 == (u4Idx % 10U)) {
				PCM_DEBUG(LOG_TAG, "\r\n");
			}
		...
		PCM_DEBUG(LOG_TAG, "SpeechEnhance_SetEnhanceParam:Init AEC Param = ");
		for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
			Sph_Enh_ctrl1.enhance_pars[u4Idx] = prSpeechConf->enhance_pars[u4Idx];
			if (0 == (u4Idx % 10U)) {
				PCM_DEBUG(LOG_TAG, "\r\n");
			}
			PCM_DEBUG(LOG_TAG, "%d, ", (s32)Sph_Enh_ctrl1.enhance_pars[u4Idx]);
		}
		PCM_DEBUG(LOG_TAG, "\r\n");
		Sph_Enh_ctrl1.error_flag = prSpeechConf->error_flag;
		PCM_DEBUG(LOG_TAG, "rSphParam.error_flag = %d\r\n", (s32)Sph_Enh_ctrl1.error_flag);

		PCM_DEBUG(LOG_TAG, "SpeechEnhance_SetEnhanceParam:Init AEC Param2 = ");
		for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
			Sph_Enh_ctrl2.enhance_pars[u4Idx] = prSpeechConf->enhance_pars2[u4Idx];
			if (0 == (u4Idx % 10U)) {
				PCM_DEBUG(LOG_TAG, "\r\n");
			}
			PCM_DEBUG(LOG_TAG, "%d, ", (s32)Sph_Enh_ctrl2.enhance_pars[u4Idx]);
		}
		PCM_DEBUG(LOG_TAG, "\r\n");
...
s32 SpeechEnhance_GetEnhance16KParam(PCM_SPEECH_16K_CONF *prSpeechConf)
{
	...
	PCM_DEBUG(LOG_TAG, "SpeechEnhance_GetEnhance16KParam: AEC 16K Param = ");
	for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
		if (0 == (u4Idx % 10U)) {
			PCM_DEBUG(LOG_TAG, "\r\n");
		}
		PCM_DEBUG(LOG_TAG, "%d, ", (s32)prSpeechConf->enhance_16k_pars[u4Idx]);
	}
	PCM_DEBUG(LOG_TAG, "\r\n");
...
s32 SpeechEnhance_SetEnhance16KParam(PCM_SPEECH_16K_CONF *prSpeechConf)
{
	...
	if (g_prSpeechEnhance.m_prShareMem) {
		...
		PCM_DEBUG(LOG_TAG, "SpeechEnhance_SetEnhance16KParam: AEC 16K Param = ");
		for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
			if (0 == (u4Idx % 10U)) {
				PCM_DEBUG(LOG_TAG, "\r\n");
			}
		...
		PCM_DEBUG(LOG_TAG, "SpeechEnhance_SetEnhance16KParam:Init AEC 16K Param = ");
		for (u4Idx = 0; u4Idx < AEC_NDC_PARAM_NUM; u4Idx++) {
			Sph_Enh_ctrl_16k[u4Idx] = prSpeechConf->enhance_16k_pars[u4Idx];
			if (0 == (u4Idx % 10U)) {
				PCM_DEBUG(LOG_TAG, "\r\n");
			}
			PCM_DEBUG(LOG_TAG, "%d, ", (s32)Sph_Enh_ctrl_16k[u4Idx]);
		}
		PCM_DEBUG(LOG_TAG, "\r\n");
	}
...
u32 SpeechEnhance_EnableDump(bool fgEnable)
{
	...
	PCM_DEBUG(LOG_TAG, "SpeechEnhance_EnableDump: fgEnable(%d)\r\n\r\n",
