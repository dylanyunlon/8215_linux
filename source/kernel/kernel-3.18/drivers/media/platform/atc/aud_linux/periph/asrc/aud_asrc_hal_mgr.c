...
static void AsrcHal_ISR(u16 u2Vector)
{   
...
static void AsrcMgr_AllocMemory(PASRC_MGR_CLS prThis, u32 u4IChSz, u32 u4OChSz)
{
    ...
    ASRCLOG_INFO(T("[%d]Alloc Buffer: In(0x%x, 0x%x, 0x%x, 0x%x) Out(0x%x, 0x%x, 0x%x, 0x%x) Align(0x%x)\n"), 
        prThis->eType, (u32)(prMemory->u4IVirAddr), (u32)(prMemory->u4IPhyAddr), (u32)(prMemory->u4ISz), (u32)(prMemory->u4IChSz),
        (u32)(prMemory->u4OVirAddr), (u32)(prMemory->u4OPhyAddr), (u32)(prMemory->u4OSz), (u32)(prMemory->u4OChSz), (u32)u4Alignment);
