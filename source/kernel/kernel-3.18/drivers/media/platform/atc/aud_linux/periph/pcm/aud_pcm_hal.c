...
{
    u32 u4MemSize, u4TxSadr, u4RxSadr;
    ...
    PCMLOG_INFO(T("PCM TX BUF INFO:  buf phy adr : 0x%x, buf vir adr : 0x%x \r\n"),
                  (u32)(prCfg->rTxBuf.u4PhySddr), (u32)(prCfg->rTxBuf.u4VirSAdr));
    ...
    PCMLOG_INFO(T("PCM RX BUF INFO:  buf phy adr : 0x%x, buf vir adr : 0x%x \r\n"),
                  (u32)(prCfg->rRxBuf.u4PhySddr), (u32)(prCfg->rRxBuf.u4VirSAdr));
