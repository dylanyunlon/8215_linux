...
struct dmx_dev_info {
	...
	void __iomem *sys_base_regs;
	void __iomem *sys_dram_regs;
};

extern struct dmx_dev_info *g_dmxdevinfo;

/* Demux register access commands*/
#define DMXCMD_READ8(offset)		__raw_readb((volatile void *)(g_dmxdevinfo->dmx_base0_regs + (offset)))
#define DMXCMD_READ16(offset)		__raw_readw((volatile void *)(g_dmxdevinfo->dmx_base0_regs + (offset) * 2))
#define DMXCMD_READ32(offset)		__raw_readl((volatile void *)(g_dmxdevinfo->dmx_base0_regs + ((offset) * 4)))
#define DMXCMD_WRITE8(offset, value)	do {\
	__raw_writeb((value), (volatile void *)(g_dmxdevinfo->dmx_base0_regs + (offset))); mb();\
} while (0)
#define DMXCMD_WRITE16(offset, value)	do {\
	__raw_writew((value), (volatile void *)(g_dmxdevinfo->dmx_base0_regs + ((offset) * 2))); mb();\
} while (0)
#define DMXCMD_WRITE32(offset, value)	do {\
	__raw_writel((value), (volatile void *)(g_dmxdevinfo->dmx_base0_regs + ((offset) * 4))); mb();\
} while (0)

#define SYSCMD_WRITE32(offset, value) do { \
	__raw_writel((value), (volatile void *)(g_dmxdevinfo->sys_base_regs + (offset))); mb();\
} while (0)
#define SYSDRAM_WRITE32(offset, value) do { \
	__raw_writel((value), (volatile void *)(g_dmxdevinfo->sys_dram_regs + (offset))); mb();\
} while (0)
#define SYSCMD_READ32(offset)		__raw_readl((volatile void *)(g_dmxdevinfo->sys_base_regs + (offset)))
#define SYSDRAM_READ32(offset)	__raw_readl((volatile void *)(g_dmxdevinfo->sys_dram_regs + (offset)))
...
#define PVR_DMEM_BASE			((volatile void *)(g_dmxdevinfo->dmx_base2_regs))
#define PVR_DMEM_MAX_LEN		(0x04000)
...
EXTERN u8 _PVR_GetByte(u8 **ppu1StartAddr, uintptr_t ptrEndAddr,
...
EXTERN u32 _PVR_CopyRingBuffer(uintptr_t ptrDst, uintptr_t ptrDstStart,
				  uintptr_t ptrDstEnd, uintptr_t ptrSrc, uintptr_t ptrSrcStart,
				  uintptr_t ptrSrcEnd, u32 u4Size);

EXTERN bool _PVR_CopyDestRingBuffer(uintptr_t ptrDst, uintptr_t ptrBufStart,
				    uintptr_t ptrBufEnd, uintptr_t ptrSrc, u32 u4Size);
...
EXTERN uintptr_t _PVR_AdvanceAddr(uintptr_t ptrAddr, s32 i4Increment, uintptr_t ptrWp,
...
EXTERN void _PVR_DumpDMem(uintptr_t ptrStartAddr, u32 u4WordCnt);

EXTERN void _PVR_DumpMemory(uintptr_t ptrBufSa, uintptr_t ptrBufEa, uintptr_t ptrAddr, u32 u4BytesCnt);
...
#ifndef __linux__
EXTERN bool _PVR_SetPowerState(CEDEVICE_POWER_STATE ePowerState, PVR_INPUT_TYPE_T eInputType);

EXTERN CEDEVICE_POWER_STATE _PVR_GetPowerState(void);
#else
