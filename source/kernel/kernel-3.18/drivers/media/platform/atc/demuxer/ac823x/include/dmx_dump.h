...
void DmxDumpADmaInfo(void *pvDmx, u64 u8FileOfst, void *pvBuf,
...
void DmxDumpData(HANDLE hFile, uintptr_t ptrFifoRP, uintptr_t ptrFifoWP,
	uintptr_t ptrFifoSa, uintptr_t ptrFifoEa);
