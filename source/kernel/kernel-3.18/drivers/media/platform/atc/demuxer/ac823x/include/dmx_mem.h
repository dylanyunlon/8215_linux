...
#define dmx_memset(dst, value, size) memset((dst), (value), (size))
#define dmx_memcpy(dst, src, size)   memcpy((dst), (src), (size))
...
bool DMX_CheckPesHdrMemGuard(u32 u4PhyPesHdrSa);
...
#define DMX_PHYSICAL(ptrVMem) DMX_PHYSICALEX(ptrVMem, __func__, __LINE__)
...
#define DMX_PHYSICAL_REG(ptrVMem) DMX_PHYSICALEX_REG(ptrVMem, __func__, __LINE__)
uintptr_t DMX_NONCACHEEX_REG(u32 u4PMem, const char *szFunc, s32 i4Line);

#define DMX_NONCACHE_REG(u4PMem) DMX_NONCACHEEX_REG(u4PMem, __func__, __LINE__)

uintptr_t DMX_PHY_REG_2_PHYEX(u32 u4PMem, const char *szFunc, s32 i4Line);
#define DMX_PHY_REG_2_PHY(u4PMem) DMX_PHY_REG_2_PHYEX(u4PMem, __func__, __LINE__)
