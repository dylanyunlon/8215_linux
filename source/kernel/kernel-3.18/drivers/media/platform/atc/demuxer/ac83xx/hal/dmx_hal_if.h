...
EXTERN uintptr_t DMX_HAL_GetFIFOWPtr(u32 u4HWPIDIndex,
	DMX_HAL_FIFOType eFIFOType);

EXTERN uintptr_t DMX_HAL_GetFIFORPtr(u32 u4HWPIDIndex,
	DMX_HAL_FIFOType eFIFOType);

EXTERN void    DMX_HAL_SetFIFOWPtr(u32 u4HWPIDIndex,
	DMX_HAL_FIFOType eFIFOType, uintptr_t ptrCurWritePtr);

EXTERN void    DMX_HAL_SetFIFORPtr(u32 u4HWPIDIndex,
	DMX_HAL_FIFOType eFIFOType, uintptr_t ptrCurReadPtr);
