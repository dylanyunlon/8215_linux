...
{
	/*clear KEY and Ctrl*/
	memset((void *)PVR_DMEM_CA_KEY_BASE, 0, PVR_DMEM_CA_KEY_SIZE * PVR_DMEM_CA_KEY_NUM);
	mb();
	memset((void *)PVR_DMEM_CA_CTRL_BASE, 0, 4 * PVR_DMEM_CA_KEY_NUM);
	mb();

	/*clear PVR_DMEM_MM_KEY*/
	memset((void *)PVR_DMEM_MM_KEY_BASE, 0, PVR_DMEM_MM_KEY_FIELD_SIZE * 4);
	mb();
}
