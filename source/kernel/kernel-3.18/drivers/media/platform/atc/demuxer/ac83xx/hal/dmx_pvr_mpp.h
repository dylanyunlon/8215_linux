...
typedef bool (*PFN_MPP_NOTIFY)(PVR_MPP_NOTIFY_EVENT_T);
...
EXTERN void _PVR_MPP_FixDMAEndAddr(uintptr_t* pptrEA, uintptr_t ptrWPtr);

EXTERN bool _PVR_MPP_SetISREventHandle(HANDLE_T hEvent);
