...
bool _PVR_SetVideoType(u8 u1DevID, PVR_VIDEO_TYPE_T eVideoType)
{
	...
	PVR_LOG_TRACE(TEXT("------ [PVR] %s --> eVideoType: %d ------\r\n"),
...
bool _PVR_VCodeInit(void)
{
	...
	memset((void *)PVR_PATTERN_MATCH_BASE0, 0, PVR_DMEM_PATTERN_MATCH_LEN * 4);
	mb();
	memset((void *)PVR_PATTERN_MATCH_BASE1, 0, PVR_DMEM_PATTERN_MATCH_LEN * 4);
	mb();
