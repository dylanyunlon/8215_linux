...
/* 03: DMX Optimization */
#define DMX_VER_MAIN        03		/* /> main version */
...
#define DMX_VER_REV         02		/* /> version number, you should add 1 when check in aud */
...
#define DMX_MEMCHECK_START_VAL      (0x5A5A5A5A)
#define DMX_MEMCHECK_END_VAL        (0xFBFBFBFB)
...
#define MAX_DMX_INSTANCE_CNT              1

#define DMX_DEV_CNT                       1
