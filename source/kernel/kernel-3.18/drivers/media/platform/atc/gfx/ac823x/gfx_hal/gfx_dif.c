...
{
   { (uint32_t)(GFX_HAVE_SW_MOD + GFX_HAVE_HW_8520_MOD),
    (uint32_t)E_GFX_HW_8520_MOD,
    (uint32_t)0,
    (unsigned long *)NULL,
    (uint32_t)TRUE,
    (BOOL)FALSE
 ...
 */
//-------------------------------------------------------------------------
static INT32 _GfxReturn1(uint32_t u4GfxHwId)
{
    return 1;
}
 ...
 */
//-------------------------------------------------------------------------
INT32 (*pfnGFX_DifAction)(uint32_t);
 ...
 */
//-------------------------------------------------------------------------
INT32 (*pfnGFX_DifGetInternalIdle)(uint32_t);
 ...
 */
//-------------------------------------------------------------------------
void (*pfnGFX_DifFinNotify)(uint32_t);
 ...
 */
//-------------------------------------------------------------------------
void GFX_DifSetIdle(uint32_t u4GfxHwId, INT32 i4Idle)
{
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifGetIdle(uint32_t u4GfxHwId)
{
 ...
 */
//-------------------------------------------------------------------------
MI_DIF_T *GFX_DifGetData(uint32_t u4GfxHwId)
{
 ...
 */
//-------------------------------------------------------------------------
void GFX_DifSetNotify(uint32_t u4GfxHwId, void (*pfnNotify)(uint32_t))
{
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifInit(uint32_t u4GfxHwId)
{
    INT32 i4Ret;
	...
	printk(" define GFX_ENABLE_SW_MODE\n");
    i4Ret = GFX_SwInit();
    if ((INT32)E_GFX_OK == i4Ret)
    {
    	printk("enter if 1");
        GFX_DifSetMode(u4GfxHwId, (uint32_t)E_GFX_SW_MOD);
    ...
    if (MA_DIF_HAVE_GFX_HW8520)
    {
        ...
        if ((INT32)E_GFX_OK == i4Ret)
        {
            ...
            GFX_DifSetMode(u4GfxHwId, (uint32_t)E_GFX_HW_8520_MOD);
        } 
    }
...
INT32 GFX_DifUninit(uint32_t u4GfxHwId)
{
    if (MA_DIF_HAVE_GFX_HW8520)
    {
        GFX_HwUninit();
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifSetRegBase(uint32_t u4GfxHwId, unsigned long *pu4Base)
{
    if (pu4Base != NULL)
    {
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifGetRegBase(uint32_t u4GfxHwId, unsigned long *pu4Base)
{
    if (pu4Base != NULL)
    {
        *pu4Base = (unsigned long)(_rDifData[u4GfxHwId].pu4CrBase);
        return (INT32)E_GFX_OK;
    }
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifReset(uint32_t u4GfxHwId, uint32_t u4Reset)
{
    ...
    else
    {
        ...
        GFX_UNUSED_RET(x_memset(_rDifData[u4GfxHwId].pu4CrBase, 0, 
                (sizeof(unsigned long) * GREG_FILE_SIZE)))
    }

    return (INT32)E_GFX_OK;
}

INT32 GFX_DifResetWT(uint32_t u4GfxHwId, uint32_t u4Reset)
{
    // if an HW gfx engine is available, just reset it
    if (MA_DIF_HAVE_GFX_HW8520)
    {
    ...
    else
    {
        // else erase software control register file
        GFX_UNUSED_RET(x_memset(_rDifData[u4GfxHwId].pu4CrBase, 0, 
                (sizeof(uint32_t) * GREG_FILE_SIZE)))
    }
 ...
 */
//-------------------------------------------------------------------------
void GFX_DifSetMode(uint32_t u4GfxHwId, uint32_t u4GfxMode)
{
    INT32 i4Ret;
    unsigned long u4GfxRegBase;
    unsigned long *pu4GfxRegBase = &u4GfxRegBase;

#if defined(GFX_ENABLE_SW_MODE)
    // sw mode setting
    if ((uint32_t)E_GFX_SW_MOD == u4GfxMode)
    {
    ...
    // hw mode setting
    if ((uint32_t)E_GFX_HW_8520_MOD == u4GfxMode)
    {
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifSetCR(uint32_t u4GfxHwId, uint32_t u4CrName, uint32_t u4Val)
{
 ...
 */
//-------------------------------------------------------------------------
INT32 GFX_DifGetCR(uint32_t u4GfxHwId, uint32_t u4CrName, uint32_t *pu4Val)
{
