...
int gfx_bitblt(uint32_t u4TTB,gfx_ioc_paras *gfx_paras)
{
	...
	UINT32 u4SrcCM,u4DstCM,u4SrcPitch,u4DstPitch,u4SrcX,u4SrcY,u4DstX,u4DstY,u4Width,u4Height;
	UINT32 u4Color,u4Alpha,u4Bltopt;
	UINT32 u4SrcDisKey,u4SrcKeyIn,u4SrcKeyMin,u4SrcKeyMax,u4DstDisKey,u4DstKeyIn,u4DstKeyMin,u4DstKeyMax;
...
{
	UINT8 *pu1DstAddr = NULL;
	UINT32 u4DstCM,u4DstPitch,u4DstX,u4DstY,u4Width,u4Height;
	UINT32 u4Color;
...
int gfx_stretchblt(uint32_t u4TTB,gfx_ioc_paras *gfx_paras)
{
	UINT8 *pu1SrcAddr = NULL;
	UINT8 *pu1DstAddr = NULL;
	UINT32 u4SrcCM,u4DstCM,u4SrcPitch,u4DstPitch,u4SrcX,u4SrcY,u4DstX,u4DstY;
	UINT32 u4SrcWidth,u4SrcHeight,u4DstWidth,u4DstHeight;
