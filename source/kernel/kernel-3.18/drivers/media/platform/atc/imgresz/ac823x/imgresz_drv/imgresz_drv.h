...
typedef struct _IMGRESZ_YCBCR_TO_AYUV_WORK_AROUND {
	...
	bool                    fgCbTo444;
	bool                    fgCrTo444;
	unsigned long           u4Cb444Sa;
	unsigned long           u4Cr444Sa;
	bool                    fgCbTo444Done;
	bool                    fgCrTo444Done;
	u32                  u4LineCnt;
...
extern void vImgReszHwInstScaleNotify(bool fgForceHwId, u32 *pu4HwId);
extern s32 i4ImgReszHwInstLockNotify(u32 u4HwInstId, bool fgLock);
extern s32 i4ImgReszHwInstStopNotify(u32 u4HwInstId);
extern s32 i4ImgReszHwInstGetNum(void);
extern bool fgImgReszHwInstIsActive(u32 u4HwInstId);
extern void vImgreszCopyMemory(void *pvDestination, void *pvSource, SIZE_T Length);
extern void vImgreszSetMemory(void *pvDestination, u8 u1Value, SIZE_T Length);
