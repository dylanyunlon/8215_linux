...
typedef struct _IMGRESZ_INST_T {
...
#endif
	unsigned long                  u4PrevRowBufSa1;        /*/< Previous partial row buffer 1 start address*/
	unsigned long                  u4PrevRowBufSa2;        /*/< Previous partial row buffer 2 start address*/
	unsigned long                  u4PrevRowBufSa3;        /*/< Previous partial row buffer 3 start address*/
	...
	unsigned long                  u4TempLineBufSa;        /*/< Temporary line buffer start address.*/
	...
	unsigned long				u4tableaddr;			/*/mmu table addr from caller*/
} IMGRESZ_INST_T;
