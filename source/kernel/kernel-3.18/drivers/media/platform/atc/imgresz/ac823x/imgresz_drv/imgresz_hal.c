...
static unsigned long u4HwImgReszOffset[HW_IMGRESZ_NUM];

void ImgrGetHwRegAddress(void)
{
	u4HwImgReszOffset[0] = (unsigned long)imgr0_sysreg_base;
	u4HwImgReszOffset[1] = (unsigned long)imgr1_sysreg_base;
	u4HwImgReszOffset[2] = (unsigned long)imgr2_sysreg_base;
	u4HwImgReszOffset[3] = (unsigned long)imgr3_sysreg_base;
}

INLINE void vHwImgReszWrite32(u32 u4HwId, unsigned long addr, u32 value)
{
	*(volatile u32 *)(u4HwImgReszOffset[u4HwId] + addr) = value;
}

INLINE u32 u4HwImgReszRead32(u32 u4HwId, unsigned long addr)
{
	return *(volatile u32 *)(u4HwImgReszOffset[u4HwId] + addr);
}

INLINE u32 u4HwImgReszReadBim(unsigned long addr)
{
	return *(volatile u32 *)(0x70000000 + addr);
}

INLINE void vHwImgReszWriteBim(unsigned long addr, u32 value)
{
...
s32 i4HwImgReszSetSrcBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2, unsigned long u4BufSA3)
{
...
s32 i4HwImgReszSetSrcPrevRowBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2, unsigned long u4BufSA3)
{
#if 0/*!IMGRESZ_IO_MMU_TEST*/
	u4BufSA1 = u4BufSA1 ? VA_TO_PA(u4BufSA1) : 0;
	u4BufSA2 = u4BufSA2 ? VA_TO_PA(u4BufSA2) : 0;
...
s32 i4HwImgReszSetDestBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2)
{
#if 0/*!IMGRESZ_IO_MMU_TEST*/
	u4BufSA1 = u4BufSA1 ? VA_TO_PA(u4BufSA1) : 0;
	u4BufSA2 = u4BufSA2 ? VA_TO_PA(u4BufSA2) : 0;
...
s32 i4HwImgReszSetPreloadBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2)
{
	u4BufSA1 = u4BufSA1 ? VA_TO_PA(u4BufSA1) : 0;
	u4BufSA2 = u4BufSA2 ? VA_TO_PA(u4BufSA2) : 0;
...
s32 i4HwImgReszSetTempBufAddr(u32 u4HwId, unsigned long u4Addr)
{
...
s32 i4HwImgReszSetColorPalletTable(u32 u4HwId, unsigned long u4ColorPalletTableAddr)
{
	u32 u4i = 0;
