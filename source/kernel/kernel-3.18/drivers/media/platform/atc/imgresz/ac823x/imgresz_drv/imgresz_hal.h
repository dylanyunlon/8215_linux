...
/*#define IMGRESZ0_REG_OFFSET                 0x4400*/
/*#define IMGRESZ1_REG_OFFSET                 0x4600*/

extern void __iomem *imgr0_sysreg_base;
extern void __iomem *imgr1_sysreg_base;
extern void __iomem *imgr2_sysreg_base;
extern void __iomem *imgr3_sysreg_base;

extern unsigned int imgr0irq;
extern unsigned int imgr1irq;
extern unsigned int imgr2irq;
extern unsigned int imgr3irq;

extern struct clk *clk_ac8317_imgr0;
extern struct clk *clk_ac8317_imgr1;
extern struct clk *clk_ac8317_imgr2;
extern struct clk *clk_ac8317_imgr3;

extern struct clk *clk_ac8317_imgr_top1;
extern struct clk *clk_ac8317_imgr_top2;
...
/*/bit[21] = 0x1: CbCr Swap*/
#define IMG_RESZ_CBCR_SWAP                 ((unsigned)0x1 << 21)
...
/*! @} */
#define IMGRESZ_InterRupt_ENABLE_REG     0x0813c
#define IMGRESZ_InterRupt_ENABLE		  ((unsigned)0x1 << 13)
...
#define IMG_RESZ_FLIP_EN              ((unsigned)0x1 << 0)
...
extern void vHwImgIntResize(u32 u4HwId);/*sun for turning on interrupt*/
extern void vHwImgReszWaitCountReset(u32 u4HwId);
#if 0/*IMGRESZ_IO_MMU_TEST*/
extern void vHwImgReszEnableMMU(u32 u4HwId);
extern void vHwImgReszDisableMMU(u32 u4HwId);
#endif

extern void vHwImgRezeDMAReset(u32 u4HwId);
extern void vHwImgRezeSetWaitWRDone(u32 u4HwId);
extern void vImgResz_HAL_Set_Interupt(bool Enable);

extern void vHwImgRezeReset(u32 u4HwId);
extern void vHwImgReszTempMMUSet(u32 u4HwId);
extern void vHwImgReszEnable(u32 u4HwId);
extern void vHwImgReszDisable(u32 u4HwId);
extern void vHwImgReszResize(u32 u4HwId);
extern void vHwJdecPrintRegister(u32 u4HwId);
extern void vHwImgReszWriteRegisterToDRAM(u32 u4HwId, u32 u4RegisterbufSA);
extern void vHwImgReszReadRegisterFromDRAM(u32 u4HwId, u32 u4RegisterbufSA);
extern s32 i4ImgReszVfyTestPowerDownWrite(u32 u4HwId);
extern s32 i4ImgReszVfyTestPowerDownRead(u32 u4HwId);

extern INLINE void vHwImgReszWrite32(u32 u4HwId, unsigned long addr, u32 value);
extern bool fgHwImgReszResizeWorking(u32 u4HwId);
extern bool fgHwImgReszInterruptExist(u32 u4HwId);

extern bool fgHwImgReszDMARstFinish(u32 u4HwId);

extern bool fgHwImgReszResizeFinish(u32 u4HwId);
extern s32 i4HwImgReszSetResizeMode(u32 u4HwId,
				      IMGRESZ_HAL_RESIZE_MODE_T eResizeMode,
				      IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat);
extern s32 i4HwImgReszSetResampleMethod(u32 u4HwId,
					  IMGRESZ_HAL_RESAMPLE_METHOD_T eHResampleMethod,
					  IMGRESZ_HAL_RESAMPLE_METHOD_T eVResampleMethod);
extern s32 i4HwImgReszSetSrcBufFormat(u32 u4HwId, IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat);
extern s32 i4HwImgReszSetSrcBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2, unsigned long u4BufSA3);
extern s32 i4HwImgReszSetSrcPrevRowBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2, unsigned long u4BufSA3);
extern s32 i4HwImgReszSetSrcBufWidth(u32 u4HwId, u32 u4BufWidth,
	IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat);

extern s32 i4HwImgReszSetSrcRowBufHeight(u32 u4HwId, u32 u4RowBufHeight,
	IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat, bool fgRPRRacingModeEnable);

extern s32 i4HwImgReszSetSrcImageWidthHeight(u32 u4HwId, u32 u4Width,
	u32 u4Height, IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat);
extern s32 i4HwImgReszSetSrcImageClipWidthHeight(u32 u4HwId, u32 u4YWidth, u32 u4CWidth,
						   u32 u4YHeight, u32 u4CHeight,
						   IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat);

extern s32 i4HwImgReszSetSrcImageOffset(u32 u4HwId, u32 u4XOff, u32 u4YOff,
					  IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat,
					  u32 u4SrcHeight, u32 u4TgtHeight);
extern s32 i4HwImgReszSetSrcFirstRow(u32 u4HwId, bool fgFirstRow);
extern s32 i4HwImgReszSetSrcLastRow(u32 u4HwId, bool fgLastRow);
extern s32 i4HwImgReszSetDestBufFormat(u32 u4HwId, IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat,
					 IMGRESZ_HAL_IMG_BUF_FORMAT_T *prDestBufferFormat);
extern s32 i4HwImgReszSetDestBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2);
extern s32 i4HwImgReszSetDestBufWidth(u32 u4HwId, u32 u4BufWidth);
extern s32 i4HwImgReszSetDestImageWidthHeight(u32 u4HwId, u32 u4Width, u32 u4Height);
extern s32 i4HwImgReszSetDestImageOffset(u32 u4HwId, u32 u4XOff, u32 u4YOff);


extern s32 i4HwImgReszSetTmpLineBufLen(u32 u4HwId, IMGRESZ_HAL_RESAMPLE_METHOD_T eVResampleMethod,
					 u32 u4SrcHeight, u32 u4DestHeight, u32 u4DestWidth,
					 bool fgRPRMode, bool fgLumaKeyEnable);

extern s32 i4HwImgReszSetTempBufAddr(u32 u4HwId, unsigned long u4Addr);
extern s32 i4HwImgReszSetJpegPicMode(u32 u4HwId, bool fgPicMode);
extern s32 i4HwImgReszSetJpegPreloadMode(u32 u4HwId, bool fgPreloadMode);
extern s32 i4HwImgReszSetJpegComponent(u32 u4HwId, bool fgYExist, bool fgCbExist, bool fgCrExist);
extern s32 i4HwImgReszSetJpegComponentExt(u32 u4HwId, bool fgYExist, bool fgCbExist,
	bool fgCrExist, bool fgRPRRacingModeEnable);
extern s32 i4HwImgReszSetHScaleFactor(u32 u4HwId, u32 u4SrcWidth, u32 u4TgtWidth,
					IMGRESZ_HAL_RESAMPLE_METHOD_T eResampleMethod,
					IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat,
					IMGRESZ_HAL_IMG_BUF_FORMAT_T *prDestBufferFormat);
extern s32 i4HwImgReszSetVScaleFactor(u32 u4HwId,
					u32 u4SrcHeight, u32 u4TgtHeight,
					IMGRESZ_HAL_RESAMPLE_METHOD_T eResampleMethod,
					IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat,
					IMGRESZ_HAL_IMG_BUF_FORMAT_T *prDestBufferFormat);
extern s32 i4HwImgReszSetClipHScaleFactor(u32 u4HwId, u32 u4SrcWidth, u32 u4TgtWidth,
					    ...
					    IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat,
					    IMGRESZ_HAL_IMG_BUF_FORMAT_T *prDestBufferFormat);
extern s32 i4HwImgReszSetClipVScaleFactor(u32 u4HwId,
					    u32 u4SrcHeight, u32 u4TgtHeight, u32 u4TgtClipHeigh,
					    u32 u4YOff_Clip,
					    u32 *u4SrcClipYHeitht,
					    u32 *u4SrcClipCHeitht,
					    IMGRESZ_HAL_RESAMPLE_METHOD_T eResampleMethod,
					    IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat,
					    IMGRESZ_HAL_IMG_BUF_FORMAT_T *prDestBufferFormat);

extern s32 i4HwImgReszSetAlphaBlendingLevel(u32 u4HwId, u32 u4Alpha);
extern s32 i4HwImgReszSetPreloadBufAddr(u32 u4HwId, unsigned long u4BufSA1, unsigned long u4BufSA2);
extern s32 i4HwImgReszSetAlphaChangeScalingType(u32 u4HwId, u32 u4ScalingType);
extern s32 i4HwImgReszSetLumaKeyEnable(u32 u4HwId, bool fgEnable);
extern s32 i4HwImgReszSetLumaKeyScalingType(u32 u4HwId, u32 u4ScalingType);
extern s32 i4HwImgReszSetLumaKey(u32 u4HwId, u8 u1LumaKey);
extern s32 i4HwImgReszSetAlphaChangeBilinearBoundary(u32 u4HwId, bool fgBilinearBoundary);
extern s32 i4HwImgReszSetOnlyDistinguishAlpha(u32 u4HwId, bool fgOnlyDistinguishAlpha);
extern s32 i4HwImgReszSetLumaKeyBilinearBoundary(u32 u4HwId, bool fgBilinearBoundary);
extern void vHwImgReszReadBurstLength(u32 u4HwId, bool fgEnable);
extern s32 i4HwImgReszSetLumaKeyYUVMode(u32 u4HwId, bool fgYUVMode);
extern s32 i4HwImgReszSetDramReqBurstLimit(u32 u4HwId, u32 u4Limit);
extern s32 i4HwImgReszSetIndexBufColorTranslation(u32 u4HwId);
extern s32 i4HwImgReszSetColorPalletTable(u32 u4HwId, unsigned long u4ColorPalletTableAddr);
extern s32 i4HwImgReszGetHwStatus(u32 u4HwId, IMGRESZ_HAL_HW_STATUS_T *prHwStatus);
extern s32 i4HwImgReszSetHwStatus(u32 u4HwId, IMGRESZ_HAL_HW_STATUS_T *prHwStatus);
extern s32 i4HwImgReszResetDestPartialBuf(u32 u4HwId, bool fgReset);
extern s32 i4HwImgReszSetRPR(u32 u4HwId, bool fgRPRMode, bool fgRPRRacingModeEnable);
extern s32 i4HwImgReszSetRPRHScaleFactor(u32 u4HwId, s32 i4SrcWidth, s32 i4TgtWidth); /*sun new*/
extern s32 i4HwImgReszSetRPRVScaleFactor(u32 u4HwId, s32 i4SrcHeight, s32 i4TgtHeight); /*sun new*/
extern s32 i4HwImgReszSetFLIP(u32 u4HwId, bool fgFlipModeEnable);
extern s32 i4HwImgReszSetSwap(u32 u4HwId, bool fgSwapModeEnable);

extern s32 i4HwImgReszSetScale1to1Factor(u32 u4HwId,
					   IMGRESZ_HAL_IMG_BUF_FORMAT_T *prSrcBufferFormat);
extern void vHwImgReszWaitCountReset(u32 u4HwId);
