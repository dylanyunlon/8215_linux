...
static int mali_core_scaling_enable = 1; //0 is org
...
static struct resource mali_gpu_resources_m400_mp2[] = {
	MALI_GPU_RESOURCES_MALI400_MP2(0xF0060000, 98, 99, 100,101, 102, 103)
};

#endif
#endif
#ifdef ATC_PLATFORM_AC83XX
static struct resource mali_gpu_resources_m400_mp2[] = {
	MALI_GPU_RESOURCES_MALI400_MP2(0xF0060000, 98, 99, 100,101, 102, 103)
};
...
static struct resource mali_gpu_resources_m400_mp1[] = {
	MALI_GPU_RESOURCES_MALI400_MP1(0xF0060000, 98, 99, 100,101 )
};
#endif
...
static struct mali_gpu_device_data mali_gpu_data = {
	...
	.shared_mem_size = 768 * 1024 * 1024, /* 768MB */
	.fb_start = 0x00000000,
	.fb_size = 0x40000000,
	.max_job_runtime = 2000, /* 2 seconds */
...
/*
 * For resolve mali resume hang issue,
 * Directly use spm control interface in replace of featureInit
*/
void power_on(void)
{
    MALI_DEBUG_PRINT(1, ("power on ++\n"));
	//featureInit(FEATURE_3D, 0, 0, 0);
    spm_set_power(SPM_MODULE_G3D, 1);
    MALI_DEBUG_PRINT(1, ("power on --\n"));
}

void power_off(void)
{
    MALI_DEBUG_PRINT(1, ("power off ++\n"));
    //featureInit(FEATURE_3D, 1, 0, 0);
    spm_set_power(SPM_MODULE_G3D, 0);
    MALI_DEBUG_PRINT(1, ("power off --\n"));
}

#define MALI_CORE_NUM_1  1 
#define MALI_CORE_NUM_2  2

int mali_core_nums(void)
{
        u32  * core_number_reigster_addr = (u32 *) 0xfd054664;

        return (((*core_number_reigster_addr) & (0x1 << 5)) ? MALI_CORE_NUM_1 : MALI_CORE_NUM_2);
}
