...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 12, 0)) && defined(MALI_CONFIG_OF) \
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 7, 0)) && defined(MALI_CONFIG_OF) \
