...
#define IO_VIRT_HDMI IO_BASE/*Linux:0xf0000000, nucleus:0x70000000 */
#define IO_HDMI_BASE (0x22c00)
...
/*    #define DDC_DEGLITCH_EN Fld(1, 31, AC_MSKB3) //31
   ...
   */
#define BYPASS_CTL3_FSM_DVI Fld(1, 22, AC_MSKB2)
...
/*   #define HDCP_AINFO Fld(8, 8, AC_FULLB1) //15:8 */
...
/*   #define DEV_EXCEED Fld(1, 31, AC_MSKB3) //31
  ...
  #define FIFO_RDY_WP Fld(1, 19, AC_MSKB2) //19
  #define BCAPS1 Fld(1, 17, AC_MSKB2) //17
  #define BCAPS0 Fld(1, 16, AC_MSKB2) //16
...
#define RPT_START_ADDR_CLR Fld(1, 22, AC_MSKB3) //24 */
#define RPT_SHA_GO Fld(1, 20, AC_MSKB2) /*24*/
/* #define RPT_START_ADDR_9_8 Fld(2, 18, AC_MSKB2) //19:18 */
/* #define SHA_LENGTH_9_8 Fld(2, 16, AC_MSKB2) //17:16 */
#define SHA_LENGTH_9_0  Fld(10, 8, AC_FULLB1) /*15:8*/
...
#define INTR8 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x040))
#define V_READY_INTR Fld(1, 1, AC_MSKB0) /* 7:0 */
#define INTR8_MASK (IO_VIRT_HDMI+(IO_HDMI_BASE+0x044))
#define AUD_CHSTATUS_CHG_MASK Fld(1, 7, AC_MSKB0) /* 7 */
#define AUD_FORMAT_CHG_MASK Fld(1, 6, AC_MSKB0) /* 6 */
...
#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
/* #define V2ACTIVELINES Fld(7, 16, AC_MSKB2) //22:16 */
#define VID_DELINES_12_8 Fld(5, 8, AC_MSKB1) /* 12:8 */
#endif
...
#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
/* #define VID_HFRONTPORCH Fld(11, 8, AC_MSKW21) //18:8 */
#endif
...
#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
#define INTR_STATE2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x060))
#define INTR_STATE2_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x060))
#define INTR_STATE2_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x061))
#define INTR_STATE2_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x062))
#define INTR_STATE2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x063))
#define INTR_VSYNC_ENABLE  Fld(1, 3, AC_MSKB0)

/* #define INTR_VSYNC         Fld(1, 19, AC_MSKB2)
#define INTR_NO_VS_PKT     Fld(1, 18, AC_MSKB2)
#define INTR_NEW_VS_PKT    Fld(1, 17, AC_MSKB2)
#define INTR_NEW_ISRC1_PKT Fld(1, 16, AC_MSKB2) */
#endif
...
#else
#define AAC_XCLK_IN_PCLK Fld(8, 24, AC_FULLB3) /*31:24 */
#endif
...
#define INTR6_PWR5V_RX2 Fld(1, 20, AC_MSKB2)
#define INTR6_PWR5V_RX1 Fld(1, 19, AC_MSKB2)
...
#define HDMI_RTCK_AUTO Fld(1, 31, AC_MSKB3)
#define TMDS_PHASE_CHECK_RESET Fld(1, 29, AC_MSKB3)
#define MCK_INV_EN Fld(1, 28, AC_MSKB3)
#define QCK_INV_EN Fld(1, 27, AC_MSKB3)
#define TMDS_PHASE_CHECK_STATUS Fld(1, 25, AC_MSKB3)
#define HDMI_ATEST_EN Fld(1, 24, AC_MSKB3)
#define HDMI_PLLBIAS Fld(2, 20, AC_MSKB2) /* 21:20 */
/* #define HDMI_LBW Fld(3, 16, AC_MSKB2) //18:16 */
#define HDMI_MON Fld(3, 8, AC_MSKB1)/* 10:8 */
#define DPCLK_INV Fld(1, 4, AC_MSKB0)
#define TMDS_RX_RST_ Fld(1, 3, AC_MSKB0)
#define TMDS_RT_RST_ Fld(1, 2, AC_MSKB0)
#define TMDS_SP_RST_ Fld(1, 1, AC_MSKB0)
#define PCLK_INV Fld(1, 0, AC_MSKB0)
...
#define PHASE_CHECK_EN Fld(1, 27, AC_MSKB3)
/*#define MCK90SEL Fld(1, 26, AC_MSKB3)//26 */
#define BAND135 Fld(1, 25, AC_MSKB3)
#define PLL_CK_SEL Fld(1, 22, AC_MSKB2)
/*#define EQ_GAIN Fld(2, 20, AC_MSKB2)//21:20 */
#define PLL_CK_VCO Fld(1, 16, AC_MSKB2)
#define CLK_BYPASS_SEL Fld(1, 15, AC_MSKB1)
#define PIXPLL_DFF_RST_SEL Fld(1, 6, AC_MSKB0)
#define PIXPLL_DFF_RST Fld(1, 5, AC_MSKB0)
#define EQ_CNT_STOP_EN Fld(1, 4, AC_MSKB0)
#define EQ_CODE_CNTL Fld(1, 3, AC_MSKB0)
#define CE_ISI_MONITOR Fld(1, 2, AC_MSKB0)
#define HARDWARE_ADAPTIVE_EQ_COUNTER Fld(1, 1, AC_MSKB0)
#define ADEQ_ECK_GATE_EN Fld(1, 0, AC_MSKB0)
#define TMDS_CTRL2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x098))
#define TMDS_CTRL2_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x098))
#define TMDS_CTRL2_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x099))
#define TMDS_CTRL2_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09a))
#define TMDS_CTRL2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09b))
#define DIGITAL_CKDT (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09c))
#define DIGITAL_CKDT_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09c))
#define DIGITAL_CKDT_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09d))
#define DIGITAL_CKDT_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09e))
#define DIGITAL_CKDT_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x09f))
...
/*
#if CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT8555
#define ANA_INTF_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a0))
#define ANA_INTF_0_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a0))
#define ANA_INTF_0_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a1))
#define ANA_INTF_0_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a2))
#define ANA_INTF_0_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a3))
...
#define RG_ATEST_EN  Fld(1, 0, AC_MSKB0)  // 0
#define RG_ANAMON  Fld(3, 1, AC_MSKB0)  // 3:1
#define RG_ACBIAS Fld(2, 4, AC_MSKB0)  // 4:5
#define RG_BAND_SEL_SW_EN Fld(1, 6, AC_MSKB0)  //6
#define RG_CHAM12_EN  Fld(1, 7, AC_MSKB0)  //7
#define RG_CH0_CDRLPI  Fld(7, 8, AC_MSKB1)  // 14:8
#define RG_CH1_CDRLPI1  Fld(1, 15, AC_MSKB1)  // 15
#define RG_CH1_CDRLPI2  Fld(6, 16, AC_MSKB2)  // 21:16
#define RG_CH2_CDRLPI1  Fld(2, 22, AC_MSKB2)  // 22:23
#define RG_CH2_CDRLPI2  Fld(5, 24, AC_MSKB3)  // 24:28
#define RG_CLKBIAS  Fld(2, 29, AC_MSKB3)  // 29:30
#define RG_CLKBUF_EN  Fld(1, 31, AC_MSKB3)  // 31

#define ANA_INTF_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a4))
#define ANA_INTF_1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a4))
#define ANA_INTF_1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a5))
#define ANA_INTF_1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a6))
#define ANA_INTF_1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a7))
...
#define RG_BAND_SEL_HW Fld(1, 23, AC_MSKB2) // 23
#define RG_KPGAIN Fld(3, 19, AC_MSKB2)//19:21
#define RG_JITTST_SEL Fld(1, 18, AC_MSKB2)//18
#define RG_JITTST_DIV Fld(1, 17, AC_MSKB2)//17
#define RG_JITTST_EN Fld(1, 16, AC_MSKB2)//16
#define RG_IBMUX Fld(2, 14, AC_MSKB1)//14:15
#define RG_HY Fld(2, 12, AC_MSKB1)//12:13
#define RG_FULL_EN Fld(1, 11, AC_MSKB1)//11
#define RG_EQ_RST  Fld(1, 10, AC_MSKB1)//10
#define RG_EQ_SWRSTSEL  Fld(1, 9, AC_MSKB1)//9
#define RG_EQ_PRBSCK_SEL Fld(1, 8, AC_MSKB1)//8
#define RG_CDR_STOP Fld(1, 7, AC_MSKB0)//7
#define RG_CDR_RST Fld(1, 6, AC_MSKB0)//6
#define RG_BAND_SEL_SW Fld(2, 4, AC_MSKB0)// 4:5
#define RG_EQBIAS Fld(3, 1, AC_MSKB0)// 1:3
#define RG_DATA_RST Fld(1, 0, AC_MSKB0)// 0

#define ANA_INTF_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a8))
#define ANA_INTF_2_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a8))
#define ANA_INTF_2_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a9))
#define ANA_INTF_2_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0aa))
#define ANA_INTF_2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ab))
#define HAPLL_REPLACE_APLL2_reg Fld(1, 5, AC_MSKB0)//5

#define RG_HDMI_PORT0_EN Fld(1, 31, AC_MSKB3)// 30
#define RG_HDMI_PORT1_EN Fld(1, 30, AC_MSKB3)// 30
#define RG_EQ_PD Fld(1, 30, AC_MSKB3)// 30
#define RG_EQ_FILT Fld(4, 25, AC_MSKB3)// 25:28
#define RG_PREDOV_SW_EN Fld(1, 24, AC_MSKB3)// 24
#define RG_PREDIV_SW Fld(1, 23, AC_MSKB2)// 23
#define RG_PI_VCOB Fld(2, 21, AC_MSKB2)// 21
#define RG_CKDT_SET Fld(1, 20, AC_MSKB2)// 20
#define RG_CKDT_AEN  Fld(1, 19, AC_MSKB2)// 19
#define RG_PI_EN  Fld(1, 18, AC_MSKB2)// 18
#define RG_PLLBIAS Fld(2, 16, AC_MSKB2)// 17:16
#define RG_PLLCK_EN Fld(1, 15, AC_MSKB1)// 15
#define RG_EQ_FILT_SEL  Fld(3, 12, AC_MSKB1)// 14:12
#define RG_ZSEL Fld(1, 11, AC_MSKB1)// 11
#define RG_VCTRL_EN Fld(1, 10, AC_MSKB1)// 10
#define RG_VCO_RSTB_SW_EN  Fld(1, 9, AC_MSKB1)// 9
#define RG_VCO_RSTB_SW Fld(1, 8, AC_MSKB1)// 8
#define RG_TEST_SEL  Fld(1, 7, AC_MSKB0)// 7
#define RG_TERM_EN  Fld(1, 6, AC_MSKB0)//6
#define RG_RX_MODE  Fld(2, 4, AC_MSKB0)// 4:5
#define RG_RXAFE_EN_SW  Fld(1, 3, AC_MSKB0)// 3
#define RG_RXAFECH2_EN  Fld(1, 2, AC_MSKB0)// 2
#define RG_RXAFECH1_EN  Fld(1, 1, AC_MSKB0)// 1
#define RG_RXAFECH0_EN  Fld(1, 0, AC_MSKB0)// 0

#define ANA_INTF_10 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ac))
#define ANA_INTF_10_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ac))
#define ANA_INTF_10_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ad))
#define ANA_INTF_10_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ae))
#define ANA_INTF_10_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0af))
#define RG_PLL_RST Fld(1, 17, AC_MSKB2) //4// 17

#define RG_DEEPCLRCLK_PDB  Fld(1, 14, AC_MSKB1) // 14
#define RG_DEEPCLRCLK_RSTN  Fld(1, 15, AC_MSKB1) // 15

#define RG_HDMI_HY Fld(2, 3, AC_MSKB0) //4:3
#define RG_HDMI_SW_EN Fld(3, 0, AC_MSKB0) //2:0
#define ANA_INTF_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ac))
#define AUD_INTF_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b0))//Note: This Mt8555 does not exist
#define AUD_INTF_1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b0))
#define AUD_INTF_1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b1))
#define AUD_INTF_1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b2))
#define AUD_INTF_1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b3))
...
#define ANA_INTF_0 (IO_VIRT_HDMI+0x740)
#define ANA_INTF_0_0 (IO_VIRT_HDMI+0x740)
#define ANA_INTF_0_1 (IO_VIRT_HDMI+0x741)
#define ANA_INTF_0_2 (IO_VIRT_HDMI+0x742)
#define ANA_INTF_0_3 (IO_VIRT_HDMI+0x743)
#define ANA_INTF_1_31_16 Fld(16, 16, AC_FULLW32) /*31:16*/
#define RG_CDR_RST Fld(1, 31, AC_MSKB3)
#define RG_CDR_STOP Fld(1, 30, AC_MSKB3)
#define RG_ATEST_EN Fld(1, 28, AC_MSKB3)
#define RG_ANAMON Fld(3, 24, AC_MSKB3)/*24:26*/
#define RG_CH0_CDRLPI Fld(7, 16, AC_MSKB2)/*16:22*/
#define RG_CH1_CDRLPI Fld(7, 8, AC_MSKB1)/*8:14*/
#define RG_CH2_CDRLPI Fld(7, 0, AC_MSKB0)/*0:6*/

#define ANA_INTF_1 (IO_VIRT_HDMI+0x744)
#define ANA_INTF_1_0 (IO_VIRT_HDMI+0x744)
#define ANA_INTF_1_1 (IO_VIRT_HDMI+0x745)
#define ANA_INTF_1_2 (IO_VIRT_HDMI+0x746)
#define ANA_INTF_1_3 (IO_VIRT_HDMI+0x747)
#define RG_BAND_SEL_SW Fld(1, 31, AC_MSKB3) /*31*/
#define RG_BAND_SEL_SW_EN Fld(1, 30, AC_MSKB3) /*30*/
#define RG_CHAN12_EN Fld(1, 29, AC_MSKB3) /*31*/
#define RG_CKDT_AEN  Fld(1, 28, AC_MSKB3) /*31 */
#define RG_CKDT_SET Fld(1, 27, AC_MSKB3)
#define RG_HY_BIAS Fld(2, 25, AC_MSKB3)
#define RG_CLKBUF_EN Fld(1, 24, AC_MSKB3)
#define RG_DATA_RST Fld(1, 23, AC_MSKB2)
#define RG_EQ_PD Fld(1, 22, AC_MSKB2)
#define RG_D2SBIAS  Fld(2, 20, AC_MSKB2)
#define RG_EQ_FILT Fld(4, 16, AC_MSKB2)
#define RG_EQ_FILT_SEL Fld(3, 13, AC_MSKB1)
#define RG_EQ_PRBSCK_SEL Fld(1, 12, AC_MSKB1)
#define RG_EQ_SWRSTSEL Fld(1, 11, AC_MSKB1)
#define RG_EQ_RST Fld(1, 10, AC_MSKB1)
#define RG_HY Fld(2, 8, AC_MSKB1)
#define RG_EQ_PATERN_SEL Fld(1, 7, AC_MSKB0)
#define RG_EQBIAS Fld(2, 5, AC_MSKB0)
#define RG_FULL_EN Fld(1, 3, AC_MSKB0)
/* #define RG_HDMI_VREF Fld(3, 0, AC_MSKB0) */

#define ANA_INTF_2 (IO_VIRT_HDMI+0x748)
#define ANA_INTF_2_0 (IO_VIRT_HDMI+0x748)
#define ANA_INTF_2_1 (IO_VIRT_HDMI+0x749)
#define ANA_INTF_2_2 (IO_VIRT_HDMI+0x74a)
#define ANA_INTF_2_3 (IO_VIRT_HDMI+0x74b)

#define RG_HDMI_PORT0_EN Fld(1, 31, AC_MSKB3)/* 30 */
#define RG_HDMI_PORT1_EN Fld(1, 30, AC_MSKB3)/* 30 */
#define RG_IN_PULL Fld(1, 29, AC_MSKB3)/* 30 */
#define RG_PI_EN Fld(1, 28, AC_MSKB3)/* 30 */
#define RG_KPGAIN Fld(3, 24, AC_MSKB3)/* 30 */
#define RG_PLLCK_EN Fld(1, 21, AC_MSKB2)
#define RG_RXAFE_EN_SW Fld(1, 20, AC_MSKB2)
#define RG_RXAFECH0_EN Fld(1, 19, AC_MSKB2)
#define RG_RXAFECH1_EN Fld(1, 18, AC_MSKB2)
#define RG_RXAFECH2_EN Fld(1, 17, AC_MSKB2)
#define RG_TERM_EN Fld(1, 16, AC_MSKB2)
#define RG_ZSEL Fld(2, 14, AC_MSKB1)
#define RG_RX_MODE Fld(2, 12, AC_MSKB1)
#define RG_TEST_SEL Fld(1, 8, AC_MSKB1)
#define RG_EQ_GAIN Fld(2, 4, AC_MSKB0)
#define RG_DEEPCLRCLK_PDB Fld(1, 1, AC_MSKB0)
#define RG_DEEPCLRCLK_RSTN Fld(1, 0, AC_MSKB0)


#define ANA_INTF_10 (IO_VIRT_HDMI+0x74c)
#define ANA_INTF_10_0 (IO_VIRT_HDMI+0x74c)
#define ANA_INTF_10_1 (IO_VIRT_HDMI+0x74d)
#define ANA_INTF_10_2 (IO_VIRT_HDMI+0x74e)
#define ANA_INTF_10_3 (IO_VIRT_HDMI+0x74f)

#define RG_PLL_BAND Fld(6, 24, AC_MSKB3)
#define RG_PLL_BC Fld(2, 20, AC_MSKB2)
#define RG_PLL_BIC Fld(4, 16, AC_MSKB2)
#define RG_PLL_BIR Fld(4, 12, AC_MSKB1)
#define RG_PLL_BP Fld(4, 8, AC_MSKB1)
#define RG_PLL_BR Fld(3, 4, AC_MSKB0)
#define ANA_INTF_3 (IO_VIRT_HDMI+0x74c)

#define ANA_INTF_4 (IO_VIRT_HDMI+0x750)
#define ANA_INTF_4_0 (IO_VIRT_HDMI+0x750)
#define ANA_INTF_4_1 (IO_VIRT_HDMI+0x751)
#define ANA_INTF_4_2 (IO_VIRT_HDMI+0x752)
#define ANA_INTF_4_3 (IO_VIRT_HDMI+0x753)

#define RG_HDMI_0_PLL_DIVCTRL Fld(2, 30, AC_MSKB3)
#define RG_HDMI_0_PLL_DIVEN Fld(6, 24, AC_MSKB3)
#define RG_HDMI_0_PLL_FBSEL Fld(2, 22, AC_MSKB2)
#define RG_HDMI_0_PLL_BYPASS Fld(1, 21, AC_MSKB2)
#define RG_HDMI_0_PLL_MONED Fld(1, 20, AC_MSKB2)
#define RG_HDMI_0_PLL_POSDIV Fld(2, 18, AC_MSKB2)
#define RG_HDMI_0_PLL_PREDIV Fld(2, 16, AC_MSKB2)
#define RG_HDMI_0_PLL_PWD Fld(1, 15, AC_MSKB1)
#define RG_HDMI_0_PLL_VODEN Fld(1, 14, AC_MSKB1)
#define RG_HDMI_0_PLL_FMEN Fld(1, 13, AC_MSKB1)
#define RG_HDMI_0_PLL_DETEN Fld(1, 12, AC_MSKB1)
#define RG_HDMI_0_TESTE Fld(1, 0, AC_MSKB0)

#define ANA_2F0 (IO_VIRT_HDMI+0x754)
/* #define MHL_CFG_0 (IO_VIRT_HDMI+0x754))
#define MHL_CFG_1 (IO_VIRT_HDMI+0x755)
#define MHL_CFG_2 (IO_VIRT_HDMI+0x756)
#define MHL_CFG_3 (IO_VIRT_HDMI+0x757)
#define RG_HDMI_0_PLL_ICADJ Fld(2, 30, AC_MSKB3) //31:30
#define RG_HDMI_0_PLL_KVSEL Fld(2, 28, AC_MSKB3) //29:28
#define RG_HDMI_0_PLL_BCA Fld(1, 27, AC_MSKB3) //27
#define RG_HDMI_0_PLL_480PEN Fld(1, 26, AC_MSKB3) //26 */
#define RG_HDMI_0_CKMON_JITSEN Fld(1, 25, AC_MSKB3) /* 25 */
/* #define RG_HDMI_0_CKMON_DIV4EN Fld(1, 24, AC_MSKB3) //24
#define RG_HDMI_0_CKMON_JITEN Fld(1, 23, AC_MSKB2) //23
#define RG_HDMI_0_PLL_V11EN Fld(1, 22, AC_MSKB2) //22
#define RG_HDMI_0_FLAG_SEL Fld(1, 21, AC_MSKB2) //21
#define RG_HDMI_0_ABIST_EN Fld(1, 20, AC_MSKB2) //20 */
#define RG_HDMI_0_ABIST_SEL Fld(1, 19, AC_MSKB2)
/* #define RG_HDMI_0_CKMON_CKSET Fld(1, 17, AC_MSKB2) //17
#define RG_HDMI_0_CH0_MONEN Fld(1, 16, AC_MSKB2) //16
#define RG_HDMI_0_CH1_MONEN Fld(1, 15, AC_MSKB1) //15
#define RG_HDMI_0_CH2_MONEN Fld(1, 14, AC_MSKB1) //14 */
#define RG_HDMI_0_CKMON_PLLSET Fld(1, 13, AC_MSKB1)
#define RG_HDMI_0_EQ_CALEN_T Fld(1, 12, AC_MSKB1)
#define RG_HDMI_0_CH2_EQMC_T Fld(4, 8, AC_MSKB1) /*11:8 */
#define RG_HDMI_0_CH1_EQMC_T Fld(4, 4, AC_MSKB0) /*7:4 */
#define RG_HDMI_0_CH0_EQMC_T Fld(4, 0, AC_MSKB0) /*3:0 */

#define ANA9_INTF_CFG6 (IO_VIRT_HDMI+0x758)
#define RG_HDMI_0_REV Fld(31, 0, AC_FULLB3)

#if 1
#define RGS_HDMI_RX_Normal_0_CFG3 (IO_VIRT_HDMI+0x768)
#define RGS_HDMI_0_CH0_EQMM_T Fld(1, 31, AC_MSKB3)
#define RGS_HDMI_0_CH1_EQMM_T Fld(1, 30, AC_MSKB3)
#define RGS_HDMI_0_CH2_EQMM_T Fld(1, 29, AC_MSKB3)
#endif
/* Exist in 3363? not confirm */
#define AUD_INTF_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b0))/* Note: This Mt8555 does not exist */
#define AUD_INTF_1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b0))
#define AUD_INTF_1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b1))
#define AUD_INTF_1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0b2))
...
#define RG_PLL_PWD Fld(1, 15, AC_MSKB1) /* 16 */
/*
#elif CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3368
#define ANA_INTF_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a0))
 #define ANA_INTF_0_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a0))
 #define ANA_INTF_0_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a1))
 #define ANA_INTF_0_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a2))
 #define ANA_INTF_0_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a3))
       #define ANA_INTF_1_31_16 Fld(16, 16, AC_FULLW32) //31:16
       #define RG_CDR_RST Fld(1, 31, AC_MSKB3)//31
       #define RG_CDR_STOP Fld(1, 30, AC_MSKB3)//30
       #define RG_ATEST_EN Fld(1, 28, AC_MSKB3)//29
       #define RG_ANAMON Fld(3, 24, AC_MSKB3)//26
       #define RG_CH0_CDRLPI Fld(7, 16, AC_MSKB2)//25:24
       #define RG_CH1_CDRLPI Fld(7, 8, AC_MSKB1)//25:24
       #define RG_CH2_CDRLPI Fld(7, 0, AC_MSKB0)//25:24
...
#define ANA_INTF_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0a8))
 ...
 #define ANA_INTF_2_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x0ab))
   ...
   #define RG_HDMI_0_MHLEN Fld(1, 31, AC_MSKB3)// 30
   #define RG_HDMI_0_MHLMODE Fld(1, 30, AC_MSKB3)// 30
   #define RG_HDMI_0_FTMODE Fld(1, 29, AC_MSKB3)// 30
   #define RG_PI_EN Fld(1, 28, AC_MSKB3)// 30
   #define RG_KPGAIN Fld(3, 24, AC_MSKB3)// 30
   #define RG_PLLCK_EN Fld(1, 21, AC_MSKB2)
   #define RG_RXAFE_EN_SW Fld(1, 20, AC_MSKB2)
   ...
   #define RG_RXAFECH2_EN Fld(1, 17, AC_MSKB2)
   #define RG_TERM_EN Fld(1, 16, AC_MSKB2)
   #define RG_HDMI_0_ZSEL_EN Fld(1, 15, AC_MSKB1)
   #define RG_HDMI_0_TERM_MODE Fld(1, 14, AC_MSKB1)
   #define RG_RX_MODE Fld(2, 12, AC_MSKB1)
   #define RG_TEST_SEL Fld(1, 8, AC_MSKB1)
   #define RG_EQ_GAIN Fld(2, 4, AC_MSKB0)
   #define RG_DEEPCLRCLK_PDB Fld(1, 1, AC_MSKB0)
...
AAC Exception : */
#define EXP_H_RESOLUTION_CHG Fld(1, 31, AC_MSKB3)
#define EXP_SYNC_POLARITY_CHG Fld(1, 30, AC_MSKB3)
#define EXP_INTERLACE_CHG Fld(1, 29, AC_MSKB3)
#define EXP_FS_CHG Fld(1, 28, AC_MSKB3)
#define EXP_CTS_REUSED Fld(1, 27, AC_MSKB3)
#define EXP_AFIFO_OVERRUN Fld(1, 26, AC_MSKB3)
#define EXP_AFIFO_UNDERRUN Fld(1, 25, AC_MSKB3)
#define EXP_HDMI_MODE_CHG Fld(1, 24, AC_MSKB3)
#define EXP_CLOCK_SWITCH Fld(1, 23, AC_MSKB2)
#define EXP_SYNC_DETECT Fld(1, 22, AC_MSKB2)
#define EXP_INFOFRM_CP_CHG Fld(1, 21, AC_MSKB2)
#define EXP_VIDEO_CLK_CHG Fld(1, 20, AC_MSKB2)
#define EXP_ARC_CTS_CHG Fld(1, 19, AC_MSKB2)
#define EXP_ARC_N_CHG Fld(1, 18, AC_MSKB2)
#define EXP_PLL_UNLOCKED Fld(1, 17, AC_MSKB2)
#define EXP_CABLE_UNPLUG Fld(1, 16, AC_MSKB2)
...
#define AAC_SM_SEL_1T Fld(1, 0, AC_MSKB0)
...
#define CAPTURE_CNT_WP Fld(1, 24, AC_MSKB3)
#define FORMAT_CHANGE_EXP_EN Fld(1, 8, AC_MSKB1)
#define EXP_EN Fld(8, 0, AC_FULLB0) /* 7:0 */
/* AAC Exception */
#define EXP_FN_CLK_CHG Fld(1, 2, AC_MSKB0)
#define EXP_LINK_ERROR Fld(1, 1, AC_MSKB0)
#define EXP_V_RESOLUTION_CHG Fld(1, 0, AC_MSKB0)
...
#define DS_HDMI_MODE Fld(1, 20, AC_MSKB2)
#define DS_CASC_EXCEED Fld(1, 19, AC_MSKB2)
#define DS_DEPTH Fld(3, 16, AC_MSKB2) /*18:16 */
#define DS_DEV_EXCEED Fld(1, 15, AC_MSKB1)
...
#define OUTBOX_FULL_WP Fld(1, 31, AC_MSKB3)
#define DDC_OUTBOX_FULL Fld(1, 25, AC_MSKB3)
#define INBOX_FULL Fld(1, 24, AC_MSKB3)
...
#define EPCM_WP Fld(1, 23, AC_MSKB2)
#define MSIF_UNLOCK Fld(1, 22, AC_MSKB2)
#define LD_KSV Fld(1, 21, AC_MSKB2)
#define EPCM Fld(5, 16, AC_MSKB2) /*20:16 */
#define OTP_UNLOCKED Fld(1, 15, AC_MSKB1)
#define OTP_BIST2_ERR Fld(1, 14, AC_MSKB1)
#define OTP_BIST1_ERR Fld(1, 13, AC_MSKB1)
#define OPT_DN_KSV Fld(1, 12, AC_MSKB1)
#define MSIF_ACK_ERR Fld(1, 11, AC_MSKB1)
#define MSIF_SDA_ERR Fld(1, 10, AC_MSKB1)
#define OTP_BIST0_ERR Fld(1, 9, AC_MSKB1)
#define MSIF_CMD_DONE Fld(1, 8, AC_MSKB1)
#define EPA_PAGE Fld(1, 0, AC_MSKB0)
...
#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
#define RG_PCW_CTRL            Fld(16, 16, AC_FULLW32) /*31:16    for >=8580 */
#define RG_PCW_LEVEL_SHIFT     Fld(1, 11, AC_MSKB1)    /* 11       for >=8580 */
#define RG_FBDIV_SEL_SW        Fld(1, 10, AC_MSKB1)    /* 10       for >=8580 */
#define RG_PCW_CHG_SEL_SW      Fld(1, 9, AC_MSKB1)     /* 9         for >=8580 */
#define RG_PCW_NCPO_CHG_SEL_SW Fld(1, 8, AC_MSKB1)     /* 8         for >=8580 */
#endif
#define CTS_THRESH Fld(4, 3, AC_MSKB0) /*6:3 */
#define MCLK_LOOPBACK Fld(1, 2, AC_MSKB0)
#define LOG_WIN_ENA Fld(1, 1, AC_MSKB0)
#define POST_DIV2_ENA Fld(1, 0, AC_MSKB0)
#define REPEATER_KSV (IO_VIRT_HDMI+(IO_HDMI_BASE+0x11C))
#define KSV_STOP_PLS_SEL Fld(1, 11, AC_MSKB1) /*31 */
#define KSV_STOP Fld(1, 10, AC_MSKB1) /*31 */
#define KSV_RISC_WR_SEL Fld(1, 9, AC_MSKB1) /*31 */
#define KSV_DATA (IO_VIRT_HDMI+(IO_HDMI_BASE+0x120))
...
#define reservedregister_N_HDMI_CTRL1_11 Fld(1, 31, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL1_10 Fld(1, 30, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL1_9 Fld(1, 29, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL1_8 Fld(1, 28, AC_MSKB3)
/*#define TT88_3_SPDIF_CS_SEL Fld(2, 26, AC_MSKB3) //27:26 */
/*#define TT88_3_SPDIF_CH_SEL Fld(2, 24, AC_MSKB3) //25:24 */
#define reservedregister_N_HDMI_CTRL1_7 Fld(1, 23, AC_MSKB2)
#define reservedregister_N_HDMI_CTRL1_6 Fld(1, 22, AC_MSKB2)
...
#define reservedregister_N_HDMI_CTRL1_5 Fld(1, 7, AC_MSKB0)
#define reservedregister_N_HDMI_CTRL1_4 Fld(1, 6, AC_MSKB0)
#define reservedregister_N_HDMI_CTRL1_3 Fld(1, 5, AC_MSKB0)
/*#define TT88_0_NEW_GAMUT_ONLY Fld(1, 4, AC_MSKB0) //4 */
/*#define TT88_0_PHASE_SW Fld(1, 3, AC_MSKB0) //3 */
#define reservedregister_N_HDMI_CTRL1_2 Fld(1, 2, AC_MSKB0)
#define reservedregister_N_HDMI_CTRL1_1 Fld(1, 1, AC_MSKB0)
#define reservedregister_N_HDMI_CTRL1_0 Fld(1, 0, AC_MSKB0)
...
#define reservedregister_N_HDMI_CTRL2_7 Fld(1, 31, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_6 Fld(1, 30, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_5 Fld(1, 29, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_4 Fld(1, 28, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_3 Fld(1, 27, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_2 Fld(1, 26, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_1 Fld(1, 25, AC_MSKB3)
#define reservedregister_N_HDMI_CTRL2_0  Fld(1, 24, AC_MSKB3)
...
#define TT89_STAT0_GCP_PHASE_OK Fld(1, 5, AC_MSKB0)
#define TT89_STAT0_GCP_PHASE Fld(1, 4, AC_MSKB0)
#define TT89_STAT0_NO_VALID_NEW_PP Fld(1, 3, AC_MSKB0)
#define TT89_STAT0_NO_VALID_NEW_CD Fld(1, 2, AC_MSKB0)
#define TT89_STAT0_GCP_PP_ERR Fld(1, 1, AC_MSKB0)
#define TT89_STAT0_GCP_CD_ERR Fld(1, 0, AC_MSKB0)
...
#define HDMI_DIG_MACRO (IO_VIRT_HDMI+(IO_HDMI_BASE+0x260))
#define RG_C_DATA_SYNC_AUTO  Fld(1, 15, AC_MSKB1)

#define CKDT_RST  (IO_VIRT_HDMI+(IO_HDMI_BASE+0x264))
/* #if CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT8555
#define HDMI_MACRO_RESET Fld(1, 17, AC_MSKB2) */
#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
#define HDMI_MACRO_RESET Fld(1, 9, AC_MSKB1)
#endif
#define RG_Mux_Setting  Fld(2, 18, AC_MSKB1) /*18 19 */

#define HDMI_DIG_MACRO3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x26c))
#define OUT_REPACK_422 Fld(1, 15, AC_MSKB1)

#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
#define HDMI_AUD_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x270))
/*#define DDC_SEL Fld(1, 25, AC_MSKB3) //15  >=8580 valid */
#define PWR5V_SEL Fld(1, 24, AC_MSKB3) /*15 >=8580 valid */


#define HDMI_CH0_EQ_STATUS (IO_VIRT_HDMI+(IO_HDMI_BASE+0x274))
#define RG_HDMI_CH0_STATUS  Fld(16, 0, AC_MSKB1) /*15~0 */
#define RG_HDMI_CH0_EQERR  Fld(4, 16, AC_MSKB1) /*19:16 */

#define HDMI_CH1_EQ_STATUS (IO_VIRT_HDMI+(IO_HDMI_BASE+0x278))
#define RG_HDMI_CH1_STATUS  Fld(16, 0, AC_MSKB1) /*15~0 */
#define RG_HDMI_CH1_EQERR  Fld(4, 16, AC_MSKB1) /*19:16 */

#define HDMI_CH2_EQ_STATUS (IO_VIRT_HDMI+(IO_HDMI_BASE+0x27C))
#define RG_HDMI_CH2_STATUS  Fld(16, 0, AC_MSKB1) /*15~0 */
#define RG_HDMI_CH2_EQERR  Fld(4, 16, AC_MSKB1) /*19:16 */

#else

#define HDMI_EQ_STATUS (IO_VIRT_HDMI+(IO_HDMI_BASE+0x27c))
#define RG_HDMI_CH0_STATUS  Fld(16, 0, AC_MSKB1) /*15~0 */
#define RG_HDMI_CH0_EQERR  Fld(4, 16, AC_MSKB1) /*19:16 */
#define RG_HDMI_CH1_EQERR  Fld(4, 20, AC_MSKB1) /*23:20 */
#define RG_HDMI_CH2_EQERR  Fld(4, 24, AC_MSKB1) /*24:27 */

#endif

#define HDCP_DEV   (IO_VIRT_HDMI+(IO_HDMI_BASE+0x280))
#define HDCP_ADDR  (IO_VIRT_HDMI+(IO_HDMI_BASE+0x284))
#define HDCP_DATA  (IO_VIRT_HDMI+(IO_HDMI_BASE+0x288))

#define AUD_PKT_HEAER (IO_VIRT_HDMI+(IO_HDMI_BASE+0x294))
#define AUD_PKT_HEAER_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x294))
#define AUD_PKT_HEAER_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x295))
#define AUD_PKT_HEAER_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x296))
#define AUD_PKT_HEAER_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x297))
#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
#define AUD_LAYOUT_INFO Fld(1, 12, AC_MSKB1)/* 12:12 */
#define AUD_8CH_BLOCK_INFO Fld(4, 20, AC_MSKB1)/* 23:20 */
#define AUD_8CH_FLAT_INFO Fld(4, 16, AC_MSKB1)/* 19:16 */
#define AUD_8CH_PRESENT_INFO Fld(4, 8, AC_MSKB1)/* 11:8 valid channels */
#else
#define AUD_LAYOUT_INFO Fld(1, 12, AC_MSKB1)/* 12:12 */
#define AUD_8CH_BLOCK_INFO Fld(4, 8, AC_MSKB1)/* 11:8 */
#define AUD_8CH_FLAT_INFO Fld(4, 4, AC_MSKB0)/* 7:4 */
#define AUD_8CH_PRESENT_INFO Fld(4, 0, AC_MSKB0)/* 3:0 valid channels */
#endif

#if (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX) || (CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_MT3360)
#define ISRC1RX0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2AC))
#define ISRC1RX0_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2AE))

#define VS_ALL_PACKET_RECEIVE Fld(1, 1, AC_MSKB0)
#define ISRC1_ALL_PACKET_RECEIVE Fld(1, 0, AC_MSKB0)




#define VSRX0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2C0))
#endif
#if CONFIG_CHIP_VER_CURR == CONFIG_CHIP_VER_AC83XX
#define MHL_HDCP_CTRL_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E4))
#define MHL_HDCP_CTRL_0_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E4))
#define MHL_HDCP_CTRL_0_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E5))
#define MHL_HDCP_CTRL_0_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E6))
#define MHL_HDCP_CTRL_0_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E7))
#define RISC_ADDR_CNT Fld(8, 8, AC_FULLB1) /*15:8 */
#define RISC_DBUS Fld(8, 0, AC_FULLB0) /*7:0 */

#define MHL_HDCP_CTRL_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E8))
#define MHL_HDCP_CTRL_1_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E8))
#define MHL_HDCP_CTRL_1_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2E9))
#define MHL_HDCP_CTRL_1_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EA))
#define MHL_HDCP_CTRL_1_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EB))
/*#define RISC_HDCP_CLK_DIV Fld(8, 8, AC_FULLB1) //15:8 */
#define HDCP_RISC_SEL Fld(1, 1, AC_MSKB0)
#define RISC_ADDR_PAGE Fld(1, 0, AC_MSKB0)

#define MHL_CFG (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EC))
#define MHL_CFG_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EC))
#define MHL_CFG_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2ED))
#define MHL_CFG_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EE))
#define MHL_CFG_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EF))
/*#define REG_CHANNEL_SEL2 Fld(1, 31, AC_MSKB3) //31
#define REG_CHANNEL_SEL1 Fld(1, 30, AC_MSKB3) //30
#define REG_CHANNEL_SEL0 Fld(1, 29, AC_MSKB3) //29 */
#define REG_MHL_CTRL_SEL Fld(1, 27, AC_MSKB3)
#define REG_PACKET_VD_SEL Fld(1, 21, AC_MSKB2)
#define REG_MHL_CALIB_DATA Fld(5, 16, AC_MSKB2) /*20:16 */
#define REG_MHL_IMPCAL_EN Fld(1, 15, AC_MSKB1)
#define REG_MHL_IMPCAL_REG_EN Fld(1, 14, AC_MSKB1)
#define REG_MHL_CALIB_SEL Fld(1, 13, AC_MSKB1)
#define REG_MHL_CALIB_RSTB Fld(1, 12, AC_MSKB1)
#define REG_MHL_SAMP_SEL Fld(2, 10, AC_MSKB1) /*11:10 */

#if 0
#define ANA_2F0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2F0))
#define MHL_CFG_0 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EC))
#define MHL_CFG_1 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2ED))
#define MHL_CFG_2 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EE))
#define MHL_CFG_3 (IO_VIRT_HDMI+(IO_HDMI_BASE+0x2EF))
#define RG_HDMI_0_PLL_ICADJ Fld(2, 30, AC_MSKB3) /*31:30 */
#define RG_HDMI_0_PLL_KVSEL Fld(2, 28, AC_MSKB3) /*29:28 */
#define RG_HDMI_0_PLL_BCA Fld(1, 27, AC_MSKB3)
#define RG_HDMI_0_PLL_480PEN Fld(1, 26, AC_MSKB3)
#define RG_HDMI_0_CKMON_JITSEN Fld(1, 25, AC_MSKB3)
#define RG_HDMI_0_CKMON_DIV4EN Fld(1, 24, AC_MSKB3)
#define RG_HDMI_0_CKMON_JITEN Fld(1, 23, AC_MSKB2)
#define RG_HDMI_0_PLL_V11EN Fld(1, 22, AC_MSKB2)
#define RG_HDMI_0_FLAG_SEL Fld(1, 21, AC_MSKB2)
#define RG_HDMI_0_ABIST_EN Fld(1, 20, AC_MSKB2)
#define RG_HDMI_0_ABIST_SEL Fld(1, 19, AC_MSKB2)
#define RG_HDMI_0_CKMON_CKSET Fld(1, 17, AC_MSKB2)
#define RG_HDMI_0_CH0_MONEN Fld(1, 16, AC_MSKB2)
#define RG_HDMI_0_CH1_MONEN Fld(1, 15, AC_MSKB1)
#define RG_HDMI_0_CH2_MONEN Fld(1, 14, AC_MSKB1)
#define RG_HDMI_0_CKMON_PLLSET Fld(1, 13, AC_MSKB1)
#define RG_HDMI_0_EQ_CALEN Fld(1, 12, AC_MSKB1)
...
#endif   /*3363 which is define in ANA9 Register map by lifang Wang */
