...
extern void   tvd_hal_open(u32 u4UVSwap);
extern void   tvd_hal_close(void);
extern void   tvd_channel_on_off(u32 channel, bool on_off);
void tvd_clock_on_off(bool on_off);
extern bool   tvd_channel_port_config(u32 channel, u32 port_num, u32 u4Rear, u32 u4CfgType);
extern bool   tvd_get_di_flag(void);
extern void tvd_hal_notify_close_wch(void);
extern TVD_SIG_STATE_T tvd_hal_get_signal_status(void);
