...
/*
 * Some new specification is listed by ATC_Linux platform.
 * Update by Joshua Wang. @02/06/2017			!!!
 * New Micro defined in makefile is used for different plarform.
 * AEE_FOR_ANDROID <- AEE_ATC_SPEC
 */

/*#define AEE_ATC_SPEC   1	*/
