...
int mini_rdump_reserve_memory(struct reserved_mem *rmem, unsigned long node, const char *uname)
{
...
RESERVEDMEM_OF_DECLARE(reserve_memory_minirdump, "minirdump-reserve-memory", mini_rdump_reserve_memory);
