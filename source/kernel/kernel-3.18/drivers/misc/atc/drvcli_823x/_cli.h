...
{
#endif
extern ulong CLI_IO_BASE;

#ifndef IO_VIRT
#define IO_VIRT             (CLI_IO_BASE)
#endif


#define RS232_VIRT                  (CLI_IO_BASE + 0x0000C000)
#define RS232_BASE_VA				(CLI_IO_BASE + 0x0000C000)
#define CKGEN_BASE_VA				(CLI_IO_BASE + 0x0000C000)
#define CKGEN_VIRT_CLI                  (CLI_IO_BASE + 0x0000D000)

#define UART_READ32(REG)            \
	__raw_readl((const volatile void *)(CLI_IO_BASE + REG))
#define UART_WRITE32(VAL, REG)      __raw_writel(VAL, (volatile void *)(CLI_IO_BASE + REG))
