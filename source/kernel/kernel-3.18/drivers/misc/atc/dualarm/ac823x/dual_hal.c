...
{\
    ...
    while((bitsmask) & __bim2_readl(reg)) \
    {\
...
extern u32 __bim_readl(u64 regaddr);
extern u32 __bim2_readl(u64 regaddr);
extern void __bim_writel(u64 regaddr, u32 regval32);
extern void __bim2_writel(u64 regaddr, u32 regval32);

static BOOL _fgDualHALSetParmeterGroup0(UINT32 u4P1, UINT32 u4P2, UINT32 u4P3, UINT32 u4P4)
{
  //while(MESSAGEDIRMASK & __bim2_readl(REG_RW_SINFO0_REG));
  WAIT_BITS_ZERO(REG_RW_SINFO0_REG, MESSAGEDIRMASK);
  __bim2_writel(REG_RW_SINFO1_REG, u4P2); 
  __bim2_writel(REG_RW_SINFO2_REG, u4P3);  
  __bim2_writel(REG_RW_SINFO3_REG, u4P4);
  __bim2_writel(REG_RW_SINFO0_REG, u4P1); //must be last
  return TRUE;
}

static BOOL _fgDualHALGetParmeterGroup0(UINT32 *pu4P1, UINT32 *pu4P2, UINT32 *pu4P3, UINT32 *pu4P4)
{
  *pu4P1 = __bim2_readl(REG_RW_SINFO0_REG);
  *pu4P2 = __bim2_readl(REG_RW_SINFO1_REG);
  *pu4P3 = __bim2_readl(REG_RW_SINFO2_REG);
  *pu4P4 = __bim2_readl(REG_RW_SINFO3_REG);

  //clear message
  __bim2_writel(REG_RW_SINFO0_REG, 0);
  return TRUE;    
}	

static BOOL _fgDualHALSetParmeterGroup1(UINT32 u4P1, UINT32 u4P2, UINT32 u4P3, UINT32 u4P4)
{
  //while(MESSAGEDIRMASK & __bim2_readl(REG_RW_SINFO4_REG));
  WAIT_BITS_ZERO(REG_RW_SINFO4_REG, MESSAGEDIRMASK);
  __bim2_writel(REG_RW_SINFO5_REG, u4P2);
  __bim2_writel(REG_RW_SINFO6_REG, u4P3);
  __bim2_writel(REG_RW_SINFO7_REG, u4P4);
  __bim2_writel(REG_RW_SINFO4_REG, u4P1);
  return TRUE;  
}
#if 0
static BOOL _fgDualHALGetParmeterGroup1(UINT32 *pu4P1, UINT32 *pu4P2, UINT32 *pu4P3, UINT32 *pu4P4)
{
  *pu4P1 = __bim2_readl(REG_RW_SINFO4_REG);
  *pu4P2 = __bim2_readl(REG_RW_SINFO5_REG);
  *pu4P3 = __bim2_readl(REG_RW_SINFO6_REG);
  *pu4P4 = __bim2_readl(REG_RW_SINFO7_REG);

  //clear message
  __bim2_writel(REG_RW_SINFO4_REG, 0);
  return TRUE;
}

static BOOL _fgDualHALSetParmeterGroup2(UINT32 u4P1, UINT32 u4P2, UINT32 u4P3, UINT32 u4P4)
{
  //while(MESSAGEDIRMASK & __bim2_readl(REG_RW_SINFO8_REG));
  WAIT_BITS_ZERO(REG_RW_SINFO8_REG, MESSAGEDIRMASK);
  __bim2_writel(REG_RW_SINFO9_REG, u4P2); 
  __bim2_writel(REG_RW_SINFOA_REG, u4P3);  
  __bim2_writel(REG_RW_SINFOB_REG, u4P4);
  __bim2_writel(REG_RW_SINFO8_REG, u4P1);
  return TRUE;  
}
#endif
static BOOL _fgDualHALGetParmeterGroup2(UINT32 *pu4P1, UINT32 *pu4P2, UINT32 *pu4P3, UINT32 *pu4P4)
{
  *pu4P1 = __bim2_readl(REG_RW_SINFO8_REG);
  *pu4P2 = __bim2_readl(REG_RW_SINFO9_REG);
  *pu4P3 = __bim2_readl(REG_RW_SINFOA_REG);
  *pu4P4 = __bim2_readl(REG_RW_SINFOB_REG);

  //clear message
  __bim2_writel(REG_RW_SINFO8_REG, 0);
  return TRUE;    
}
#if 0
static BOOL _fgDualHALSetParmeterGroup3(UINT32 u4P1, UINT32 u4P2, UINT32 u4P3, UINT32 u4P4)
{
//  while(MESSAGEDIRMASK & __bim2_readl(REG_RW_SINFOC_REG));
  WAIT_BITS_ZERO(REG_RW_SINFOC_REG, MESSAGEDIRMASK);
  __bim2_writel(REG_RW_SINFOD_REG, u4P2);
  __bim2_writel(REG_RW_SINFOE_REG, u4P3);
  __bim2_writel(REG_RW_SINFOF_REG, u4P4);
  __bim2_writel(REG_RW_SINFOC_REG, u4P1);
  return TRUE;
}
#endif
static BOOL _fgDualHALGetParmeterGroup3(UINT32 *pu4P1, UINT32 *pu4P2, UINT32 *pu4P3, UINT32 *pu4P4)
{
  *pu4P1 = __bim2_readl(REG_RW_SINFOC_REG);
  *pu4P2 = __bim2_readl(REG_RW_SINFOD_REG);
  *pu4P3 = __bim2_readl(REG_RW_SINFOE_REG);
  *pu4P4 = __bim2_readl(REG_RW_SINFOF_REG);

  //clear message
  __bim2_writel(REG_RW_SINFOC_REG, 0);
  return TRUE;
}
...
BOOL fgDualHALStart(void)
{
  ...
  //Step.1 Reset ARM2
  u4Tmp1 = __bim_readl(REG_RW_RISCRST);  
  u4Tmp1 = u4Tmp1 | RISCRST_RISC1_RESET;
  __bim_writel(REG_RW_RISCRST, u4Tmp1);
...
BOOL fgDualHALStop(void)
{
  ...
  __bim_writel(REG_RW_RISCRST, RISCRST_PASSWD);
  __bim_writel(REG_RW_RISCRST, RISCRST_RISC1_PASSWD);
...
{
  __bim2_writel(REG_RW_REMAP, __bim2_readl(REG_RW_REMAP) | REMAP_BIT);
  return TRUE;
}
...
{
  __bim2_writel(REG_RW_DRAMB_OFF, u4Offset);
  return TRUE;
}	
...
{
  int count = 0;
  while (__bim2_readl(REG_ARM2_IRQST) & (1U << 23))
  {
	  count++;
	  if (count > 500) {
		  count = 0;
  ...
  __bim_writel(REG_RW_TOCORISC, TOCORISC_INTR);  
