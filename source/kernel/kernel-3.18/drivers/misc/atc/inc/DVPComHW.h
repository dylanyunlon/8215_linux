...
DWORD   DVPComHW_SendData8032(BYTE* pData, DWORD dwSize);
DWORD   DVPComHW_SendDataPT110(BYTE* pData, DWORD dwSize);
DWORD   DVPComHW_ReceiveData(BYTE* pData, DWORD dwSize, BOOL *fgFromPT);
