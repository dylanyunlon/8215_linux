...
//#endif
    // Add New Post process type to here ......
#if ((1==CONFIG_DRV_SUPPORT_PARTY) && (defined(CONFIG_DRV_SUPPORT_PARTY)))
    AUD_SE_PARTY = 0x0FD,                           // Party (aud_se_party_v2)
#endif
    // Add New Post process type to here ......
...
//extern bool AUD_DRVGetDecodeType(_u8 u1DecId,  AUD_DRV_STREAM_FROM_T * peStreamFrom,AUD_DRV_FMT_INFO_T * prDecType);
//extern void AUD_SetAvSynMode(_u8 u1DecId, AV_SYNC_MODE_T eSynMode);
...
#ifdef ISPDIF_FINETUNE_NEW_METHOD
//extern bool fgAudinGetCurrentOutputBank(_u32 *pu4Banks);
#endif
