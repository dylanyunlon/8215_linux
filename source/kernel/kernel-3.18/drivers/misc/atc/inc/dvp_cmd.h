...
//for dvp reserved mem offset shared for drm driver
#define DVP_SHAREINFO_BASE_ADDR        (0x0071B800)
#define SI_DRM_MEMORY_ADDR             (DVP_SHAREINFO_BASE_ADDR + (78 * 32))  // for AP, get PhysicAddr by added DVP_BUFFER_PA
...
#define AP_CMD_FUNC_DIGITAL_NUM                0x70  //choose digital num
...
//CD Ripping
#define AP_CMD_RIP_TRACK                       0x81   //rip current track
...
#define DVP_CMD_FL_CODEC                       0x34  // enter sub-dir/to parent dir
...
#define DVP_CMD_FL_ACK_RESULT                  0x36    // ACK result
    ...
    #define AUTO_UPDATE_DIR_REUSLT      0x02    
...
#define DVP_CMD_PBC_SHUFFLE_MODE               0x5d  // Shuffle On/Off
...
#define DVP_CMD_PBC_AUDIO                      0x61  // channel, Right /Left
#define DVP_CMD_PBC_SUBTITLE                   0x62  // DVD/MP4 subtitle
#define DVP_CMD_PBC_ANGLE                      0x63  // DVD Angle
#define DVP_CMD_PBC_PBC                        0x64  // VCD PBC ON/OFF
#define DVP_CMD_PBC_FILE_PATH                  0x65  // playing file path
#define DVP_CMD_PBC_CHANNEL                    0x66
#define DVP_CMD_MPS_ERROR                      0x67    
...
#define DVP_CMD_PBC_FIRST_THUMBNAIL_IDX        0x69   //first thumbnail idex
...
#define DVP_CMD_INVALID_FSTAB                  0x80
...
#define DVP_CMD_AUD_SAMPLE_RATE                0xA4    // audio FS.
...
#define DVP_SEND_CMD_TIMEOUT                   0xf4
...
#define AP2PT_LOG_CHECK_OUTPUT                 0x07  //Write  PT110  log OK    
#define AP2PT_CHECK_LASTMEMORY                 0x08
#define AP2PT_RIP_WR_OK                        0x80  //Rip Write Ok
...
#define PT2AP_LOG_DATA_OUTPUT                  0xa2  //Set PT110 log
