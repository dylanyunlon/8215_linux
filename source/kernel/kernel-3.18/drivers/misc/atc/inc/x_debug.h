...
#if 0
#if (CONFIG_SECTION_BUILD_ARM2 || CONFIG_SECTION_BUILD || CONFIG_SECTION_BUILD_LINUX_PROG)
...
#define _TINT			((INT32) 1 << 17)		/* Enable Thread id display. */
