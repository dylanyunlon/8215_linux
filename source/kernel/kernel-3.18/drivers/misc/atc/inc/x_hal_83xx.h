...
#define LIMIT_DRAM_SIZE                                 1

#if LIMIT_DRAM_SIZE
  //TODO : Use Symtem Configuration
  // Limit DRAM Size to 384M
  #define DRAM_SIZE                        0x18000000

  //TODO : Use Symtem Configuration
  // Limit Channel 1 Size to 384M
  #define DRAM_CAHNNEL_1_SIZE              0x10000000
#endif
...
#define _TO_VA(x)					((x) + IO_BASE_VA - IO_BASE)
...
//#define RS232_BASE_VA                                   (IO_BASE_VA + 0x0C000)
#define DRAM1_BASE                                      (IO_BASE + 0x0D000)
#define USB_BASE                                        (IO_BASE + 0x0E000)
#define USB3_BASE                                        (IO_BASE + 0x0F000)
...
#endif
#define  AUXADC_BASE                                              (IO_BASE + 0xA9000)
//#define Resv_BASE                                        (IO_BASE + 0x1F000)
#define VDOUT_MISC                                      (IO_BASE + 0x1F000)  //MT8555
#define VDOUT_AUX_BASE                                  (IO_BASE + 0x43000) //MT8530_PMX  //SVDO
...
#define IMAGE2_BASE_VA                                  (IO_BASE_VA + 0x40000)
...
#define DDMA_BASE                                       (IO_BASE + 0x4A000)
...
#define SMART_CARD_BASE                                 (IO_BASE_VA + 0x50000)
...
#define DEMUX0_BASE                                      (IO_BASE_VA + 0x12000)
#define DEMUX1_BASE                                      (IO_BASE_VA + 0x13000)
#define DEMUX2_BASE                                      (IO_BASE_VA + 0x14000)
#define DEMUX4_BASE					                     (IO_BASE_VA + 0x16500)
#define DEMUX5_BASE					                     (IO_BASE_VA + 0x16BB8)
#define DEMUX6_BASE					                     (IO_BASE_VA + 0x171F8)
#define DEMUX7_BASE					                     (IO_BASE_VA + 0x17378)
#define DEMUX8_BASE					                     (IO_BASE_VA + 0x18000)
#define DDI_BASE                                         (IO_BASE_VA + 0x19000)

#define STC_BASE                                         (IO_BASE + 0x3B000)
...
typedef enum
{
  ...
  IC_83XX             = 0x8555,           //
  IC_83XX_VER_A       = 0x8556,           //
  IC_83XX_VER_B       = 0x8557,           //
