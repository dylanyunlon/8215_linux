...
#define DRVT_PVR_DCC                         ((DRV_TYPE_T)  151)
#define DRVT_PVR_TS_PES_PACKET         ((DRV_TYPE_T)  152)
...
#define DRVT_OPECON                 ((DRV_TYPE_T) 392)


#define DRVT_VENC                                  ((DRV_TYPE_T)  393)
#define DRVT_VENC_ESBITSTREAM          ((DRV_TYPE_T)  394)

#define DRVT_FMC                                  ((DRV_TYPE_T)  395)
#define DRVT_ESN        ((DRV_TYPE_T)  396)
