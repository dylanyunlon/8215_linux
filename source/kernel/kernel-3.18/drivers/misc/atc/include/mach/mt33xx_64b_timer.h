#ifndef __MT33XX_64B_TIMER_H
#define __MT33XX_64B_TIMER_H

#define BIM_64b_TIMER_NUM	1
#define BIM_T64b_LO		0x728
#define BIM_T64b_HI		0x72C
#define BIM_T64b_EN		0x730

typedef struct {
	u32 u4L;		//Number of timer interrupts from startup
	u32 u4H;		//System cycles from last timer interrupt
} T64b_RAW_TIME_T;

typedef struct {
	u32 u4Seconds;	//Number of seconds from startup
	u32 u4Micros;		//Remainder in microsecond
} HAL_TIME_T;
