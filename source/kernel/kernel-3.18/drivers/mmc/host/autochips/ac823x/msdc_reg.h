...
#define	OFFSET_SDC_CMD_STS		(0x64) //FOR 8237
...
/*Only for SD/SDIO use , not for eMMC*/
...
#define	SDC_CMD_STS			REG_ADDR(SDC_CMD_STS) //FOR 8237
...
#define RD_VALID            		(0x1 << 27)
#define WR_VALID              		(0x1 << 26)
#define RD_VALID_SEL				(0x1 << 25)
#define WR_VALID_SEL				(0x1 << 24)
#define	WR_PTR_MARGIN				(0xFF << 16)
#define	EMMC50_BLK_LENGTH			(0x1FF << 0)
