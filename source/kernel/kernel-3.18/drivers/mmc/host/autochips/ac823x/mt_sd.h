...
#define MSDC_SIMULATE_ERROR  (0)
#define MSDC_DEBUG_ENABLE (0)

#define  MSDC_AUTOK_TO_MTZ  0
#define  MSDC_USE_CLK_GATE 0
...
#define REQ_MISS_INTERRUPT_ERR (0x1 << 8)

#define MAX_LOW_SPEED_TUNE_TIMES  (4)
...
#define MSDC_DATA1_INT      (0) // modify by dandan liu
...
struct msdc_hw {
	...
	unsigned char  clk_sr;/*clock pad slew rate*/
	unsigned char  clk_res;/*clk pin resistor*/
	unsigned char  cmd_drv;	/* command pad driving */
	unsigned char  cmd_sr;/*cmd pad slew rate*/
	unsigned char  cmd_res;/*cmd pin resistor*/
	unsigned char  dat_drv;	/* data pad driving */
	unsigned char  dat_sr; /*data pad slew rate*/
	unsigned char  dat_res;/*data pin resistor*/
	unsigned char  ds_drv;	/* eMMC5.0 DS pad driving */
	unsigned char  ds_sr;/*eMMC 5.0 DS pad slew rate driving*/
	unsigned char  ds_res;/*eMMC5.0 DS pin resistor*/
	...
	u8 cd_method;		/* card detect method*/
	int cd_gpio;		/*detect gpio*/
...
struct msdc_host {
	...
	u8						autok_hs200_tune_done;
	u8						autok_hs400_tune_done;
	u8						autok_sdr104_tune_done;
	...
	bool                    block_bad_card;
	#define	MAX_FATAL_ERR_TIMES  		(30)
	unsigned int					fatal_err_times;
