#ifndef AC83XX_AUTOK_H
#define AC83XX_AUTOK_H
...
#if 1
#define sdr_read32(reg)  		MSDC_READ32(reg) 
#define sdr_write32(reg,val)   	MSDC_WRITE32(reg,val)
#define sdr_set_bits(reg,bs)	MSDC_SET_BITS(reg, bs)
#define sdr_clr_bits(reg,bs)	MSDC_CLR_BITS(reg, bs)
#define sdr_set_field(reg, field,val)	MSDC_SET_FIELD(reg, field, val)
#define sdr_get_field(reg, field,val)	MSDC_GET_FIELD(reg, field, val)
#endif
...
#define ATC_SDIO_AUTOK_ENABLE 1
#endif
