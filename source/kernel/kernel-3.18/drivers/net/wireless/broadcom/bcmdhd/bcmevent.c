...
static const bcmevent_name_str_t bcmevent_names[] = {
	...
	BCMEVENT_NAME(WLC_E_EXT_AUTH_REQ),
	BCMEVENT_NAME(WLC_E_EXT_AUTH_FRAME_RX),
	BCMEVENT_NAME(WLC_E_MGMT_FRAME_TXSTATUS),
	BCMEVENT_NAME(WLC_E_MGMT_FRAME_OFF_CHAN_COMPLETE),
...
const char *wl_if_role2str(u8 role)
{
	switch (role) {
...
const char *wl_iftype2str(int iftype)
{
	switch (iftype) {
