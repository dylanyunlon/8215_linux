...
enum {
	DHD_STATE_PROBE_START   = 0,
	DHD_STATE_PROBE_FAIL    = 1,
	DHD_STATE_PROBE_SUCCESS = 2,
	DHD_STATE_REMOVE_START  = 3,
	DHD_STATE_REMOVE_DONE   = 4,
};
...
extern int pcie_host_detect_change(u32 slot, u32 enable);
#endif
