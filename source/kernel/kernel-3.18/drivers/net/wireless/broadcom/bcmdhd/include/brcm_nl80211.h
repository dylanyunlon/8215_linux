...
#ifdef CONFIG_ATC_AOSP_ENHANCEMENT // cypress wpa3 patch
#define NL80211_EXTERNAL_AUTH_START				0
#define NL80211_ATTR_EXTERNAL_AUTH_ACTION       260
#endif
...
#else // cypress wpa3 patch
	BRCM_VENDOR_SUBCMD_SET_PSK      = 9,
	BRCM_VENDOR_SUBCMD_EXTERNAL_AUTH = 10,
	BRCM_VENDOR_SCMD_ACS            = 11,
	BRCM_VENDOR_SCMD_MAX            = 12,
#endif
};
