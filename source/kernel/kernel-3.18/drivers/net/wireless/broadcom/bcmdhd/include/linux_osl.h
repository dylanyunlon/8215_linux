...
#ifdef CONFIG_ATC_AOSP_ENHANCEMENT
#define OSL_SYSUPTIME()		((uint32)(osl_sysuptime_us() / USEC_PER_MSEC))
#else
...
#ifdef CONFIG_ATC_AOSP_ENHANCEMENT // suppress PVS false positives
//-V:R_REG:1032
//-V:W_REG:1032
#endif
		...
		({ \
			...
			switch (sizeof(*(r))) { \
				case sizeof(uint8):	__osl_v = \
					_readb((volatile uint8*)(r)); break; \
				case sizeof(uint16):	__osl_v = \
					_readw((volatile uint16*)(r)); break; \
				case sizeof(uint32):	__osl_v = \
					_readl((volatile uint32*)(r)); break; \
				case sizeof(uint64):	__osl_v = \
					_readq((volatile uint64*)(r)); break; \
			} \
			__osl_v; \
		}), \
		OSL_READ_REG(osh, r)) \
...
#define W_REG(osh, r, v) do { \
	SELECT_BUS_WRITE(osh, \
		switch (sizeof(*(r))) { \
			case sizeof(uint8):	_writeb((uint8)(v), (volatile uint8*)(r)); break; \
			case sizeof(uint16):	_writew((uint16)(v), (volatile uint16*)(r)); break; \
			case sizeof(uint32):	_writel((uint32)(v), (volatile uint32*)(r)); break; \
			case sizeof(uint64):	_writeq((uint64)(v), (volatile uint64*)(r)); break; \
		}, \
