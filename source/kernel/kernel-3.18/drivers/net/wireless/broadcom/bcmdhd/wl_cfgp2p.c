...
static int wl_cfgp2p_set_mac_address(struct net_device *dev, void *addr);
#endif
...
#ifdef CONFIG_ATC_AOSP_ENHANCEMENT
	.ndo_set_mac_address = wl_cfgp2p_set_mac_address,
#endif
};
            ...
            chanspec_t chspec)
{
	...
	CFGP2P_INFO(("---cfg p2p_ifadd "MACDBG" %s %u\n",
...
#if defined(WL_CFG80211_P2P_DEV_IF)
#ifdef CONFIG_ATC_AOSP_ENHANCEMENT
				if (((struct wireless_dev *)cfgdev)->wiphy
...
static int wl_cfgp2p_set_mac_address(struct net_device *dev, void *addr)
{
	CFGP2P_INFO(("wl_cfgp2p_set_mac_address\n"));
	return 0;
}
#endif
...
wl_cfgp2p_add_p2p_disc_if(struct bcm_cfg80211 *cfg)
{
	...
	CFGP2P_INFO(("P2P interface registered\n"));
