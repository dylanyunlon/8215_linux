...
*/
	...
	#define BCNT_PATCH_BUF_HEADROOM (0)
#else
...
#define WMT_LPBK_BUF_LEN        (2048+WMT_LPBK_CMD_LEN)
...
typedef enum _ENUM_PKT_TYPE {
	...
	PKT_TYPE_CMD = 1,
	PKT_TYPE_EVENT = 2,
	_PKT_TYPE_MAX // PKT_TYPE_MAX conflict with skbuff.h
...
extern MTK_WCN_BOOL wmt_core_is_func_on(UINT32 type);

extern INT32 wmt_core_pwr_off_if_func_off(INT32 coredump_off);
