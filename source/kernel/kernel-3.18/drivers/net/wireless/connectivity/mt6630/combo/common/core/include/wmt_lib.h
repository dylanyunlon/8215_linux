...
/*
#define WMT_PWRON_RTY_DFT 2 remove for fix wifi turn on fail but lower layers has been turn on.
(put_act_op timeout is 4s, retry results in timeout.)
*/
#define WMT_PWRON_RTY_DFT 1
...
typedef struct _DEV_WMT_ {
	...
	OSAL_SLEEPABLE_LOCK func_onoff_lock;
...
extern VOID wmt_lib_func_onoff_lock_release(VOID);
extern INT32 wmt_lib_func_onoff_lock_aquire(VOID);
extern INT32 wmt_lib_set_stp_wmt_last_close(UINT32 value);
extern MTK_WCN_BOOL wmt_lib_is_stp_wmt_last_close_pre(VOID);
...
extern VOID wmt_lib_read_fw_cpupcr_times(UINT32 times, UINT32 sleep);
extern VOID wmt_lib_read_fw_cpupcr(VOID);
extern VOID wmt_lib_dump_all_thread(VOID);
/*******************************************************************************
*                              F U N C T I O N S
********************************************************************************
*/
