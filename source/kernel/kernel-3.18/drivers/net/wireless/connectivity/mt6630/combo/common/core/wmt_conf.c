...
#undef DFT_TAG
#endif
#define DFT_TAG         "[CNN][WMT_CONF-6630]"
...
INT32 wmt_conf_read_file(VOID)
{
	...
	WMT_INFO_FUNC("wmt_conf_read_file\n");
	osal_memset(&gDevWmt.rWmtGenConf, 0, osal_sizeof(gDevWmt.rWmtGenConf));
	//osal_memset(&gDevWmt.pWmtCfg, 0, osal_sizeof(gDevWmt.pWmtCfg)); // PVS: V568
	gDevWmt.pWmtCfg = NULL;
