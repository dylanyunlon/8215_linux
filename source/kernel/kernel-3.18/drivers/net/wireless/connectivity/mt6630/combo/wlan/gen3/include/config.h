...
#define CFG_TX_MAX_PKT_SIZE                     2304U
...
#define CFG_TX_MAX_PKT_SIZE                     1600U
...
#define CFG_MAX_NUM_OF_CHNL_INFO               50U
...
#define CFG_SDIO_MAX_RX_AGG_NUM                     0U	/*
...
#define HW_BSSID_NUM                (4U)	/* HW BSSID number by chip */
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_DRV_OWN_VERSION   ((UINT_16)((NIC_DRIVER_MAJOR_VERSION << 8U) | \
...
/* Max Tx page count */
#define CFG_MAX_TX_PAGE_COUNT               (968U)

#if defined(MT6631)
/* it must be less than or eaqual to 512 */
#define MY_SDIO_BLOCK_SIZE	512U
#if CFG_SDIO_TX_AGG || CFG_TX_BUFFER_IS_SCATTER_LIST
#define BLK_MODE_COALESCING_SZ \
	(NIC_TX_PAGE_SIZE * CFG_MAX_TX_PAGE_COUNT \
	+ MY_SDIO_BLOCK_SIZE - 1U)
#else
#define BLK_MODE_COALESCING_SZ	(CFG_TX_MAX_PKT_SIZE + MY_SDIO_BLOCK_SIZE - 1U)
...
#define CFG_TX_MAX_PKT_NUM                      (1024U)

/*! Maximum number of SW TX CMD packet buffer */
#define CFG_TX_MAX_CMD_PKT_NUM                  (32U)

/*! Maximum number of associated STAs */
#define CFG_NUM_OF_STA_RECORD                   (27U)
...
#if CFG_SLT_SUPPORT
#define CFG_NUM_OF_RX0_HIF_DESC                 42U
#else
#define CFG_NUM_OF_RX0_HIF_DESC                 16U
#endif
#define CFG_NUM_OF_RX1_HIF_DESC                 2U

/*! Max. buffer hold by QM */
/*! Maximum buffer hold by QM, it should cover below two scenarios:
 *
 *  - RX_PKT_DESTINATION_HOST
 *     the maximum packets queued in reordering buffer
 *     (consider all BA sessions concurrency):
 *     CFG_NUM_OF_RX_BA_AGREEMENTS * (WinSize - 1) = 8 * 67 = 536
 *
 *  - RX_PKT_DESTINATION_FORWARD
 *     the maximum packets queued in reordering buffer
 *     (consider two BA sessions concurrencyfor TGn AP 4.2.25)
 *     +
 *     the maximum pending forwarding count queued in TxQue (since the
 *     SwRfb consumed by forwarding frame will be freed in hif_thread
 *     until the corresponding MSDU is sent out, this may be blocked by
 *     hif_thread receiving procedure, we should reserve buffer here):
...
#define CFG_RX_MAX_PKT_NUM \
	((CFG_NUM_OF_RX0_HIF_DESC + CFG_NUM_OF_RX1_HIF_DESC) * 3U \
	+ CFG_NUM_OF_QM_RX_PKT_NUM)

#define CFG_RX_REORDER_Q_THRESHOLD              8U

#ifndef LINUX
#define CFG_RX_RETAINED_PKT_THRESHOLD           (CFG_NUM_OF_RX0_HIF_DESC + CFG_NUM_OF_RX1_HIF_DESC \
						+ CFG_NUM_OF_QM_RX_PKT_NUM)
#else
#define CFG_RX_RETAINED_PKT_THRESHOLD           0U
#endif
...
#define CFG_RX_MAX_PKT_SIZE   (28U + 2312U + 12U /* HIF_RX_HEADER_T */)
...
#define CFG_RX_COALESCING_BUFFER_SIZE       ((CFG_NUM_OF_RX0_HIF_DESC  + 1U) \
						* CFG_RX_MAX_PKT_SIZE)
#else
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_RESPONSE_POLLING_TIMEOUT            512U
#define CFG_RESPONSE_CLEAR_RDY_TIMEOUT		100U
#define CFG_MCU_POWER_OFF_POLLING_CNT		20U
#define CFG_MCU_POWER_OFF_MAGIC_CODE		0xa0000001U
#define CFG_MCU_POWER_OFF_MAILBOX_INDEX		0x1U
#define CFG_MCU_POWER_OFF_SOFTINT_BIT		16U
...
#define CFG_MAX_NUM_BSS_LIST                    128U

#define CFG_MAX_NUM_ROAM_BSS_LIST		64U

#define CFG_MAX_COMMON_IE_BUF_LEN         ((1500U * CFG_MAX_NUM_BSS_LIST) / 3U)

/*! Maximum size of Header buffer of each SCAN record */
#define CFG_RAW_BUFFER_SIZE                      1024U

/*! Maximum size of IE buffer of each SCAN record */
#define CFG_IE_BUFFER_SIZE                      512U

/*! Maximum number of STA records */
#define CFG_MAX_NUM_STA_RECORD                  32U
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_MAX_PMKID_CACHE                     16U	/*
 ...
 *------------------------------------------------------------------------------
 */
/* CH1~CH14, CH36~CH48, CH52~CH64, CH100~CH144, CH149~CH165 */
#define MAX_CHN_NUM                             39U
...
#define CFG_SCAN_HIDDEN_SSID_MAX_NUM       (7U)
#endif
#define CFG_SCAN_SSID_MAX_NUM                   (4U)
#define CFG_SCAN_SSID_MATCH_MAX_NUM             (16U)
...
#define CFG_IST_LOOP_COUNT                  1U
#else
#define CFG_IST_LOOP_COUNT                  32U
#endif /* _HIF_SDIO */
...
#define CFG_BOW_PHYSICAL_LINK_NUM               4U
...
#endif
#define CFG_STATISTICS_VALID_CYCLE              (2000U)
#define CFG_LINK_QUALITY_VALID_PERIOD           (500U)

/* Restrict AIS operation channel in STA+SAP concurrent mode */
#define CFG_SAP_LIMIT_AIS_CHNL                  0
...
#define CFG_SUPPORT_STA_AP_SCC   1
 ...
 *------------------------------------------------------------------------------
 */
#define COMPILE_FLAG0_GET_STA_LINK_STATUS     (1U<<0U)
#define COMPILE_FLAG0_WFD_ENHANCEMENT_PROTECT (1U<<1U)
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_SUPPORT_REPLAY_DETECTION		0
...
#define CFG_SOFTAP_WPA3_NEED_SOFTAP_PMF         0
#else
#define CFG_SUPPORT_SOFTAP_WPA3                 1
#define CFG_SOFTAP_WPA3_NEED_SOFTAP_PMF         1
#endif

#define CFG_NOTIFY_REASON_CODE                 1
