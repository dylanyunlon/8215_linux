...
#define TX_AUTHENTICATION_RETRY_TIMEOUT_TU          100U	/* TU. */

/* Retry interval for retransmiting association-request MMPDU. */
#define TX_ASSOCIATION_RETRY_TIMEOUT_TU             100U	/* TU. */

/* Wait for a response to a transmitted authentication-request MMPDU. */
#define DOT11_AUTHENTICATION_RESPONSE_TIMEOUT_TU    512U	/* TU. */

/* Wait for a response to a transmitted association-request MMPDU. */
#define DOT11_ASSOCIATION_RESPONSE_TIMEOUT_TU       512U	/* TU. */

/* The maximum time to wait for JOIN process complete. */
/* Beacon Interval, 20 * 100TU = 2 sec. */
#define JOIN_FAILURE_TIMEOUT_BEACON_INTERVAL        20U

/* Retry interval for next JOIN request. */
#define JOIN_RETRY_INTERVAL_SEC                     10U	/* Seconds */

/* Maximum Retry Count for accept a JOIN request. */
/* Autochips modifiy it from 2U to 5U*/
#define JOIN_MAX_RETRY_FAILURE_COUNT                5U	/* Times */

#define JOIN_MAX_RETRY_OVERLOAD_RN		    1U	/* Times */
/*******************************************************************************
*                             D A T A   T Y P E S
********************************************************************************
*/
