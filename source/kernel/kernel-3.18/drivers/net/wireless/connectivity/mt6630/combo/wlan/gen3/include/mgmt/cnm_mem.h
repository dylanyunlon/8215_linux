...
#define MGT_BUF_BLOCK_SIZE_IN_POWER_OF_2        7U
/* 5 to the power of 2 = 32 */
#define MSG_BUF_BLOCK_SIZE_IN_POWER_OF_2        5U
...
#define MAX_NUM_OF_BUF_BLOCKS                   32U	/* Range: 1~32 */
...
#define STA_REC_INDEX_BMCAST        0xFFU
#define STA_REC_INDEX_NOT_FOUND     0xFEU
...
#define MAX_NUM_CONCURRENT_FRAGMENTED_MSDUS     3U
...
struct _STA_RECORD_T {
...
#if CFG_SUPPORT_FRAG_AGG_ATTACK_DETECTION
	/*0 ~ TID-1 for TID, TID_NUM for non-qos data.*/
	...
	UINT_8 ucIdleOption;
#if CFG_SUPPORT_802_11W || CFG_SUPPORT_SOFTAP_WPA3
	/* AP PMF */
...
#define IS_FROM_BUF(_prAdapter, pucInfoBuffer) \
	(((ULONG)(pucInfoBuffer) >= (ULONG)_prAdapter->rMgtBufInfo.pucBuf) && \
	((ULONG)(pucInfoBuffer) < \
	(ULONG)_prAdapter->rMgtBufInfo.pucBuf + MGT_BUFFER_SIZE))
#else
...
VOID cnmStaSendUpdateCmd(P_ADAPTER_T prAdapter, P_STA_RECORD_T prStaRec, BOOLEAN fgNeedResp);
