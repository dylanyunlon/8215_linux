...
#define USEC_PER_TU                     1024U	/* microsecond */

#define MSEC_PER_MIN                    (60U * MSEC_PER_SEC)

#define MGMT_MAX_TIMEOUT_INTERVAL       ((UINT_32)0x7fffffff)

#define WAKE_LOCK_MAX_TIME              5U	/* Unit: sec */

#define OBSS_SCAN_MIN_INTERVAL  10U	/* In unit of sec */
/*
...
#define TIME_BEFORE(a, b)        \
	((UINT_32)((UINT_32)(a) - (UINT_32)(b)) > 0x7fffffffU)
...
#define CHECK_FOR_EXPIRATION(_currentTime, _expirationTime) \
	((UINT_32)((_currentTime) - (_expirationTime)) <= 0x7fffffffU)
