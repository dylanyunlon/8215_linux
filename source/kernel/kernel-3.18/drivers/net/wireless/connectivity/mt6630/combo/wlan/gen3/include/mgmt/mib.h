...
typedef struct _DOT11_RSNA_CONFIG_PAIRWISE_CIPHERS_ENTRY {
	UINT_32 CfgPWCipher;	/* dot11RSNAConfigPairwiseCiphersEntry 2 */
	BOOLEAN CfgPWCipherEnabled;	/*RSNAConfigPairwiseCiphersEntry 3 */
} CFG_PW_CIPHERS_ENTRY, *P_CFG_PW_CIPHERS_ENTRY;
...
typedef struct _IEEE_802_11_MIB_T {
	...
	CFG_PW_CIPHERS_ENTRY CfgCiphersTbl[MAX_NUM_SUPPORTED_CIPHER_SUITES];
