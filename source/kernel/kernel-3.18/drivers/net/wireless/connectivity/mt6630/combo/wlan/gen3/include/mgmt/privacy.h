 ...
 ********************************************************************************
 */
#define MAX_KEY_NUM                             4U
#define WEP_40_LEN                              5U
#define WEP_104_LEN                             13U
#define LEGACY_KEY_MAX_LEN                      16U
#define CCMP_KEY_LEN                            16U
#define TKIP_KEY_LEN                            32U
#define MAX_KEY_LEN                             32U
#define MIC_RX_KEY_OFFSET                       16U
#define MIC_TX_KEY_OFFSET                       24U
#define MIC_KEY_LEN                             8U

#define WEP_KEY_ID_FIELD      BITS(0U, 29U)
#define KEY_ID_FIELD          BITS(0U, 7U)

#define IS_TRANSMIT_KEY       BIT(31U)
#define IS_UNICAST_KEY        BIT(30U)
#define IS_AUTHENTICATOR      BIT(28U)
...
#define WTBL_RESERVED_ENTRY             255U
#define WTBL_SIZE                       32U	/*
...
#define WTBL_STA_IDX_MAX                17U
#define WTBL_IBSS_STA_IDX_MAX           7U

#define WTBL_AIS_BIP_IDX                18U

#define WTBL_IBSS_BC_IDX_0              9U

#define WTBL_BC_IDX_0                   19U
#define WTBL_BC_IDX_MAX                 27U

#define WTBL_AIS_DLS_MAX_IDX            (WTBL_STA_IDX_MAX - 7U)	/*
								 * Reserved for DLS:end entry, Todo:: Max DLS entry
								 * define
								 */

/* Reserved for Ad-hoc No sec index */
#define WTBL_AIS_IBSS_NO_SEC_BC_IDX     28U
/* Reserved for AP mode No Sec index */
#define WTBL_AP_NO_SEC_BC_IDX           28U

#define SEC_TX_KEY_COMMAND		1U
#define SEC_QUEUE_KEY_COMMAND	0U
#define SEC_DROP_KEY_COMMAND	2U
