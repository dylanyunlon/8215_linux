...
#define TX_BEAMFORMING_CAP_DEFAULT_VAL        0U
...
#else
#define TX_BEAMFORMING_CAP_BFEE        0U
#endif
...
#define FIELD_VHT_CAP_INFO_BF \
	...
	VHT_CAP_INFO_COMPRESSED_STEERING_NUMBER_OF_BF_ANTENNAS_4_SUPPOERTED)
#else
...
#define VHT_CAP_INFO_DEFAULT_VAL \
	(VHT_CAP_INFO_MAX_MPDU_LEN_3K | \
	 ((UINT_32)AMPDU_PARAM_MAX_AMPDU_LEN_1024K << \
	 VHT_CAP_INFO_MAX_AMPDU_LENGTH_OFFSET))

#define VHT_CAP_INFO_DEFAULT_HIGHEST_DATA_RATE			0U
#endif
/*******************************************************************************
*                             D A T A   T Y P E S
********************************************************************************
...
#define RLM_NET_IS_11N(_prBssInfo) \
	(((_prBssInfo)->ucPhyTypeSet & PHY_TYPE_SET_802_11N) != 0U)
#define RLM_NET_IS_11GN(_prBssInfo) \
	(((_prBssInfo)->ucPhyTypeSet & PHY_TYPE_SET_802_11GN) != 0U)

#if CFG_SUPPORT_802_11AC
#define RLM_NET_IS_11AC(_prBssInfo) \
	(((_prBssInfo)->ucPhyTypeSet & PHY_TYPE_SET_802_11AC) != 0U)
#endif
...
// Autochips add it
void rlmRspGenerateInterworkingIE(P_ADAPTER_T prAdapter, P_MSDU_INFO_T prMsduInfo);
// Add end
