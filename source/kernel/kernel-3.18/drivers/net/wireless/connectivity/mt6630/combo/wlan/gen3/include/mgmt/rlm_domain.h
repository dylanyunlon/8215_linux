...
********************************************************************************
*/
#define MAX_SUBBAND_NUM     6U
#define MAX_SUBBAND_NUM_5G  8U
...
/* 2.4G */
#define BAND_2G4_LOWER_BOUND 1U
#define BAND_2G4_UPPER_BOUND 14U
/* 5G SubBand FCC spec */
#define UNII1_LOWER_BOUND    36U
#define UNII1_UPPER_BOUND    48U
#define UNII2A_LOWER_BOUND   52U
#define UNII2A_UPPER_BOUND   64U
#define UNII2C_LOWER_BOUND   100U
#define UNII2C_UPPER_BOUND   144U
#define UNII3_LOWER_BOUND    149U
#define UNII3_UPPER_BOUND    173U

#if CFG_SUPPORT_PWR_LIMIT_COUNTRY

#define POWER_LIMIT_TABLE_NULL			0xFFFFU
#define MAX_TX_POWER				63
#define MIN_TX_POWER				-64
#define MAX_CMD_SUPPORT_CHANNEL_NUM		64U
...
#define CAL_CH_OFFSET_80M(_PRIMARY_CH, _CENTRAL_CH) \
			(((_PRIMARY_CH - _CENTRAL_CH) + 6U) >> 2U)

#define CAL_CH_OFFSET_160M(_PRIMARY_CH, _CENTRAL_CH) \
			(((_PRIMARY_CH - _CENTRAL_CH) + 14U) >> 2U)
