...
#define RSN_CIPHER_SUITE_CCMP           0x04AC0F00U
...
#define RSN_AKM_SUITE_PSK               0x02AC0F00U
#if (CFG_SUPPORT_WPA3 == 1)
...
#define WPA_AKM_SUITE_NONE              0x00F25000U
...
#define MASK_RSNIE_CAP_PREAUTH          BIT(0U)

#define GET_SELECTOR_TYPE(x)           ((UINT_8)(((x) >> 24U) & 0x000000FFU))
...
#if CFG_SUPPORT_802_11W
#define RSN_AUTH_MFP_DISABLED   0U	/* MFP disabled */
#define RSN_AUTH_MFP_OPTIONAL   1U	/* MFP optional */
#define RSN_AUTH_MFP_REQUIRED   2U	/* MFP required */
#endif
...
#if (CFG_SUPPORT_SOFTAP_WPA3 == 1) || CFG_SUPPORT_802_11W
...
#if CFG_SUPPORT_AAA || (CFG_SUPPORT_SOFTAP_WPA3 == 1)
