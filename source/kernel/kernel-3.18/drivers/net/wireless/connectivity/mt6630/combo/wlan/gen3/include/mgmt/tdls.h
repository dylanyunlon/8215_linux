...
{												\
	(__fgFlag__) |= ((UINT_32)WIPHY_FLAG_SUPPORTS_TDLS | \
...
#define TDLS_FME_MAC_ADDR_LEN				6U
...
/* protocol */
#define TDLS_FRM_PROT_TYPE                          0x890dU

/* payload specific type in the LLC/SNAP header */
#define TDLS_FRM_PAYLOAD_TYPE						2U

#define TDLS_FRM_CATEGORY                           12U
...
#define ELEM_ID_LINK_IDENTIFIER						101U
