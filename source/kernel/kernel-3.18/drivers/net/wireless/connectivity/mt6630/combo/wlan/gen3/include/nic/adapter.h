...
struct _BSS_INFO_T {
	...
	ENUM_CHNL_EXT_T eBssSCO;	/*
					 ...
					 */
	UINT_8 auc2G_20mReqChnlList[CHNL_LIST_SZ_2G + 1U];
	UINT_8 auc2G_NonHtChnlList[CHNL_LIST_SZ_2G + 1U];
	UINT_8 auc2G_PriChnlList[CHNL_LIST_SZ_2G + 1U];
	UINT_8 auc2G_SecChnlList[CHNL_LIST_SZ_2G + 1U];
...
#define THROUGHPUT_L1_THRESHOLD		(20U*1024U*1024U)
#define THROUGHPUT_L2_THRESHOLD		(60U*1024U*1024U)
#define THROUGHPUT_L3_THRESHOLD		(135U*1024U*1024U)
#define THROUGHPUT_L4_THRESHOLD		(180U*1024U*1024U)
...
#define IS_BSS_ACTIVE(_prBssInfo)     ((_prBssInfo)->fgIsNetActive != FALSE)
