...
#define MAC_ADDR_LOCAL_ADMIN                    BIT(1U)
...
#define IP_PRO_ICMP				0x01U
#define IP_PRO_UDP				0x11U
#define IP_PRO_TCP				0x06U

#define UDP_PORT_DHCPS				0x43U
#define UDP_PORT_DHCPC				0x44U
#define UDP_PORT_DNS				0x35U

#define ETH_P_1X                                0x888EU
#define ETH_P_PRE_1X                            0x88C7
#if CFG_SUPPORT_WAPI
#define ETH_WPI_1X                              0x88B4U
#endif
...
#define IP_VERSION_MASK                         BITS(4U, 7U)
...
#define IPV4_HDR_TOS_PREC_MASK                  BITS(5U, 7U)
...
#define IPV6_HDR_TC_PREC_MASK                   BITS(1U, 3U)
...
#define ICMPV6_FLAG_ROUTER_BIT                  BIT(7U)
#define ICMPV6_FLAG_SOLICITED_BIT               BIT(6U)
#define ICMPV6_FLAG_OVERWRITE_BIT               BIT(5U)
...
#define ARP_PRO_REQ				1U
#define ARP_PRO_RSP				2U

#define TDLS_ACTION_CODE_OFFSET                 2

#define LLC_LEN                                 8	/* LLC(3) + SNAP(3) + EtherType(2) */

#define NULL_MAC_ADDR              {0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U}
#define BC_MAC_ADDR                             {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}

#if 1

#define ETH_HLEN                                14
#define ETH_TYPE_LEN_OFFSET                     12U

#define IPVERSION                               4
#define IP_HEADER_LEN                           20

#define IPVH_VERSION_OFFSET                     4U	/* For Little-Endian */
#define IPVH_VERSION_MASK                       0xF0U
...
#define ETHER_MIN_PKT_SZ                        60U
#define ETHER_MAX_PKT_SZ                        1514U
...
#define WLAN_MAC_HEADER_LEN                     24U	/* Address 4 excluded */
#define WLAN_MAC_HEADER_A4_LEN                  30	/* Address 4 included */
/* QoS Control included */
#define WLAN_MAC_HEADER_QOS_LEN                 26U
...
#define WLAN_MAC_MGMT_HEADER_LEN                24U	/* Address 4 excluded */
...
#define RATE_MASK                               BITS(0U, 6U)
/* mask bit for the rate belonging to the BSSBasicRateSet */
#define RATE_BASIC_BIT                          BIT(7U)
...
#define STA_STATE_1                             0U

/* Accept Class 1 & 2 frames */
#define STA_STATE_2                             1U

/* Accept Class 1,2 & 3 frames */
#define STA_STATE_3                             2U
...
#define MAXIMUM_OPERATION_CHANNEL_LIST          32U
...
#define DOT11_RECEIVE_LIFETIME_TU_MIN           1U
#define DOT11_RECEIVE_LIFETIME_TU_MAX           0xFFFFffffU
#define DOT11_RECEIVE_LIFETIME_TU_DEFAULT       4096U	/* 802.11 define 512 */

/* Annex D - dot11StationConfigEntry 12 */
#define DOT11_BEACON_PERIOD_MIN                 1U	/* TU. */
#define DOT11_BEACON_PERIOD_MAX                 0xffffU	/* TU. */
#define DOT11_BEACON_PERIOD_DEFAULT             100U	/* TU. */

/* Annex D - dot11StationConfigEntry 13 */
#define DOT11_DTIM_PERIOD_MIN                   1U	/* TU. */
#define DOT11_DTIM_PERIOD_MAX                   255U	/* TU. */
#define DOT11_DTIM_PERIOD_DEFAULT               1U	/* TU. */

/* Annex D - dot11RegDomainsSupportValue */
#define REGULATION_DOMAIN_FCC                   0x10U	/* FCC (US) */
#define REGULATION_DOMAIN_IC                    0x20U	/* IC or DOC (Canada) */
#define REGULATION_DOMAIN_ETSI                  0x30U	/* ETSI (Europe) */
#define REGULATION_DOMAIN_SPAIN                 0x31U	/* Spain */
#define REGULATION_DOMAIN_FRANCE                0x32U	/* France */
#define REGULATION_DOMAIN_JAPAN                 0x40U	/* MKK (Japan) */
#define REGULATION_DOMAIN_CHINA                 0x50U	/* China */
#define REGULATION_DOMAIN_OTHER                 0x00U	/* Other */

/* 3 --------------- IEEE 802.11 MAC header fields --------------- */
/* 7.1.3.1 Masks for the subfields in the Frame Control field */
#define MASK_FC_PROTOCOL_VER                    BITS(0U, 1U)
#define MASK_FC_TYPE                            BITS(2U, 3U)
#define MASK_FC_SUBTYPE                         BITS(4U, 7U)
#define MASK_FC_SUBTYPE_QOS_DATA                BIT(7U)
#define MASK_FC_TO_DS                           BIT(8U)
#define MASK_FC_FROM_DS                         BIT(9U)
#define MASK_FC_MORE_FRAG                       BIT(10U)
#define MASK_FC_RETRY                           BIT(11U)
#define MASK_FC_PWR_MGT                         BIT(12U)
#define MASK_FC_MORE_DATA                       BIT(13U)
#define MASK_FC_PROTECTED_FRAME                 BIT(14U)
#define MASK_FC_ORDER                           BIT(15U)

#define MASK_FRAME_TYPE                         (MASK_FC_TYPE | MASK_FC_SUBTYPE)
#define MASK_TO_DS_FROM_DS                      (MASK_FC_TO_DS | MASK_FC_FROM_DS)

#define MAX_NUM_OF_FC_SUBTYPES                  16U
#define OFFSET_OF_FC_SUBTYPE                    4U

/* 7.1.3.1.2 MAC frame types and subtypes */
#define MAC_FRAME_TYPE_MGT                      0U
#define MAC_FRAME_TYPE_CTRL                     BIT(2U)
#define MAC_FRAME_TYPE_DATA                     BIT(3U)
#define MAC_FRAME_TYPE_QOS_DATA                 (MAC_FRAME_TYPE_DATA | MASK_FC_SUBTYPE_QOS_DATA)

#define MAC_FRAME_ASSOC_REQ                     (MAC_FRAME_TYPE_MGT | 0x0000U)
#define MAC_FRAME_ASSOC_RSP                     (MAC_FRAME_TYPE_MGT | 0x0010U)
#define MAC_FRAME_REASSOC_REQ                   (MAC_FRAME_TYPE_MGT | 0x0020U)
#define MAC_FRAME_REASSOC_RSP                   (MAC_FRAME_TYPE_MGT | 0x0030U)
#define MAC_FRAME_PROBE_REQ                     (MAC_FRAME_TYPE_MGT | 0x0040U)
#define MAC_FRAME_PROBE_RSP                     (MAC_FRAME_TYPE_MGT | 0x0050U)
#define MAC_FRAME_BEACON                        (MAC_FRAME_TYPE_MGT | 0x0080U)
#define MAC_FRAME_ATIM                          (MAC_FRAME_TYPE_MGT | 0x0090U)
#define MAC_FRAME_DISASSOC                      (MAC_FRAME_TYPE_MGT | 0x00A0U)
#define MAC_FRAME_AUTH                          (MAC_FRAME_TYPE_MGT | 0x00B0U)
#define MAC_FRAME_DEAUTH                        (MAC_FRAME_TYPE_MGT | 0x00C0U)
#define MAC_FRAME_ACTION                        (MAC_FRAME_TYPE_MGT | 0x00D0U)
#define MAC_FRAME_ACTION_NO_ACK                 (MAC_FRAME_TYPE_MGT | 0x00E0U)

#define MAC_FRAME_CONTRL_WRAPPER                (MAC_FRAME_TYPE_CTRL | 0x0070U)
#define MAC_FRAME_BLOCK_ACK_REQ                 (MAC_FRAME_TYPE_CTRL | 0x0080U)
#define MAC_FRAME_BLOCK_ACK                     (MAC_FRAME_TYPE_CTRL | 0x0090U)
#define MAC_FRAME_PS_POLL                       (MAC_FRAME_TYPE_CTRL | 0x00A0U)
#define MAC_FRAME_RTS                           (MAC_FRAME_TYPE_CTRL | 0x00B0U)
#define MAC_FRAME_CTS                           (MAC_FRAME_TYPE_CTRL | 0x00C0U)
#define MAC_FRAME_ACK                           (MAC_FRAME_TYPE_CTRL | 0x00D0U)
#define MAC_FRAME_CF_END                        (MAC_FRAME_TYPE_CTRL | 0x00E0U)
#define MAC_FRAME_CF_END_CF_ACK                 (MAC_FRAME_TYPE_CTRL | 0x00F0U)

#define MAC_FRAME_DATA                          (MAC_FRAME_TYPE_DATA | 0x0000U)
#define MAC_FRAME_DATA_CF_ACK                   (MAC_FRAME_TYPE_DATA | 0x0010U)
#define MAC_FRAME_DATA_CF_POLL                  (MAC_FRAME_TYPE_DATA | 0x0020U)
#define MAC_FRAME_DATA_CF_ACK_CF_POLL           (MAC_FRAME_TYPE_DATA | 0x0030U)
#define MAC_FRAME_NULL                          (MAC_FRAME_TYPE_DATA | 0x0040U)
#define MAC_FRAME_CF_ACK                        (MAC_FRAME_TYPE_DATA | 0x0050U)
#define MAC_FRAME_CF_POLL                       (MAC_FRAME_TYPE_DATA | 0x0060U)
#define MAC_FRAME_CF_ACK_CF_POLL                (MAC_FRAME_TYPE_DATA | 0x0070U)
#define MAC_FRAME_QOS_DATA                      (MAC_FRAME_TYPE_DATA | 0x0080U)
#define MAC_FRAME_QOS_DATA_CF_ACK               (MAC_FRAME_TYPE_DATA | 0x0090U)
#define MAC_FRAME_QOS_DATA_CF_POLL              (MAC_FRAME_TYPE_DATA | 0x00A0U)
#define MAC_FRAME_QOS_DATA_CF_ACK_CF_POLL       (MAC_FRAME_TYPE_DATA | 0x00B0U)
#define MAC_FRAME_QOS_NULL                      (MAC_FRAME_TYPE_DATA | 0x00C0U)
#define MAC_FRAME_QOS_CF_POLL                   (MAC_FRAME_TYPE_DATA | 0x00E0U)
#define MAC_FRAME_QOS_CF_ACK_CF_POLL            (MAC_FRAME_TYPE_DATA | 0x00F0U)

/* 7.1.3.2 Mask for the AID value in the Duration/ID field */
#define MASK_DI_DURATION                        BITS(0U, 14U)
#define MASK_DI_AID                             BITS(0U, 13U)
#define MASK_DI_AID_MSB                         BITS(14U, 15U)
#define MASK_DI_CFP_FIXED_VALUE                 BIT(15U)

/* 7.1.3.4 Masks for the subfields in the Sequence Control field */
#define MASK_SC_SEQ_NUM                         BITS(4U, 15U)
#define MASK_SC_SEQ_NUM_OFFSET                  4
#define MASK_SC_FRAG_NUM                        BITS(0U, 3U)
...
#define TID_NUM                                 16
#define TID_MASK                                BITS(0U, 3U)
#define EOSP                                    BIT(4U)
#define ACK_POLICY                              BITS(5U, 6U)
#define A_MSDU_PRESENT                          BIT(7U)

#define MASK_QC_TID                  BITS(0U, 3U)
#define MASK_QC_EOSP                 BIT(4U)
#define MASK_QC_EOSP_OFFSET          4
#define MASK_QC_ACK_POLICY           BITS(5U, 6U)
#define MASK_QC_ACK_POLICY_OFFSET    5
#define MASK_QC_A_MSDU_PRESENT       BIT(7U)

/* 7.1.3.5a HT Control field */
#define HT_CTRL_LINK_ADAPTATION_CTRL            BITS(0U, 15U)
#define HT_CTRL_CALIBRATION_POSITION            BITS(16U, 17U)
#define HT_CTRL_CALIBRATION_SEQUENCE            BITS(18U, 19U)
#define HT_CTRL_CSI_STEERING                    BITS(22U, 23U)
#define HT_CTRL_NDP_ANNOUNCEMENT                BIT(24U)
#define HT_CTRL_AC_CONSTRAINT                   BIT(30U)
#define HT_CTRL_RDG_MORE_PPDU                   BIT(31U)

#define LINK_ADAPTATION_CTRL_TRQ                BIT(1U)
#define LINK_ADAPTATION_CTRL_MAI_MRQ            BIT(2U)
#define LINK_ADAPTATION_CTRL_MAI_MSI            BITS(3U, 5U)
#define LINK_ADAPTATION_CTRL_MFSI               BITS(6U, 8U)
#define LINK_ADAPTATION_CTRL_MFB_ASELC_CMD      BITS(9U, 11U)
#define LINK_ADAPTATION_CTRL_MFB_ASELC_DATA     BITS(12U, 15U)
...
/* 7.2.7.1 BAR */
#define OFFSET_BAR_SSC_SN                       4U

/* 8.3.2.2 TKIP MPDU formats */
#define TKIP_MIC_LEN                            8

#define BA_POLICY_IMMEDIATE                     BIT(1U)

/* Block Ack Starting Sequence Control field */
#define BA_START_SEQ_CTL_FRAG_NUM               BITS(0U, 3U)
#define BA_START_SEQ_CTL_SSN                    BITS(4U, 15U)

/* BAR Control field */
#define BAR_CONTROL_NO_ACK_POLICY               BIT(0U)
#define BAR_CONTROL_MULTI_TID                   BIT(1U)
#define BAR_CONTROL_COMPRESSED_BA               BIT(2U)
#define BAR_CONTROL_TID_INFO                    BITS(12U, 15U)
#define BAR_CONTROL_TID_INFO_OFFSET             12U

/* TID Value */
#define BAR_INFO_TID_VALUE                      BITS(12U, 15U)

#define BAR_COMPRESSED_VARIANT_FRAME_LEN        (16U + 4U)
...
#define AUTH_ALGORITHM_NUM_OPEN_SYSTEM              0U	/* Open System */
#define AUTH_ALGORITHM_NUM_SHARED_KEY               1U	/* Shared Key */
/* Fast BSS Transition */
#define AUTH_ALGORITHM_NUM_FAST_BSS_TRANSITION      2U
#if (CFG_SUPPORT_WPA3 == 1)
#define AUTH_ALGORITHM_NUM_SAE                      3U	/* WPA3 - SAE */
#endif
...
#define BEACON_INTERVAL_FIELD_LEN                   2U

/* 7.3.1.4 Capability Information field */
#define CAP_INFO_FIELD_LEN                          2U
#define CAP_INFO_ESS                                BIT(0U)
#define CAP_INFO_IBSS                               BIT(1U)
#define CAP_INFO_BSS_TYPE                           (CAP_INFO_ESS | CAP_INFO_IBSS)
#define CAP_INFO_CF_POLLABLE                        BIT(2U)
#define CAP_INFO_CF_POLL_REQ                        BIT(3U)
#define CAP_INFO_CF                                 (CAP_INFO_CF_POLLABLE | CAP_INFO_CF_POLL_REQ)
#define CAP_INFO_PRIVACY                            BIT(4U)
#define CAP_INFO_SHORT_PREAMBLE                     BIT(5U)
#define CAP_INFO_PBCC                               BIT(6U)
#define CAP_INFO_CH_AGILITY                         BIT(7U)
#define CAP_INFO_SPEC_MGT                           BIT(8U)
#define CAP_INFO_QOS                                BIT(9U)
#define CAP_INFO_SHORT_SLOT_TIME                    BIT(10U)
#define CAP_INFO_APSD                               BIT(11U)
#define CAP_INFO_RESERVED                           BIT(12U)
#define CAP_INFO_DSSS_OFDM                          BIT(13U)
#define CAP_INFO_DELAYED_BLOCK_ACK                  BIT(14U)
#define CAP_INFO_IMM_BLOCK_ACK                      BIT(15U)
...
/* Reseved */
#define REASON_CODE_RESERVED                        0U

/*Unspecified reason*/
#define REASON_CODE_UNSPECIFIED                     1U

/*Previous auth no longer valid*/
#define REASON_CODE_PREV_AUTH_INVALID               2U

/*Deauth because sending STA is leaving BSS*/
#define REASON_CODE_DEAUTH_LEAVING_BSS              3U

/*Disassoc due to inactivity*/
#define REASON_CODE_DISASSOC_INACTIVITY             4U

/*Disassoc because AP is unable to handle all assoc STAs*/
#define REASON_CODE_DISASSOC_AP_OVERLOAD            5U

/*Class 2 frame rx from nonauth STA*/
#define REASON_CODE_CLASS_2_ERR                     6U

/*Class 3 frame rx from nonassoc STA*/
#define REASON_CODE_CLASS_3_ERR                     7U

/*Disassoc because sending STA is leaving BSS*/
#define REASON_CODE_DISASSOC_LEAVING_BSS            8U

/*STA requesting (re)assoc is not auth with responding STA*/
#define REASON_CODE_ASSOC_BEFORE_AUTH               9U

/*Disassoc because the info in Power Capability is unacceptable*/
#define REASON_CODE_DISASSOC_PWR_CAP_UNACCEPTABLE   10U

/*Disassoc because the info in Supported Channels is unacceptable*/
#define REASON_CODE_DISASSOC_SUP_CHS_UNACCEPTABLE   11U

/*Invalid information element*/
#define REASON_CODE_INVALID_INFO_ELEM               13U

/*MIC failure*/
#define REASON_CODE_MIC_FAILURE                     14U

/*4-way handshake timeout*/
#define REASON_CODE_4_WAY_HANDSHAKE_TIMEOUT         15U

/*Group key update timeout*/
#define REASON_CODE_GROUP_KEY_UPDATE_TIMEOUT        16U

/*Info element in 4-way handshake different from*/
/*(Re-)associate request/Probe response/Beacon*/
#define REASON_CODE_DIFFERENT_INFO_ELEM             17U

/*Multicast Cipher is not valid*/
#define REASON_CODE_MULTICAST_CIPHER_NOT_VALID      18U

/*Unicast Cipher is not valid*/
#define REASON_CODE_UNICAST_CIPHER_NOT_VALID        19U

/*AKMP is not valid*/
#define REASON_CODE_AKMP_NOT_VALID                  20U

/*Unsupported RSNE version*/
#define REASON_CODE_UNSUPPORTED_RSNE_VERSION        21U

/*Invalid RSNE Capabilities*/
#define REASON_CODE_INVALID_RSNE_CAPABILITIES       22U

/*IEEE 802.1X Authentication failed*/
#define REASON_CODE_IEEE_802_1X_AUTH_FAILED         23U

/*Cipher suite rejected because of the security policy*/
#define REASON_CODE_CIPHER_REJECT_SEC_POLICY        24U

/*Disassoc for unspecified, QoS-related reason */
#define REASON_CODE_DISASSOC_UNSPECIFIED_QOS        32U

/*Disassoc because QAP lacks sufficient bandwidth for this QSTA*/
#define REASON_CODE_DISASSOC_LACK_OF_BANDWIDTH      33U

/*Disassoc because of too many ACKs lost for AP*/
/*transmissions and/or poor channel conditions*/
#define REASON_CODE_DISASSOC_ACK_LOST_POOR_CHANNEL  34U


/*Disassoc because QSTA is transmitting outside the limits of its TXOPs*/
#define REASON_CODE_DISASSOC_TX_OUTSIDE_TXOP_LIMIT  35U

/*QSTA is leaving the QBSS or resetting*/
#define REASON_CODE_PEER_WHILE_LEAVING              36U

/*Peer does not want to use this mechanism*/
#define REASON_CODE_PEER_REFUSE_DLP                 37U

/*Frames received but a setup is reqired*/
#define REASON_CODE_PEER_SETUP_REQUIRED             38U

/*Time out*/
#define REASON_CODE_PEER_TIME_OUT                   39U

/*Peer does not support the requested cipher suite*/
#define REASON_CODE_PEER_CIPHER_UNSUPPORTED         45U

/*for beacon timeout, defined by mediatek*/
#define REASON_CODE_BEACON_TIMEOUT		    100U
#define REASON_CODE_INVALID_FOR_ATC		    9999

/* 7.3.1.8 AID field */
#define AID_FIELD_LEN                               2
#define AID_MASK                                    BITS(0U, 13U)
#define AID_MSB                                     BITS(14U, 15U)
...
#define STATUS_CODE_RESERVED                        0U

/*Successful*/
#define STATUS_CODE_SUCCESSFUL                      0U

/*Unspecified failure*/
#define STATUS_CODE_UNSPECIFIED_FAILURE             1U

/*Cannot support all requested cap in the Cap Info field*/
#define STATUS_CODE_CAP_NOT_SUPPORTED               10U

/*Reassoc denied due to inability to confirm that assoc exists*/
#define STATUS_CODE_REASSOC_DENIED_WITHOUT_ASSOC    11U

/*Assoc denied due to reason outside the scope of this std. */
#define STATUS_CODE_ASSOC_DENIED_OUTSIDE_STANDARD   12U

/*Responding STA does not support the specified auth algorithm*/
#define STATUS_CODE_AUTH_ALGORITHM_NOT_SUPPORTED    13U

/*Rx an auth frame with auth transaction seq num out of expected seq*/
#define STATUS_CODE_AUTH_OUT_OF_SEQ                 14U

/* Auth rejected because of challenge failure*/
#define STATUS_CODE_AUTH_REJECTED_CHAL_FAIL         15U

/*Auth rejected due to timeout waiting for next frame in sequence*/
#define STATUS_CODE_AUTH_REJECTED_TIMEOUT           16U

/*Assoc denied because AP is unable to handle additional assoc STAs*/
#define STATUS_CODE_ASSOC_DENIED_AP_OVERLOAD        17U

/*Assoc denied due to requesting STA not supporting all of basic rates*/
#define STATUS_CODE_ASSOC_DENIED_RATE_NOT_SUPPORTED 18U

/*Assoc denied due to requesting STA not supporting short preamble*/
#define STATUS_CODE_ASSOC_DENIED_NO_SHORT_PREAMBLE  19U

/*Assoc denied due to requesting STA not supporting PBCC*/
#define STATUS_CODE_ASSOC_DENIED_NO_PBCC            20U

/*Assoc denied due to requesting STA not supporting channel agility*/
#define STATUS_CODE_ASSOC_DENIED_NO_CH_AGILITY      21U

/*Assoc rejected because Spectrum Mgt capability is required*/
#define STATUS_CODE_ASSOC_REJECTED_NO_SPEC_MGT      22U

/*Assoc rejected because the info in Power Capability is unacceptable*/
#define STATUS_CODE_ASSOC_REJECTED_PWR_CAP          23U

/*Assoc rejected because the info in Supported Channels is unacceptable*/
#define STATUS_CODE_ASSOC_REJECTED_SUP_CHS          24U

/*Assoc denied due to requesting STA not supporting short slot time*/
#define STATUS_CODE_ASSOC_DENIED_NO_SHORT_SLOT_TIME 25U

/*Assoc denied due to requesting STA not supporting DSSS-OFDM*/
#define STATUS_CODE_ASSOC_DENIED_NO_DSSS_OFDM       26U

#if CFG_SUPPORT_802_11W
/*IEEE 802.11w, Assoc denied due to the SA query*/
#define STATUS_CODE_ASSOC_REJECTED_TEMPORARILY      30U

/*IEEE 802.11w, Assoc denied due to the MFP select policy*/
#define STATUS_CODE_ROBUST_MGMT_FRAME_POLICY_VIOLATION 31U
#endif

/*Unspecified, QoS-related failure*/
#define STATUS_CODE_UNSPECIFIED_QOS_FAILURE         32U

/*Assoc denied due to insufficient bandwidth to handle another QSTA*/
#define STATUS_CODE_ASSOC_DENIED_BANDWIDTH          33U

/*Assoc denied due to excessive frame loss rates and/or poor*/
/*channel conditions*/
#define STATUS_CODE_ASSOC_DENIED_POOR_CHANNEL       34U

/*Assoc denied due to requesting STA not supporting QoS facility*/
#define STATUS_CODE_ASSOC_DENIED_NO_QOS_FACILITY    35U

/*Request has been declined*/
#define STATUS_CODE_REQ_DECLINED                    37U

/*Request has not been successful as one or more parameters*/
/*have invalid values*/
#define STATUS_CODE_REQ_INVALID_PARAMETER_VALUE     38U

/*TS not created because request cannot be honored.Suggested TSPEC provided.*/
#define STATUS_CODE_REQ_NOT_HONORED_TSPEC           39U

/*Invalid information element */
#define STATUS_CODE_INVALID_INFO_ELEMENT            40U

/*Invalid group cipher */
#define STATUS_CODE_INVALID_GROUP_CIPHER            41U

/*Invalid pairwise cipher */
#define STATUS_CODE_INVALID_PAIRWISE_CIPHER         42U

/*Invalid AKMP */
#define STATUS_CODE_INVALID_AKMP                    43U

/*Unsupported RSN information element version */
#define STATUS_CODE_UNSUPPORTED_RSN_IE_VERSION      44U

/*Invalid RSN information element capabilities */
#define STATUS_CODE_INVALID_RSN_IE_CAP              45U

/*Cipher suite rejected because of security policy */
#define STATUS_CODE_CIPHER_SUITE_REJECTED           46U

/*TS not created because request cannot be honored.*/
/*Attempt to create a TS later. */
#define STATUS_CODE_REQ_NOT_HONORED_TS_DELAY        47U

/*Direct Link is not allowed in the BSS by policy */
#define STATUS_CODE_DIRECT_LINK_NOT_ALLOWED         48U

/*Destination STA is not present within this QBSS */
#define STATUS_CODE_DESTINATION_STA_NOT_PRESENT     49U

/*Destination STA is not a QSTA */
#define STATUS_CODE_DESTINATION_STA_NOT_QSTA        50U

/*Association denied because the ListenInterval is too large */
#define STATUS_CODE_ASSOC_DENIED_LARGE_LIS_INTERVAL 51U

/* Invalid pairwise master key identifier (PMKID) */
#define STATUS_INVALID_PMKID                        53U
...
#define TIMESTAMP_FIELD_LEN                         8U

/* 7.3.1.11 Category of Action field */
#define CATEGORY_SPEC_MGT                           0U
/* QoS action */
#define CATEGORY_QOS_ACTION                         1U
/* Direct Link Protocol (DLP) action */
#define CATEGORY_DLS_ACTION                         2U
/* Block ack action */
#define CATEGORY_BLOCK_ACK_ACTION                   3U
/* Public action */
#define CATEGORY_PUBLIC_ACTION                      4U
/* Radio measurement action */
#define CATEGORY_RM_ACTION                          5U
#if (CFG_SUPPORT_SOFTAP_WPA3 == 1)
#define CATEGORY_FT_ACTION                          6U
#endif
#define CATEGORY_HT_ACTION                          7U
#if CFG_SUPPORT_802_11W
#define CATEGORY_SA_QUERY_ACTION                    8U
#define CATEGORY_PROTECTED_DUAL_OF_PUBLIC_ACTION    9U
#endif
/* 802.11v Wireless Network Management */
#define CATEGORY_WNM_ACTION                         10U
/* 802.11v Wireless Network Management */
#define CATEGORY_UNPROTECTED_WNM_ACTION             11U
#if (CFG_SUPPORT_SOFTAP_WPA3 == 1)
/* TDLS */
#define CATEGORY_TDLS_ACTION                        12U
/* Mesh */
#define CATEGORY_MESH_ACTION                        13U
/* Multihop */
#define CATEGORY_MULTIHOP_ACTION                    14U
/* Self-protected */
#define CATEGORY_SELF_PROTECTED_ACTION              15U
#define CATEGORY_DMG_ACTION                         16U
#endif
/* WME management notification */
#define CATEGORY_WME_MGT_NOTIFICATION               17U
#if (CFG_SUPPORT_SOFTAP_WPA3 == 1)
/* FST Action */
#define CATEGORY_FST_ACTION                         18U
/* Robust AV Streaming */
#define CATEGORY_ROBUST_AV_STREAMING_ACTION         19U
#define CATEGORY_UNPROTECTED_DMG_ACTION             20U
#endif
/* VHT action */
#define CATEGORY_VHT_ACTION                         21U

#if CFG_SUPPORT_802_11W
#define CATEGORY_VENDOR_SPECIFIC_ACTION_PROTECTED   126U
#endif
#define CATEGORY_VENDOR_SPECIFIC_ACTION             127U

/* 7.3.1.14 Block Ack Parameter Set field */
#define BA_PARAM_SET_ACK_POLICY_MASK                BIT(1U)
#define BA_PARAM_SET_ACK_POLICY_MASK_OFFSET         1U
#define BA_PARAM_SET_TID_MASK                       BITS(2U, 5U)
#define BA_PARAM_SET_TID_MASK_OFFSET                2U
#define BA_PARAM_SET_BUFFER_SIZE_MASK               BITS(6U, 15U)
#define BA_PARAM_SET_BUFFER_SIZE_MASK_OFFSET        6U
...
#define ELEM_ID_SSID                                0U	/* SSID */
#define ELEM_ID_SUP_RATES                           1U	/* Supported rates */
#define ELEM_ID_FH_PARAM_SET                        2U	/* FH parameter set */
#define ELEM_ID_DS_PARAM_SET                        3U	/* DS parameter set */
#define ELEM_ID_CF_PARAM_SET                        4U	/* CF parameter set */
#define ELEM_ID_TIM                                 5U	/* TIM */
...
#define ELEM_ID_SUP_CHS                             36U	/* Supported channels */
...
#define ELEM_ID_HT_CAP                              45U
#define ELEM_ID_QOS_CAP                             46	/* QoS capability */
#define ELEM_ID_RSN                                 48U	/* RSN IE */
/* Extended supported rates */
#define ELEM_ID_EXTENDED_SUP_RATES                  50U
...
#define ELEM_ID_TIMEOUT_INTERVAL                    56U
#endif
...
#define ELEM_ID_20_40_BSS_COEXISTENCE               72U
...
#define ELEM_ID_EXTENDED_CAP                        127U

/* Vendor specific IE */
#define ELEM_ID_VENDOR                              221U
...
// Autochips Add
#define ELEM_ID_APPLE_DEVICE                        ELEM_ID_VENDOR	/* APPLE DEVICE IE */
// Add end
...
// Autochips Add
#define ELEM_MAX_LEN_APPLE_ID                       1024
// Add end

/* 7.3.2.1 SSID element */
#define ELEM_MAX_LEN_SSID                           (32U)

/* 7.3.2.2 Supported Rates */
#define ELEM_MAX_LEN_SUP_RATES                      8U

/* 7.3.2.4 DS Parameter Set */
#define ELEM_MAX_LEN_DS_PARAMETER_SET               1U
...
#define ELEM_MAX_LEN_TIM                            254U

/* 7.3.2.7 IBSS Parameter Set element */
#define ELEM_MAX_LEN_IBSS_PARAMETER_SET             2U
...
#define ELEM_MAX_LEN_ERP                            1U
/* -- bits in the ERP Information element */

/* NonERP_Present bit */
#define ERP_INFO_NON_ERP_PRESENT                    BIT(0U)
/* Use_Protection bit */
#define ERP_INFO_USE_PROTECTION                     BIT(1U)
/* Barker_Preamble_Mode bit */
#define ERP_INFO_BARKER_PREAMBLE_MODE               BIT(2U)
...
// ATC_AOSP_ENHANCEMENT Add for compile
...
#if CFG_SUPPORT_802_11W
#define ELEM_WPA_CAP_MFPR                           BIT(6U)
#define ELEM_WPA_CAP_MFPC                           BIT(7U)
#endif

/* 7.3.2.27 Extended Capabilities information element */
#define ELEM_EXT_CAP_20_40_COEXIST_SUPPORT          BIT(0U)
#define ELEM_EXT_CAP_PSMP_CAP                       BIT(4U)
#define ELEM_EXT_CAP_SERVICE_INTERVAL_GRANULARITY   BIT(5U)
#define ELEM_EXT_CAP_SCHEDULE_PSMP                  BIT(6U)

#define ELEM_EXT_CAP_BSS_TRANSITION_BIT             19U
#define ELEM_EXT_CAP_UTC_TSF_OFFSET_BIT             27U
#define ELEM_EXT_CAP_INTERWORKING_BIT               31U
#define ELEM_EXT_CAP_WNM_NOTIFICATION_BIT           46U
#define ELEM_EXT_CAP_OP_MODE_NOTIFICATION_BIT       62U

#define ELEM_MAX_LEN_EXT_CAP                        (8U)

/* 7.3.2.30 TSPEC element */

/* WMM: 0 (Asynchronous TS of low-duty cycles) */
#define TS_INFO_TRAFFIC_TYPE_MASK                   BIT(0U)
#define TS_INFO_TID_OFFSET                          1
#define TS_INFO_TID_MASK                            BITS(1U, 4U)
#define TS_INFO_DIRECTION_OFFSET                    5
#define TS_INFO_DIRECTION_MASK                      BITS(5U, 6U)
#define TS_INFO_ACCESS_POLICY_OFFSET                7
#define TS_INFO_ACCESS_POLICY_MASK                  BITS(7U, 8U)
#define TS_INFO_AGGREGATION_MASK                    BIT(9U)	/* WMM: 0 */
#define TS_INFO_APSD_MASK                           BIT(10U)
#define TS_INFO_UP_OFFSET                           11
#define TS_INFO_UP_MASK                             BITS(11U, 13U)
#define TS_INFO_ACK_POLICY_OFFSET                   14
#define TS_INFO_ACK_POLICY_MASK                     BITS(14U, 15U)
...
#define ELEM_MAX_LEN_HT_CAP                         (28U - ELEM_HDR_LEN)

/* 7.3.2.56.2 HT capabilities Info field */
#define HT_CAP_INFO_LDPC_CAP                        BIT(0U)
#define HT_CAP_INFO_SUP_CHNL_WIDTH                  BIT(1U)
#define HT_CAP_INFO_SM_POWER_SAVE                   BITS(2U, 3U)
#define HT_CAP_INFO_HT_GF                           BIT(4U)
#define HT_CAP_INFO_SHORT_GI_20M                    BIT(5U)
#define HT_CAP_INFO_SHORT_GI_40M                    BIT(6U)
#define HT_CAP_INFO_TX_STBC                         BIT(7U)
#define HT_CAP_INFO_RX_STBC                         BITS(8U, 9U)
#define HT_CAP_INFO_HT_DELAYED_BA                   BIT(10U)
#define HT_CAP_INFO_MAX_AMSDU_LEN                   BIT(11U)
#define HT_CAP_INFO_DSSS_CCK_IN_40M                 BIT(12U)
#define HT_CAP_INFO_40M_INTOLERANT                  BIT(14U)
#define HT_CAP_INFO_LSIG_TXOP_SUPPORT               BIT(15U)

#define HT_CAP_INFO_RX_STBC_NO_SUPPORTED            0
#define HT_CAP_INFO_RX_STBC_1_SS                    BIT(8U)
#define HT_CAP_INFO_RX_STBC_2_SS                    BIT(9U)
#define HT_CAP_INFO_RX_STBC_3_SS                    HT_CAP_INFO_RX_STBC

#define ELEM_MAX_LEN_VHT_CAP                         (14U - ELEM_HDR_LEN)
/* 8.4.2.161 VHT Operation element */
#define ELEM_MAX_LEN_VHT_OP                          (7U - ELEM_HDR_LEN)
...
#define VHT_CAP_INFO_MAX_MPDU_LEN_3K			0U
#define VHT_CAP_INFO_MAX_MPDU_LEN_8K			BIT(0U)
#define VHT_CAP_INFO_MAX_MPDU_LEN_11K			BIT(1U)

#define VHT_CAP_INFO_MAX_SUP_CHANNEL_WIDTH_SET_NONE	0
#define VHT_CAP_INFO_MAX_SUP_CHANNEL_WIDTH_SET_160	BIT(2U)
#define VHT_CAP_INFO_MAX_SUP_CHANNEL_WIDTH_SET_160_80P80	BIT(3U)

#define VHT_CAP_INFO_RX_LDPC				BIT(4U)
#define VHT_CAP_INFO_SHORT_GI_80			BIT(5U)
#define VHT_CAP_INFO_SHORT_GI_160_80P80			BIT(6U)
#define VHT_CAP_INFO_TX_STBC				BIT(7U)

#define VHT_CAP_INFO_RX_STBC_NONE			0
#define VHT_CAP_INFO_RX_STBC_ONE_STREAM			BIT(8U)
#define VHT_CAP_INFO_RX_STBC_TWO_STREAM			BIT(9U)
#define VHT_CAP_INFO_RX_STBC_THREE_STREAM		BITS(8U, 9U)
#define VHT_CAP_INFO_RX_STBC_FOUR_STREAM		BIT(10U)

#define VHT_CAP_INFO_SU_BEAMFORMER_CAPABLE		BIT(11U)
#define VHT_CAP_INFO_SU_BEAMFORMEE_CAPABLE		BIT(12U)

#define VHT_CAP_INFO_COMPRESSED_STEERING_NUMBER_OF_BF_ANTENNAS_SUPPOERTED \
	BITS(13U, 15U)

#define VHT_CAP_INFO_COMPRESSED_STEERING_NUMBER_OF_BF_ANTENNAS_4_SUPPOERTED \
	BITS(13U, 14U)

#define VHT_CAP_INFO_NUMBER_OF_SOUNDING_DIMENSIONS	BITS(16U, 18U)

#define	VHT_CAP_INFO_MU_BEAMFOMER_CAPABLE		BIT(19U)
#define VHT_CAP_INFO_MU_BEAMFOMEE_CAPABLE		BIT(20U)
#define VHT_CAP_INFO_VHT_TXOP_PS			BIT(21U)
#define VHT_CAP_INFO_HTC_VHT_CAPABLE			BIT(22U)

#define VHT_CAP_INFO_MAX_AMPDU_LENGTH_OFFSET                    23U

#define VHT_CAP_INFO_VHT_LINK_ADAPTATION_CAPABLE_NOFEEDBACK	0
#define VHT_CAP_INFO_VHT_LINK_ADAPTATION_CAPABLE_UNSOLICITED	BITS(27U)
#define VHT_CAP_INFO_VHT_LINK_ADAPTATION_CAPABLE_BOTH		BITS(26U, 27U)

#define VHT_CAP_INFO_RX_ANTENNA_PATTERN_CONSISTENCY		BIT(28U)
#define VHT_CAP_INFO_TX_ANTENNA_PATTERN_CONSISTENCY		BIT(29U)

#define VHT_CAP_INFO_MCS_MAP_MCS7		0
#define VHT_CAP_INFO_MCS_MAP_MCS8		BIT(0U)
#define VHT_CAP_INFO_MCS_MAP_MCS9		(BIT(1U) | ~BIT(0U))
#define VHT_CPA_INFO_MCS_NOT_SUPPORTED		BITS(0U, 1U)

#define VHT_CAP_INFO_MCS_1SS_OFFSET		0U
#define VHT_CAP_INFO_MCS_2SS_OFFSET		2U
#define VHT_CAP_INFO_MCS_3SS_OFFSET		4U
#define VHT_CAP_INFO_MCS_4SS_OFFSET		6U
#define VHT_CAP_INFO_MCS_5SS_OFFSET		8U
#define VHT_CAP_INFO_MCS_6SS_OFFSET		10U
#define VHT_CAP_INFO_MCS_7SS_OFFSET		12U
#define VHT_CAP_INFO_MCS_8SS_OFFSET		14U
...
#define VHT_OP_MODE_CHANNEL_WIDTH                   BITS(0U, 1U)
#define VHT_OP_MODE_RX_NSS                          BITS(4U, 6U)
#define VHT_OP_MODE_RX_NSS_TYPE                     BIT(7U)

#define VHT_OP_MODE_CHANNEL_WIDTH_OFFSET                   0
#define VHT_OP_MODE_RX_NSS_OFFSET                   4
#define VHT_OP_MODE_RX_NSS_TYPE_OFFSET              7

#define VHT_OP_MODE_CHANNEL_WIDTH_20                0U
...
#define AMPDU_PARAM_MAX_AMPDU_LEN_EXP               BITS(0U, 1U)
#define AMPDU_PARAM_MIN_START_SPACING               BITS(2U, 4U)

#define AMPDU_PARAM_MAX_AMPDU_LEN_8K                0
#define AMPDU_PARAM_MAX_AMPDU_LEN_16K               BIT(0U)
#define AMPDU_PARAM_MAX_AMPDU_LEN_32K               BIT(1U)
#define AMPDU_PARAM_MAX_AMPDU_LEN_64K               BITS(0U, 1U)
#define AMPDU_PARAM_MAX_AMPDU_LEN_128K              BIT(2U)
#define AMPDU_PARAM_MAX_AMPDU_LEN_256K              (BIT(2U) | BIT(0U))
#define AMPDU_PARAM_MAX_AMPDU_LEN_512K              BITS(1U, 2U)
#define AMPDU_PARAM_MAX_AMPDU_LEN_1024K             BITS(0U, 2U)

#define AMPDU_PARAM_MSS_NO_RESTRICIT                0U
#define AMPDU_PARAM_MSS_1_4_US                      BIT(2U)
#define AMPDU_PARAM_MSS_1_2_US                      BIT(3U)
#define AMPDU_PARAM_MSS_1_US                        BITS(2U, 3U)
#define AMPDU_PARAM_MSS_2_US                        BIT(4U)
#define AMPDU_PARAM_MSS_4_US                        (BIT(4U) | BIT(2U))
#define AMPDU_PARAM_MSS_8_US                        (BIT(4U) | BIT(3U))
#define AMPDU_PARAM_MSS_16_US                       BITS(2U, 4U)

/* 7.3.2.56.4 Supported MCS Set field (TX rate: octects 12~15) */
#define SUP_MCS_TX_SET_DEFINED                      BIT(0U)
#define SUP_MCS_TX_RX_SET_NOT_EQUAL                 BIT(1U)
#define SUP_MCS_TX_MAX_NUM_SS                       BITS(2U, 3U)
#define SUP_MCS_TX_UNEQUAL_MODULATION               BIT(4U)

#define SUP_MCS_TX_MAX_NUM_1_SS                     0
#define SUP_MCS_TX_MAX_NUM_2_SS                     BIT(2U)
#define SUP_MCS_TX_MAX_NUM_3_SS                     BIT(3U)
#define SUP_MCS_TX_MAX_NUM_4_SS                     BITS(2U, 3U)

#define SUP_MCS_RX_BITMASK_OCTET_NUM                10U
#define SUP_MCS_RX_DEFAULT_HIGHEST_RATE             0U	/* Not specify */

/* 7.3.2.56.5 HT Extended Capabilities field */
#define HT_EXT_CAP_PCO                              BIT(0U)
#define HT_EXT_CAP_PCO_TRANSITION_TIME              BITS(1U, 2U)
#define HT_EXT_CAP_MCS_FEEDBACK                     BITS(8U, 9U)
#define HT_EXT_CAP_HTC_SUPPORT                      BIT(10U)
#define HT_EXT_CAP_RD_RESPONDER                     BIT(11U)

#define HT_EXT_CAP_PCO_TRANS_TIME_NONE              0U
#define HT_EXT_CAP_PCO_TRANS_TIME_400US             BIT(1U)
#define HT_EXT_CAP_PCO_TRANS_TIME_1_5MS             BIT(2U)
#define HT_EXT_CAP_PCO_TRANS_TIME_5MS               BITS(1U, 2U)

#define HT_EXT_CAP_MCS_FEEDBACK_NO_FB               0U
#define HT_EXT_CAP_MCS_FEEDBACK_UNSOLICITED         BIT(9U)
#define HT_EXT_CAP_MCS_FEEDBACK_BOTH                BITS(8U, 9U)

/* 7.3.2.56.6 Transmit Beamforming Capabilities field */
#define TXBF_IMPLICIT_RX_CAPABLE                    BIT(0U)
#define TXBF_RX_STAGGERED_SOUNDING_CAPABLE          BIT(1U)
#define TXBF_TX_STAGGERED_SOUNDING_CAPABLE          BIT(2U)
#define TXBF_RX_NDP_CAPABLE                         BIT(3U)
#define TXBF_TX_NDP_CAPABLE                         BIT(4U)
#define TXBF_IMPLICIT_TX_CAPABLE                    BIT(5U)
#define TXBF_CALIBRATION_CAPABLE                    BITS(6U, 7U)
#define TXBF_EXPLICIT_CSI_TX_CAPABLE                BIT(8U)
#define TXBF_EXPLICIT_NONCOMPRESSED_TX_CAPABLE      BIT(9U)
#define TXBF_EXPLICIT_COMPRESSED_TX_CAPAB           BIT(10U)
#define TXBF_EXPLICIT_CSI_FEEDBACK_CAPABLE          BITS(11U, 12U)
#define TXBF_EXPLICIT_NONCOMPRESSED_FEEDBACK_CAPABLE BITS(13U, 14U)

#define TXBF_EXPLICIT_COMPRESSED_FEEDBACK_CAPABLE   BITS(15U, 16U)
#define TXBF_EXPLICIT_COMPRESSED_FEEDBACK_IMMEDIATE_CAPABLE BIT(16U)

#define TXBF_MINIMAL_GROUPING_CAPABLE               BITS(17U, 18U)
#define TXBF_MINIMAL_GROUPING_1_2_3_CAPABLE         BITS(17U, 18U)

#define TXBF_CSI_BFER_ANTENNANUM_SUPPORTED          BITS(19U, 20U)
#define TXBF_NONCOMPRESSED_TX_ANTENNANUM_SUPPORTED  BITS(21U, 22U)

#define TXBF_COMPRESSED_TX_ANTENNANUM_SUPPORTED     BITS(23U, 24U)
#define TXBF_COMPRESSED_TX_ANTENNANUM_4_SUPPORTED   BITS(23U, 24U)

#define TXBF_CSI_MAX_ROWS_BFER_SUPPORTED            BITS(25U, 26U)

#define TXBF_CHANNEL_ESTIMATION_CAPABILITY          BITS(27U, 28U)
#define TXBF_CHANNEL_ESTIMATION_4STS_CAPABILITY     BITS(27U, 28U)

/* 7.3.2.56.7 Antenna Selection Capability field */
#define ASEL_CAP_CAPABLE                            BIT(0U)
#define ASEL_CAP_CSI_FB_BY_TX_ASEL_CAPABLE          BIT(1U)
#define ASEL_CAP_ANT_INDICES_FB_BY_TX_ASEL_CAPABLE  BIT(2U)
#define ASEL_CAP_EXPLICIT_CSI_FB_CAPABLE            BIT(3U)
#define ASEL_CAP_ANT_INDICES_CAPABLE                BIT(4U)
#define ASEL_CAP_RX_ASEL_CAPABLE                    BIT(5U)
#define ASEL_CAP_TX_SOUNDING_CAPABLE                BIT(6U)

/* 7.3.2.57 HT Operation element */
#define ELEM_MAX_LEN_HT_OP                          (24U - ELEM_HDR_LEN)

#define HT_OP_INFO1_SCO                             BITS(0U, 1U)
#define HT_OP_INFO1_STA_CHNL_WIDTH                  BIT(2U)
#define HT_OP_INFO1_RIFS_MODE                       BIT(3U)

#define HT_OP_INFO2_HT_PROTECTION                   BITS(0U, 1U)
#define HT_OP_INFO2_NON_GF_HT_STA_PRESENT           BIT(2U)
#define HT_OP_INFO2_OBSS_NON_HT_STA_PRESENT         BIT(4U)

#define HT_OP_INFO3_DUAL_BEACON                     BIT(6U)
#define HT_OP_INFO3_DUAL_CTS_PROTECTION             BIT(7U)
#define HT_OP_INFO3_STBC_BEACON                     BIT(8U)
#define HT_OP_INFO3_LSIG_TXOP_FULL_SUPPORT          BIT(9U)
#define HT_OP_INFO3_PCO_ACTIVE                      BIT(10U)
#define HT_OP_INFO3_PCO_PHASE                       BIT(11U)
...
#define BSS_COEXIST_INFO_REQ                        BIT(0U)
#define BSS_COEXIST_40M_INTOLERANT                  BIT(1U)
#define BSS_COEXIST_20M_REQ                         BIT(2U)
#define BSS_COEXIST_OBSS_SCAN_EXEMPTION_REQ         BIT(3U)
#define BSS_COEXIST_OBSS_SCAN_EXEMPTION_GRANT       BIT(4U)
...
#define ELEM_HS_CONFIG_DGAF_DISABLED_MASK           BIT(0U)
#endif /* CFG_SUPPORT_PASSPOINT */

/* MTK Vendor Specific OUI */
#define ELEM_MIN_LEN_MTK_OUI                        7U
#define VENDOR_OUI_MTK                              { 0x00, 0x0C, 0xE7 }
#define MTK_SYNERGY_CAP_SUPPORT_24G_MCS89           BIT(3U)
#define MTK_SYNERGY_CAP0                            (MTK_SYNERGY_CAP_SUPPORT_24G_MCS89)
#define MTK_SYNERGY_CAP1                            0x0U
#define MTK_SYNERGY_CAP2                            0x0U
#define MTK_SYNERGY_CAP3                            0x0U
...
#define ACTION_DELBA_INITIATOR_MASK                 BIT(11U)
#define ACTION_DELBA_TID_MASK                       BITS(12U, 15U)
...
#define ACTION_SA_QUERY_REQUEST                     0U
#define ACTION_SA_QUERY_RESPONSE                    1U

#define ACTION_SA_QUERY_TR_ID_LEN                   2U
...
#define ACTION_OPERATING_MODE_NOTIFICATION          2U

/* 3  --------------- WFA  frame body fields --------------- */
#define VENDOR_OUI_WFA                              { 0x00U, 0x50U, 0xF2U }
#define VENDOR_OUI_WFA_SPECIFIC                     { 0x50, 0x6F, 0x9A }
// Autochips Add
#define VENDOR_OUI_TYPE_APPLE                       0
// Add end
#define VENDOR_OUI_TYPE_WPA                         1U
#define VENDOR_OUI_TYPE_WMM                         (2U)
#define VENDOR_OUI_TYPE_WPS                         4
#define VENDOR_OUI_TYPE_P2P                         9U
...
#define VERSION_WPA                                 (0x0001U)
#define VENDOR_OUI_SUBTYPE_VERSION_WMM_INFO         (0x0100U)
#define VENDOR_OUI_SUBTYPE_VERSION_WMM_PARAM        (0x0101U)

/* SUBTYPE(1 octet) for WMM */

/* WMM Spec version 1.1 */
#define VENDOR_OUI_SUBTYPE_WMM_INFO                 (0x00U)
#define VENDOR_OUI_SUBTYPE_WMM_PARAM                (0x01U)
#define VENDOR_OUI_SUBTYPE_WMM_TSPEC                (0x02U)

/* VERSION(1 octet) for WMM */

/* WMM Spec version 1.1 */
#define VERSION_WMM                                 (0x01U)

/* WMM-2.1.6 QoS Control Field */
#define WMM_QC_UP_MASK                              BITS(0U, 2U)
#define WMM_QC_EOSP                                 BIT(4U)
#define WMM_QC_ACK_POLICY_MASK                      BITS(5U, 6U)
...
#define ELEM_MIN_LEN_WFA_OUI_TYPE_SUBTYPE           6U

/* 3 Control frame body */
/* 7.2.1.7 BlockAckReq */
#define CTRL_BAR_BAR_CONTROL_OFFSET                 16U
#define CTRL_BAR_BAR_CONTROL_TID_OFFSET             12U
#define CTRL_BAR_BAR_INFORMATION_OFFSET             18U
#define CTRL_BAR_BAR_INFORMATION_SSN_OFFSET         4U
...
#define RM_ACTION_NEIGHBOR_REQUEST                  4U
#define RM_ACTION_REIGHBOR_RESPONSE                 5U
#endif
/*******************************************************************************
*                             D A T A   T Y P E S
********************************************************************************
...
typedef struct _IE_Interworking {
	UINT_8 ucId;
	UINT_8 ucLength;
	UINT_8 ucInDaConn;
	UINT_8 ucVenueGroup;
	UINT_8 ucVenueType;
} __KAL_ATTRIB_PACKED__ IE_Interworking_T, *P_IE_Interworking_T;

/*  Apple Device Information element */
typedef struct _IE_Apple_Device {
	UINT_8 ucId;
	UINT_8 ucLength;
	UINT_8 aucOui[3];
	UINT_8 ucOuiType;
	UINT_8 ucElement[ELEM_MAX_LEN_APPLE_ID];
} __KAL_ATTRIB_PACKED__ IE_Apple_Device_T, *P_IE_Apple_Device_T;
// Add end
...
struct SUB_ELEMENT_T {
	UINT_8 ucSubID;
	UINT_8 ucLength;
	UINT_8 aucOptInfo[32]; // ucSSIDLen
};
...
#define RCPI_TO_dBm(_rcpi)                          \
	((PARAM_RSSI)(((PARAM_RSSI)(_rcpi) > RCPI_HIGH_BOUND ? \
	RCPI_HIGH_BOUND : (PARAM_RSSI)(_rcpi)) / 2) - \
...
#define IE_SIZE(fp)             ((UINT_32)ELEM_HDR_LEN + (UINT_32)IE_LEN(fp))
...
// Autochips Add
#define Interworking_IE(fp)    ((P_IE_Interworking_T) fp)

#define Apple_Device_IE(fp)     ((P_IE_Apple_Device_T) fp)
// Add end
...
#define IS_BMCAST_MAC_ADDR(_pucDestAddr)            \
	((((PUINT_8)(_pucDestAddr))[0] & BIT(0U)) != 0U)
...
#define EQUAL_MAC_ADDR(_pucDestAddr, _pucSrcAddr)   \
	(kalMemCmp((_pucDestAddr), (_pucSrcAddr), MAC_ADDR_LEN) == 0)
...
#define EQUAL_SSID(pucSsid1, ucSsidLen1, pucSsid2, ucSsidLen2) \
	...
	kalMemCmp((pucSsid1), (pucSsid2), (ucSsidLen1)) == 0)
...
#define COPY_SSID(pucDestSsid, ucDestSsidLen, pucSrcSsid, ucSrcSsidLen) \
	do { \
		...
		if ((ucSrcSsidLen) != 0U) { \
			ASSERT_BOOLEAN((ucSrcSsidLen) <= ELEM_MAX_LEN_SSID); \
...
#define IE_FOR_EACH(_pucIEsBuf, _u2IEsBufLen, _u2Offset) \
	for ((_u2Offset) = 0U;	\
		((((_u2Offset) + 2U) <= (_u2IEsBufLen)) && (((_u2Offset) \
		+ (UINT_16)IE_SIZE(_pucIEsBuf)) <= (_u2IEsBufLen))); \
		(_u2Offset) += (UINT_16)IE_SIZE(_pucIEsBuf), (_pucIEsBuf) \
		+= (UINT_16)IE_SIZE(_pucIEsBuf))

#define SET_EXT_CAP(_aucField, _ucFieldLength, _ucBit) \
			do { \
				if ((_ucBit) < ((_ucFieldLength) * 8U)) { \
					PUINT_8 aucExtCap = (PUINT_8)(_aucField); \
					((aucExtCap)[(_ucBit) / 8U]) \
					|= (UINT_8)BIT((_ucBit) % 8U); \
				} \
			} while (1U != 1U)
