...
********************************************************************************
*/
#define MAX_SEQ_NO                  (4095U)
#define MAX_SEQ_NO_COUNT            (4096U)
#define HALF_SEQ_NO_CNOUT           (2048U)

#define HALF_SEQ_NO_COUNT           (2048U)

#define MT6620_FIXED_WIN_SIZE         64
#define CFG_RX_MAX_BA_ENTRY            4
#define CFG_RX_MAX_BA_TID_NUM          8U

#define RX_STATUS_FLAG_MORE_PACKET    BIT(30U)
#define RX_STATUS_CHKSUM_MASK         BITS(0U, 10U)
...
/*!< 0~15 (0: un-limited) */s
#define SDIO_MAXIMUM_RX_LEN_NUM              (0U)
#else
/*!< 0~15 (0: un-limited) */
#define SDIO_MAXIMUM_RX_LEN_NUM              (0U)
#endif
...
#define RX_PAYLOAD_FORMAT_MSDU                  0U
#define RX_PAYLOAD_FORMAT_FIRST_SUB_AMSDU       3U
#define RX_PAYLOAD_FORMAT_MIDDLE_SUB_AMSDU      2U
#define RX_PAYLOAD_FORMAT_LAST_SUB_AMSDU        1U
 ...
 *------------------------------------------------------------------------------
*/
#define CIPHER_SUITE_NONE               0U
#define CIPHER_SUITE_WEP40              1U
#define CIPHER_SUITE_TKIP               2U
#define CIPHER_SUITE_TKIP_WO_MIC        3U
#define CIPHER_SUITE_CCMP               4U
#define CIPHER_SUITE_WEP104             5U
#define CIPHER_SUITE_BIP                6U
#define CIPHER_SUITE_WEP128             7U
#define CIPHER_SUITE_WPI                8U
#define CIPHER_SUITE_CCMP_W_CCX         9U
#define CIPHER_SUITE_GCMP               10U
...
/* DW 0*/
/* Word 0 */
#define RX_STATUS_RX_BYTE_COUNT_MASK    BITS(0U, 16U)
/* Word 1 */
#define RX_STATUS_ETH_TYPE_OFFSET_MASK  BITS(0U, 6U)
#define RX_STATUS_ETH_TYPE_OFFSET       0U
#define RX_STATUS_IP_CHKSUM             BIT(7U)
#define RX_STATUS_UDP_TCP_CHKSUM        BIT(8U)
#define RX_STATUS_GROUP_VLD_MASK        BITS(9U, 12U)
#define RX_STATUS_GROUP_VLD_OFFSET      9U
#define RX_STATUS_PKT_TYPE_MASK         BITS(13U, 15U)
#define RX_STATUS_PKT_TYPE_OFFSET       13U

/* DW 1 */
/* Byte 0 */
#define RX_STATUS_HTC                   BIT(0U)
#define RX_STATUS_UC2ME                 BIT(1U)
#define RX_STATUS_MC_FRAME              BIT(2U)
#define RX_STATUS_BC_FRAME              BIT(3U)
#define RX_STATUS_BCN_WITH_BMC          BIT(4U)
#define RX_STATUS_BCN_WITH_UC           BIT(5U)
#define RX_STATUS_KEYID_MASK            BITS(6U, 7U)
#define RX_STATUS_KEYID_OFFSET          6U

/* Byte 1 */
#define RX_STATUS_CHAN_FREQ_MASK        BITS(0U, 7U)
/* Byte 2 */
#define RX_STATUS_HEADER_LEN_MASK       BITS(0U, 5U)
#define RX_STATUS_HEADER_OFFSET         BIT(6U)
#define RX_STATUS_HEADER_TRAN           BIT(7U)
/* Byte 3 */
#define RX_STATUS_PAYLOAD_FORMAT_MASK   BITS(0U, 1U)
#define RX_STATUS_PAYLOAD_FORMAT_OFFSET 0U
#define RX_STATUS_BSSID_MASK            BITS(2U, 7U)
#define RX_STATUS_BSSID_OFFSET          2U

/* DW 2 */
/* Byte 1 */
#define RX_STATUS_TID_MASK              BITS(0U, 3U)
#define RX_STATUS_SEC_MASK              BITS(4U, 7U)
#define RX_STATUS_SEC_OFFSET            (4U)
/* Byte 2-3 */
#define RX_STATUS_SW_BIT                BIT(0U)
#define RX_STATUS_FLAG_FCS_ERROR        BIT(1U)
#define RX_STATUS_FLAG_CIPHER_MISMATCH  BIT(2U)
#define RX_STATUS_FLAG_CIPHER_LENGTH_MISMATCH     BIT(3U)
#define RX_STATUS_FLAG_ICV_ERROR        BIT(4U)
#define RX_STATUS_FLAG_TKIPMIC_ERROR    BIT(5U)
#define RX_STATUS_FLAG_LEN_MISMATCH     BIT(6U)
#define RX_STATUS_FLAG_DE_AMSDU_FAIL    BIT(7U)
#define RX_STATUS_FLAG_EXCEED_LEN       BIT(8U)
#define RX_STATUS_LLC_MIS               BIT(9U)
#define RX_STATUS_UDF_VLT               BIT(10U)
#define RX_STATUS_FRAG                  BIT(11U)
#define RX_STATUS_NULL                  BIT(12U)
#define RX_STATUS_DATA                  BIT(13U)
#define RX_STATUS_AMPDU_SUB_FRAME       BIT(14U)
#define RX_STATUS_AMPDU_FORMAT          BIT(15U)
...
/* DW 3 */
#define RX_STATUS_RXV_SEQ_NO_MASK       BITS(0U, 7U)
#define RX_STATUS_TCL                   BIT(8U)
#define RX_STATUS_CLS                   BIT(11U)
#define RX_STATUS_OFLD_MASK             BITS(12U, 13U)
#define RX_STATUS_OFLD_OFFSET           12
#define RX_STATUS_EAPOL_PACKET          BIT(12U)
#define RX_STATUS_ARP_NS_PACKET         BIT(13U)
#define RX_STATUS_TDLS_PACKET           BITS(12U, 13U)
#define RX_STATUS_MGC                   BIT(14U)
#define RX_STATUS_WOL_MASK              BITS(15U, 19U)
#define RX_STATUS_WOL_OFFSET            15
#define RX_STATUS_CLS_BITMAP_MASK       BITS(20U, 29U)
#define RX_STATUS_CLS_BITMAP_OFFSET     20
#define RX_STATUS_PF_MODE_BLACK_LIST    BIT(30U)
#define RX_STATUS_PF_STS_CHECKED        BIT(31U)

/* DW 12 */
#define RX_STATUS_FRAG_NUM_MASK         BITS(0U, 3U)
#define RX_STATUS_SEQ_NUM_MASK          BITS(4U, 15U)
#define RX_STATUS_SEQ_NUM_OFFSET        4U

#define RX_STATUS_GROUP1_VALID    BIT(0U)
#define RX_STATUS_GROUP2_VALID    BIT(1U)
#define RX_STATUS_GROUP3_VALID    BIT(2U)
#define RX_STATUS_GROUP4_VALID    BIT(3U)

#define RX_STATUS_FIXED_LEN       16

#define RX_STATUS_CHAN_FREQ_MASK_FOR_BY_PASS_MPDE      BITS(0U, 7U)
#define RX_STATUS_FLAG_FCS_ERROR_FOR_BY_PASS_MODE      BIT(16U)

/* Timing Measurement Report */
/* DW0 Word 1 */
#define RX_TMR_TOA_VALID          BIT(11U)
#define RX_TMR_TOD_VALID          BIT(10U)
#define RX_TMR_TYPE_MASK          BITS(8U, 9U)
#define RX_TMR_TYPE_OFFSET        8
#define RX_TMR_SUBTYPE_MASK       BITS(4U, 7U)
#define RX_TMR_SUBTYPE_OFFSET     4

/* DW0 Byte 1*/
#define RX_TMR_TM_FAILED          BIT(2U)
#define RX_TMR_NOISY_CHAN         BIT(1U)
#define RX_TMR_RESPONDER          BIT(0U)

/* TBD */
#define DMA_OWN_TO_HW          BIT(0U)
#define DMA_OWN_TO_FW_PENDING  BIT(1U)
...
/* DW 2 */
#define RX_STATUS_PACKET_LENGTH_MASK    BITS(0U, 16u)

#define RX_STATUS_HEADER_TRAN_MASK          BIT(7U)
#define RX_STATUS_HEADER_TRAN_OFFSET        7
#define RX_STATUS_HEADER_TRAN_BSS0_MASK     BIT(6U)
#define RX_STATUS_HEADER_TRAN_BSS0_OFFSET   6
#define RX_STATUS_HEADER_TRAN_BSS1_MASK     BIT(7U)
#define RX_STATUS_HEADER_TRAN_BSS1_OFFSET   7

/* DW 4 */
#define RX_STATUS_MATCH_PACKET        BIT(4U)
...
*/
/* DW 2 */
#define RX_VECTOR_FOR_BA_ACK        BIT(7U)

/*! HIF RX DMA Descriptor */
/* DW 2 */
#define HIF_RX_DESC_BUFFER_LEN                  BITS(0U, 15U)
#define HIF_RX_DESC_ETHER_TYPE_OFFSET_MASK      BITS(16U, 23U)
#define HIF_RX_DESC_ETHER_TYPE_OFFSET_OFFSET    16
#define HIF_RX_DESC_IP_CHKSUM_CHECK             BIT(24U)
#define HIF_RX_DESC_TCP_UDP_CHKSUM_CHECK        BIT(25U)
...
/* RX Vector, 1st Cycle */
#define RX_VT_RX_RATE_AC_MASK      BITS(0U, 3U)
#define RX_VT_RX_RATE_MASK         BITS(0U, 6U)
#define RX_VT_RX_RATE_OFFSET       0U
#define RX_VT_STBC_MASK            BITS(7U, 8U)
#define RX_VT_STBC_OFFSET          7U
#define RX_VT_LDPC                 BIT(9U)
#define RX_VT_NESS_MASK            BITS(10U, 11U)
#define RX_VT_NESS_OFFSET          10U
#define RX_VT_RX_MODE_MASK         BITS(12U, 14U)
#define RX_VT_RX_MODE_OFFSET       12U
#define RX_VT_RX_MODE_VHT          BIT(14U)
#define RX_VT_FR_MODE_MASK         BITS(15U, 16U)
#define RX_VT_FR_MODE_OFFSET       15U
#define RX_VT_TXOP_PS_NOT_ALLOWED  BIT(17U)
#define RX_VT_AGGREGATION          BIT(18U)
#define RX_VT_SHORT_GI             BIT(19U)
#define RX_VT_SMOOTH               BIT(20U)
#define RX_VT_NO_SOUNDING          BIT(21U)
#define RX_VT_SOUNDING             BIT(21U)
#define RX_VT_SHORT_GI_NSYM        BIT(22U)
#define RX_VT_CODING_MASK          BITS(23U, 24U)
#define RX_VT_CODING_OFFSET        23U
#define RX_VT_BEAMFORMED           BIT(29U)
#define RX_VT_GROUPID_0_MASK       BITS(30U, 31U)
#define RX_VT_GROUPID_0_OFFSET     30U
...
#define RX_VT_RX_RATE_MCS0    0U
#define RX_VT_RX_RATE_MCS1    1U
#define RX_VT_RX_RATE_MCS2    2U
#define RX_VT_RX_RATE_MCS3    3U
#define RX_VT_RX_RATE_MCS4    4U
#define RX_VT_RX_RATE_MCS5    5U
#define RX_VT_RX_RATE_MCS6    6U
#define RX_VT_RX_RATE_MCS7    7U
#define RX_VT_RX_RATE_MCS32   32U

#define RX_VT_LEGACY_CCK      0U
#define RX_VT_LEGACY_OFDM     1U
#define RX_VT_MIXED_MODE      2U
#define RX_VT_GREEN_MODE      3U
#define RX_VT_VHT_MODE        4U

#define RX_VT_LG20_HT20       0U
#define RX_VT_DL40_HT40       1U
#define RX_VT_U20             2U
#define RX_VT_L20             3U

#define RX_VT_FR_MODE_20      0U
#define RX_VT_FR_MODE_40      1U
#define RX_VT_FR_MODE_80      2U
#define RX_VT_FR_MODE_160     3U

#define RX_VT_CCK_SHORT_PREAMBLE   BIT(2U)

/* RX Vector, 2nd Cycle */
#define RX_VT_RX_LEN_HT_MASK       BITS(0U, 15U)
#define RX_VT_RX_LEN_LEACY_MASK    BITS(0U, 11U)
#define RX_VT_RX_LEN_VHT_MASK      BITS(0U, 20u)
#define RX_VT_GROUPID_1_MASK       BITS(21U, 24u)
#define RX_VT_GROUPID_1_OFFSET     21U
#define RX_VT_NSTS_MASK            BITS(25U, 27U)
#define RX_VT_NSTS_OFFSET          25U
#define RX_VT_AID_0_MASK           BITS(28U, 31U)
#define RX_VT_AID_0_OFFSET         28U

/* RX Vector, 3rd Cycle */
#define RX_VT_AID_1_MASK          BITS(0U, 4U)
#define RX_VT_AID_1_OFFSET        0U
#define RX_VT_SEL_ANT             BIT(7U)
#define RX_VT_RCPI_MASK           BITS(8U, 15U)
#define RX_VT_RCPI_OFFSET         8U
#define RX_VT_OFDM_FREQ_TRANS_DET BIT(5U)
#define RX_VT_FAGC0_EQ_CAL        BIT(16U)

/* RX Vector, 4th Cycle */
#define RX_VT_IB_RSSI_MASK       BITS(0U, 7U)
#define RX_VT_WB_RSSI_MASK       BITS(8U, 15U)
#define RX_VT_WB_RSSI_OFFSET    8U

/* RX Vector, 6th Cycle */
#define RX_VT_NF0_MASK          BITS(0U, 7U)
#define RX_VT_NF0_OFFSET        0U

/* RX Vector Group 2, the 1st cycle */
#define RX_VT_CCK_LQ            BITS(4U, 10U)
#define RX_VT_OFDM_LQ_BPSK      BITS(4U, 9U)
#define RX_VT_LQ_OFFSET         4U
#define RX_VT_PRIM_ITFR_ENV     BIT(0U)
#define RX_VT_SEC_ITFR_ENV      BIT(1U)
#define RX_VT_SEC40_ITFR_ENV    BIT(2U)

/* RX Vector Group 2, the 2nd cycle */
#define RX_VT_DYNA_BW_IN_NON_HT_DYNA   BIT(29U)
#define RX_VT_CH_BW_IN_NON_HT_CBW40    BIT(30U)
#define RX_VT_CH_BW_IN_NON_HT_CBW80    BIT(31U)
#define RX_VT_CH_BW_IN_NON_HT_CBW160   BITS(30U, 31U)

/* RX Data Type */
#define RX_DATA_TYPE_RX_VECTOR  0U
#define RX_DATA_TYPE_RX_DATA    1U
#define RX_DATA_TYPE_RX_EVM     2U
#define RX_DATA_TYPE_RX_AMBI    3U
#define RX_DATA_TYPE_RX_BT      4U
...
#define RXM_RXD_PKT_TYPE_SW_BITMAP 0xE00FU
#define RXM_RXD_PKT_TYPE_SW_EVENT  0xE000U
#define RXM_RXD_PKT_TYPE_SW_FRAME  0xE001U

/* AMPDU data frame with no errors including FC/FM/I/T/LM/DAF/EL/LLC-MIS/ UDFVLT and Class 3 error */
#define RXS_DW2_AMPDU_nERR_BITMAP  0xFFBFU
#define RXS_DW2_AMPDU_nERR_VALUE   0x0000U
/* no error including FC/FM/I/T/LM/DAF/EL/LLC-MIS/ UDFVLT */
#define RXS_DW2_RX_nERR_BITMAP     0x07F8U
#define RXS_DW2_RX_nERR_VALUE      0x0000U
/* Non-Data frames */
#define RXS_DW2_RX_nDATA_BITMAP    0x3000U
#define RXS_DW2_RX_nDATA_VALUE     0x2000U
/* Claas Error */
#define RXS_DW2_RX_CLASSERR_BITMAP 0x0001U
#define RXS_DW2_RX_CLASSERR_VALUE  0x0001U
/* Fragmentation */
#define RXS_DW2_RX_FRAG_BITMAP     0x3800U
#define RXS_DW2_RX_FRAG_VALUE      0x0800U
...
#define RX_INC_CNT(_prRxCtrl, eCounter)              \
	{((P_RX_CTRL_T)_prRxCtrl)->au8Statistics[eCounter]++; }

#define RX_ADD_CNT(_prRxCtrl, eCounter, u8Amount)    \
	{((P_RX_CTRL_T)_prRxCtrl)->au8Statistics[eCounter] \
	+= (UINT_64)u8Amount; }

#define RX_GET_CNT(_prRxCtrl, eCounter)              \
	(((P_RX_CTRL_T)_prRxCtrl)->au8Statistics[eCounter])

#define RX_RESET_ALL_CNTS(_prRxCtrl)                 \
	{kalMemZero(&_prRxCtrl->au8Statistics[0], \
	sizeof(_prRxCtrl->au8Statistics)); }
...
#define HAL_RX_STATUS_GET_ETH_TYPE_OFFSET(_prHwMacRxDesc)	\
	(((_prHwMacRxDesc)->u2PktTYpe \
	& (UINT_16)RX_STATUS_ETH_TYPE_OFFSET_MASK) \
	>> RX_STATUS_ETH_TYPE_OFFSET)
#define HAL_RX_STATUS_GET_GROUP_VLD(_prHwMacRxDesc)	\
	(((_prHwMacRxDesc)->u2PktTYpe & (UINT_16)RX_STATUS_GROUP_VLD_MASK) \
	>> RX_STATUS_GROUP_VLD_OFFSET)
#define HAL_RX_STATUS_GET_PKT_TYPE(_prHwMacRxDesc)	\
	(((_prHwMacRxDesc)->u2PktTYpe & (UINT_16)RX_STATUS_PKT_TYPE_MASK) \
	>> RX_STATUS_PKT_TYPE_OFFSET)

/* DW 1 */
#define HAL_RX_STATUS_IS_HTC_EXIST(_prHwMacRxDesc) \
	(((_prHwMacRxDesc)->ucMatchPacket & RX_STATUS_HTC != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_IS_UC2ME(_prHwMacRxDesc) \
	(((_prHwMacRxDesc)->ucMatchPacket & RX_STATUS_UC2ME != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_IS_MC(_prHwMacRxDesc) \
	((((_prHwMacRxDesc)->ucMatchPacket & \
	(UINT_8)RX_STATUS_MC_FRAME) != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_IS_BC(_prHwMacRxDesc) \
	((((_prHwMacRxDesc)->ucMatchPacket & \
	(UINT_8)RX_STATUS_BC_FRAME) != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_IS_BCN_WITH_BMC(_prHwMacRxDesc) \
	(((_prHwMacRxDesc)->ucMatchPacket & \
	RX_STATUS_BCN_WITH_BMC != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_IS_BCN_WITH_UC(_prHwMacRxDesc) \
	(((_prHwMacRxDesc)->ucMatchPacket & \
	RX_STATUS_BCN_WITH_UC != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_GET_KEY_ID(_prHwMacRxDesc)	\
	(((_prHwMacRxDesc)->ucMatchPacket & \
	(UINT_8)RX_STATUS_KEYID_MASK) >> RX_STATUS_KEYID_OFFSET)
...
#define HAL_RX_STATUS_GET_HEADER_LEN(_prHwMacRxDesc) \
	((UINT_16)((_prHwMacRxDesc)->ucHeaderLen) \
	& (UINT_16)RX_STATUS_HEADER_LEN_MASK)
#define HAL_RX_STATUS_IS_HEADER_OFFSET(_prHwMacRxDesc)	\
	((((_prHwMacRxDesc)->ucHeaderLen & \
	(UINT_8)RX_STATUS_HEADER_OFFSET) != 0U)?TRUE:FALSE)
#define HAL_RX_STATUS_GET_HEADER_OFFSET(_prHwMacRxDesc) \
	((((_prHwMacRxDesc)->ucHeaderLen & \
	(UINT_8)RX_STATUS_HEADER_OFFSET) != 0U) ? 2 : 0)
#define HAL_RX_STATUS_IS_HEADER_TRAN(_prHwMacRxDesc) \
	((((_prHwMacRxDesc)->ucHeaderLen & \
	(UINT_8)RX_STATUS_HEADER_TRAN) != 0U)?TRUE:FALSE)
...
#define HAL_RX_STATUS_GET_PAYLOAD_FORMAT(_prHwMacRxDesc) \
	(((_prHwMacRxDesc)->ucBssid \
	& ((UINT_8)RX_STATUS_PAYLOAD_FORMAT_MASK)) \
...
#define RXM_IS_QOS_DATA_FRAME(_u2FrameCtrl) \
	((((_u2FrameCtrl) & (UINT_16)MASK_FRAME_TYPE) \
		== (UINT_16)MAC_FRAME_QOS_DATA) ? TRUE : FALSE)
