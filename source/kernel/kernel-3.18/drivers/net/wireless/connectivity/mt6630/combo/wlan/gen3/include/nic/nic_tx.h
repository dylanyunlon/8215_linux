...
#define MAC_TX_RESERVED_FIELD               0U

#define NIC_TX_RESOURCE_POLLING_TIMEOUT     256
#define NIC_TX_RESOURCE_POLLING_DELAY_MSEC  5U // 50U

#define NIC_TX_CMD_INFO_RESERVED_COUNT      4U
...
#define NIC_TX_BUFF_COUNT_TC0               1U
#define NIC_TX_BUFF_COUNT_TC1               36U
#define NIC_TX_BUFF_COUNT_TC2               1U
#define NIC_TX_BUFF_COUNT_TC3               1U
#define NIC_TX_BUFF_COUNT_TC4               2U
#define NIC_TX_BUFF_COUNT_TC5               1U

#if CFG_ENABLE_FW_DOWNLOAD

#define NIC_TX_INIT_BUFF_COUNT_TC0               8U
#define NIC_TX_INIT_BUFF_COUNT_TC1               0U
#define NIC_TX_INIT_BUFF_COUNT_TC2               0U
#define NIC_TX_INIT_BUFF_COUNT_TC3               0U
#define NIC_TX_INIT_BUFF_COUNT_TC4               8U
#define NIC_TX_INIT_BUFF_COUNT_TC5               0U
...
#define NIC_TX_PAGE_SIZE_IN_POWER_OF_2          7U
#define NIC_TX_PAGE_SIZE                        (128U)	/* in unit of bytes */

/* For development only */
/* calculated by MS native 802.11 format */
#define NIC_TX_MAX_SIZE_PER_FRAME               (1532U)
#define NIC_TX_MAX_PAGE_PER_FRAME \
	((NIC_TX_DESC_AND_PADDING_LENGTH + NIC_TX_DESC_HEADER_PADDING_LENGTH + \
	NIC_TX_MAX_SIZE_PER_FRAME + NIC_TX_PAGE_SIZE - 1U) / NIC_TX_PAGE_SIZE)
...
#define NIC_TX_DESC_LONG_FORMAT_LENGTH_DW (7U)
#define NIC_TX_DESC_LONG_FORMAT_LENGTH \
	DWORD_TO_BYTE(NIC_TX_DESC_LONG_FORMAT_LENGTH_DW)

/* in unit of double word */
#define NIC_TX_DESC_SHORT_FORMAT_LENGTH_DW (2U)
...
/* in unit of double word */
#define NIC_TX_DESC_PADDING_LENGTH_DW           (0U)
...
/* in unit of bytes */
#define NIC_TX_DESC_HEADER_PADDING_LENGTH       (0U)

/* For Tx packets to peer who has no WLAN table index. */
#define NIC_TX_DEFAULT_WLAN_INDEX               31

#define NIC_TX_DESC_PID_RESERVED                0U
#define NIC_TX_DESC_DRIVER_PID_MIN              1U
#define NIC_TX_DESC_DRIVER_PID_MAX              127U
...
/*------------------------------------------------------------------------*/
/* DW 0 */
#define TX_DESC_TX_BYTE_COUNT_MASK              BITS(0U, 15U)
#define TX_DESC_TX_BYTE_COUNT_OFFSET            0

#define TX_DESC_ETHER_TYPE_OFFSET_MASK          BITS(0U, 6U)
#define TX_DESC_ETHER_TYPE_OFFSET_OFFSET        0U
#define TX_DESC_IP_CHKSUM_OFFLOAD               BIT(7U)
#define TX_DESC_TCP_UDP_CHKSUM_OFFLOAD          BIT(0U)
#define TX_DESC_USB_NEXT_VLD                    BIT(1U)
#define TX_DESC_USB_TX_BURST                    BIT(2U)
#define TX_DESC_QUEUE_INDEX_MASK                BITS(3U, 6U)
#define TX_DESC_QUEUE_INDEX_OFFSET              3U
#define TX_DESC_PORT_INDEX                      BIT(7U)
#define TX_DESC_PORT_INDEX_OFFSET               7U

#define PORT_INDEX_LMAC                         0U
#define PORT_INDEX_MCU                          1U

/* DW 1 */
#define TX_DESC_WLAN_INDEX_MASK                 BITS(0U, 7U)
#define TX_DESC_WLAN_INDEX_OFFSET               0

#define TX_DESC_HEADER_FORMAT_MASK              BITS(5U, 6U)
#define TX_DESC_HEADER_FORMAT_OFFSET            5U
...
#define HEADER_FORMAT_802_11_MASK               BIT(1U)

#define TX_DESC_NON_802_11_MORE_DATA            BIT(0U)
#define TX_DESC_NON_802_11_EOSP                 BIT(1U)
#define TX_DESC_NON_802_11_REMOVE_VLAN          BIT(2U)
#define TX_DESC_NON_802_11_VLAN_FIELD           BIT(3U)
#define TX_DESC_NON_802_11_ETHERNET_II          BIT(4U)
#define TX_DESC_NOR_802_11_HEADER_LENGTH_MASK   BITS(0U, 4U)
#define TX_DESC_NOR_802_11_HEADER_LENGTH_OFFSET 0U
#define TX_DESC_ENH_802_11_EOSP                 BIT(1U)
#define TX_DESC_ENH_802_11_AMSDU                BIT(2U)

#define TX_DESC_FORMAT                          BIT(7U)
#define TX_DESC_SHORT_FORMAT                    0
#define TX_DESC_LONG_FORMAT                     1
#define TX_DESC_HEADER_PADDING_LENGTH_MASK      BITS(0U, 1U)
#define TX_DESC_HEADER_PADDING_LENGTH_OFFSET    0U
#define TX_DESC_HEADER_PADDING_MODE             BIT(2U)
#define TX_DESC_NO_ACK                          BIT(3U)
#define TX_DESC_TID_MASK                        BITS(4U, 6U)
#define TX_DESC_TID_OFFSET                      4U
#define TX_DESC_TID_NUM                         8U
#define TX_DESC_PROTECTED_FRAME                 BIT(7U)

#define TX_DESC_PACKET_TYPE_MASK                BITS(0U, 1U)	/* SW Field */
#define TX_DESC_PACKET_TYPE_OFFSET              0U
#define TX_DESC_OWN_MAC_MASK                    BITS(2U, 7U)
#define TX_DESC_OWN_MAC_OFFSET                  2U

/* DW 2 */
#define TX_DESC_SUB_TYPE_MASK                   BITS(0U, 3U)
#define TX_DESC_SUB_TYPE_OFFSET                 0U
#define TX_DESC_TYPE_MASK                       BITS(4U, 5U)
#define TX_DESC_TYPE_OFFSET                     4U
#define TX_DESC_NDP                             BIT(6U)
#define TX_DESC_NDPA                            BIT(7U)

#define TX_DESC_SOUNDING                        BIT(0U)
#define TX_DESC_FORCE_RTS_CTS                   BIT(1U)
#define TX_DESC_BROADCAST_MULTICAST             BIT(2U)
#define TX_DESC_BIP_PROTECTED                   BIT(3U)
#define TX_DESC_DURATION_FIELD_CONTROL          BIT(4U)
#define TX_DESC_HTC_EXISTS                      BIT(5U)
#define TX_DESC_FRAGMENT_MASK                   BITS(6U, 7U)
#define TX_DESC_FRAGMENT_OFFSET                 6U
#define FRAGMENT_FISRT_PACKET                   1U
#define FRAGMENT_MIDDLE_PACKET                  2U
#define FRAGMENT_LAST_PACKET                    3U

#define TX_DESC_REMAINING_MAX_TX_TIME           BITS(0U, 7U)
#define TX_DESC_TX_TIME_NO_LIMIT                0U
/* Unit of life time calculation of Tx descriptor */
#define TX_DESC_LIFE_TIME_UNIT_IN_POWER_OF_2    5U
#define TX_DESC_LIFE_TIME_UNIT                  POWER_OF_2(TX_DESC_LIFE_TIME_UNIT_IN_POWER_OF_2)
#define TX_DESC_POWER_OFFSET_MASK               BITS(0U, 4U)
#define TX_DESC_BA_DISABLE                      BIT(5U)
#define TX_DESC_TIMING_MEASUREMENT              BIT(6U)
#define TX_DESC_FIXED_RATE                      BIT(7U)

/* DW 3 */
#define TX_DESC_SW_RESERVED_MASK                BITS(0U, 5U)
#define TX_DESC_SW_RESERVED_OFFSET              0U
#define TX_DESC_TX_COUNT_MASK                   BITS(6U, 10U)
#define TX_DESC_TX_COUNT_OFFSET                 6U
#define TX_DESC_TX_COUNT_NO_ATTEMPT             0U
#define TX_DESC_TX_COUNT_NO_LIMIT               31U
#define TX_DESC_REMAINING_TX_COUNT_MASK         BITS(11U, 15U)
#define TX_DESC_REMAINING_TX_COUNT_OFFSET       11U
#define TX_DESC_SEQUENCE_NUMBER                 BITS(0U, 11U)
#define TX_DESC_HW_RESERVED_MASK                BITS(12U, 13U)
#define TX_DESC_HW_RESERVED_OFFSET              12U
#define TX_DESC_PN_IS_VALID                     BIT(14U)
#define TX_DESC_SN_IS_VALID                     BIT(15U)

/* DW 4 */
#define TX_DESC_PN_PART1                        BITS(0U, 31U)

/* DW 5 */
#define TX_DESC_PACKET_ID                       BIT(0U, 7U)
#define TX_DESC_TX_STATUS_FORMAT                BIT(0U)
#define TX_DESC_TX_STATUS_FORMAT_OFFSET         0U
#define TX_DESC_TX_STATUS_TO_MCU                BIT(1U)
#define TX_DESC_TX_STATUS_TO_HOST               BIT(2U)
#define TX_DESC_DA_SOURCE                       BIT(3U)
#define TX_DESC_BAR_SSN_CONTROL                 BIT(4U)
#define TX_DESC_POWER_MANAGEMENT_CONTROL        BIT(5U)
#define TX_DESC_PN_PART2                        BITS(0U, 15U)

			       /* DW 6 *//* FR = 1 */
#define TX_DESC_FIXED_RATE_MODE                 BIT(0U)
#define TX_DESC_ANTENNA_INDEX_MASK              BITS(2U, 7U)
#define TX_DESC_ANTENNA_INDEX_OFFSET            2U

#define TX_DESC_BANDWIDTH_MASK                  BITS(0U, 2U)
#define TX_DESC_SPATIAL_EXTENSION               BIT(3U)
#define TX_DESC_ANTENNA_PRIORITY                BITS(4U, 6U)
#define TX_DESC_DYNAMIC_BANDWIDTH               BIT(7U)

#define TX_DESC_EXPLICIT_BEAMFORMING            BIT(0U)
#define TX_DESC_IMPLICIT_BEAMFORMING            BIT(1U)
#define TX_DESC_FIXDE_RATE_MASK                 BITS(2U, 13U)
#define TX_DESC_FIXDE_RATE_OFFSET               2U
#define TX_DESC_LDPC                            BIT(14U)
#define TX_DESC_GUARD_INTERVAL                  BIT(15U)

#if CFG_ENABLE_PKT_LIFETIME_PROFILE
/* in unit of ms */
#define NIC_TX_TIME_THRESHOLD                       100U
#endif
...
typedef enum _ENUM_MSDU_OPTION_T {
	MSDU_OPT_NO_ACK = BIT(0U),
	MSDU_OPT_NO_AGGREGATE = BIT(1U),
	MSDU_OPT_TIMING_MEASURE = BIT(2U),
	MSDU_OPT_RCPI_NOISE_STATUS = BIT(3U),

	/* Option by Frame Format */
	/* Non-80211 */
	MSDU_OPT_MORE_DATA = BIT(4U),
	MSDU_OPT_REMOVE_VLAN = BIT(5U),	/* Remove VLAN tag if exists */

	/* 80211-enhanced */
	MSDU_OPT_AMSDU = BIT(6U),

	/* 80211-enhanced & Non-80211 */
	MSDU_OPT_EOSP = BIT(7U),

	/* Beamform */
	MSDU_OPT_NDP = BIT(8U),
	MSDU_OPT_NDPA = BIT(9U),
	MSDU_OPT_SOUNDING = BIT(10U),

	/* Protection */
	MSDU_OPT_FORCE_RTS = BIT(11U),

	/* Security */
	MSDU_OPT_BIP = BIT(12U),
	MSDU_OPT_PROTECTED_FRAME = BIT(13U),

	/* SW Field */
	MSDU_OPT_SW_DURATION = BIT(14U),
	MSDU_OPT_SW_PS_BIT = BIT(15U),
	MSDU_OPT_SW_HTC = BIT(16U),
	MSDU_OPT_SW_BAR_SN = BIT(17U),

	/* Manual Mode */
	MSDU_OPT_MANUAL_FIRST_BIT = BIT(18U),

	MSDU_OPT_MANUAL_LIFE_TIME = MSDU_OPT_MANUAL_FIRST_BIT,
	MSDU_OPT_MANUAL_RETRY_LIMIT = BIT(19U),
	MSDU_OPT_MANUAL_POWER_OFFSET = BIT(20U),
	MSDU_OPT_MANUAL_TX_QUE = BIT(21U),
	MSDU_OPT_MANUAL_SN = BIT(22U),

	MSDU_OPT_MANUAL_LAST_BIT = MSDU_OPT_MANUAL_SN
} ENUM_MSDU_OPTION_T;

typedef enum _ENUM_MSDU_CONTROL_FLAG_T {
	MSDU_CONTROL_FLAG_FORCE_TX = BIT(0U)
...
#define TX_INC_CNT(_prTxCtrl, eCounter)              \
	{((P_TX_CTRL_T)_prTxCtrl)->au4Statistics[eCounter]++; }

#define TX_ADD_CNT(_prTxCtrl, eCounter, u8Amount)    \
	{((P_TX_CTRL_T)_prTxCtrl)->au4Statistics[eCounter] \
	+= (UINT_32)u8Amount; }

#define TX_GET_CNT(_prTxCtrl, eCounter)              \
	(((P_TX_CTRL_T)(_prTxCtrl))->au4Statistics[eCounter])

#define TX_RESET_ALL_CNTS(_prTxCtrl)                 \
	{kalMemZero(&(_prTxCtrl)->au4Statistics[0], \
...
#define HAL_MAC_TX_DESC_SET_ETHER_TYPE_OFFSET(_prHwMacTxDesc, _ucEtherTypeOffset) \
	...
	((UINT_8)_ucEtherTypeOffset), \
	((UINT_8)TX_DESC_ETHER_TYPE_OFFSET_MASK), \
	TX_DESC_ETHER_TYPE_OFFSET_OFFSET)

#define HAL_MAC_TX_DESC_IS_IP_CHKSUM_ENABLED(_prHwMacTxDesc)		\
	(((_prHwMacTxDesc)->ucEtherOffset \
	& (UINT_8)TX_DESC_IP_CHKSUM_OFFLOAD)?FALSE:TRUE)
#define HAL_MAC_TX_DESC_SET_IP_CHKSUM(_prHwMacTxDesc)			\
	((_prHwMacTxDesc)->ucEtherOffset |= (UINT_8)TX_DESC_IP_CHKSUM_OFFLOAD)
...
#define HAL_MAC_TX_DESC_IS_TCP_UDP_CHKSUM_ENABLED(_prHwMacTxDesc)	\
	...
	& (UINT_8)TX_DESC_TCP_UDP_CHKSUM_OFFLOAD)?FALSE:TRUE)
#define HAL_MAC_TX_DESC_SET_TCP_UDP_CHKSUM(_prHwMacTxDesc)		\
	((_prHwMacTxDesc)->ucPortIdx_QueueIdx \
	|= (UINT_8)TX_DESC_TCP_UDP_CHKSUM_OFFLOAD)
...
#define HAL_MAC_TX_DESC_IS_LONG_FORMAT(_prHwMacTxDesc) \
	(((_prHwMacTxDesc)->ucHeaderFormat & ((UINT_8)TX_DESC_FORMAT)))
...
#define HAL_MAC_TX_DESC_SET_HEADER_FORMAT(_prHwMacTxDesc, _ucHdrFormat) \
	...
	((UINT_8)_ucHdrFormat), ((UINT_8)TX_DESC_HEADER_FORMAT_MASK), \
	TX_DESC_HEADER_FORMAT_OFFSET)

/* HF = 0x00, 802.11 normal mode */
#define HAL_MAC_TX_DESC_IS_MORE_DATA(_prHwMacTxDesc)		\
	(((_prHwMacTxDesc)->ucHeaderFormat \
	& TX_DESC_NON_802_11_MORE_DATA)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_MORE_DATA(_prHwMacTxDesc)		\
	((_prHwMacTxDesc)->ucHeaderFormat \
	|= (UINT_8)TX_DESC_NON_802_11_MORE_DATA)
...
#define HAL_MAC_TX_DESC_IS_REMOVE_VLAN(_prHwMacTxDesc)		\
	(((_prHwMacTxDesc)->ucHeaderFormat \
	& TX_DESC_NON_802_11_REMOVE_VLAN)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_REMOVE_VLAN(_prHwMacTxDesc)		\
	((_prHwMacTxDesc)->ucHeaderFormat \
	|= (UINT_8)TX_DESC_NON_802_11_REMOVE_VLAN)
...
#define HAL_MAC_TX_DESC_IS_VLAN(_prHwMacTxDesc)		\
	(((_prHwMacTxDesc)->ucHeaderFormat \
	& TX_DESC_NON_802_11_VLAN_FIELD)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_VLAN(_prHwMacTxDesc)	\
	((_prHwMacTxDesc)->ucHeaderFormat \
	|= (UINT_8)TX_DESC_NON_802_11_VLAN_FIELD)
...
#define HAL_MAC_TX_DESC_IS_ETHERNET_II(_prHwMacTxDesc)		\
	(((_prHwMacTxDesc)->ucHeaderFormat \
	& TX_DESC_NON_802_11_ETHERNET_II)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_ETHERNET_II(_prHwMacTxDesc)		\
	((_prHwMacTxDesc)->ucHeaderFormat \
	|= (UINT_8)TX_DESC_NON_802_11_ETHERNET_II)
...
#define HAL_MAC_TX_DESC_IS_EOSP(_prHwMacTxDesc)	\
	(((_prHwMacTxDesc)->ucHeaderFormat \
	& TX_DESC_NON_802_11_EOSP)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_EOSP(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucHeaderFormat |= (UINT_8)TX_DESC_NON_802_11_EOSP)
...
#define HAL_MAC_TX_DESC_IS_AMSDU(_prHwMacTxDesc)	\
	(((_prHwMacTxDesc)->ucHeaderFormat \
	& TX_DESC_ENH_802_11_AMSDU)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_AMSDU(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucHeaderFormat |= (UINT_8)TX_DESC_ENH_802_11_AMSDU)
...
#define HAL_MAC_TX_DESC_GET_802_11_HEADER_LENGTH(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD((_prHwMacTxDesc)->ucHeaderFormat,	\
	((UINT_8)TX_DESC_NOR_802_11_HEADER_LENGTH_MASK), \
...
#define HAL_MAC_TX_DESC_GET_HEADER_PADDING(_prHwMacTxDesc) \
	...
	((UINT_8)TX_DESC_HEADER_PADDING_LENGTH_MASK), \
...
#define HAL_MAC_TX_DESC_IS_PROTECTION(_prHwMacTxDesc)	\
	((((_prHwMacTxDesc)->ucHeaderPadding \
	& (UINT_8)TX_DESC_PROTECTED_FRAME) != 0U)?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_PROTECTION(_prHwMacTxDesc)	\
	((_prHwMacTxDesc)->ucHeaderPadding \
	|= (UINT_8)TX_DESC_PROTECTED_FRAME)
...
#define HAL_MAC_TX_DESC_GET_OWN_MAC_INDEX(_prHwMacTxDesc) \
	...
	((UINT_8)TX_DESC_OWN_MAC_MASK), TX_DESC_OWN_MAC_OFFSET)
...
#define HAL_MAC_TX_DESC_SET_NDP(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucType_SubType |= (UINT_8)TX_DESC_NDP)
...
#define HAL_MAC_TX_DESC_SET_NDPA(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucType_SubType |= (UINT_8)TX_DESC_NDPA)
...
#define HAL_MAC_TX_DESC_SET_BMC(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucFrag |= (UINT_8)TX_DESC_BROADCAST_MULTICAST)
...
#define HAL_MAC_TX_DESC_SET_HTC_EXIST(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucFrag |= (UINT_8)TX_DESC_HTC_EXISTS)
...
#define HAL_MAC_TX_DESC_GET_FRAG_PACKET_POS(_prHwMacTxDesc) \
	...
	((UINT_8)TX_DESC_FRAGMENT_MASK), TX_DESC_FRAGMENT_OFFSET)
...
#define HAL_MAC_TX_DESC_SET_REMAINING_LIFE_TIME_IN_MS(_prHwMacTxDesc, _u4LifeTimeMs) \
	{ \
		...
		if (u4LifeTimeInUnit >= ((UINT_32)BIT(8U))) { \
			u4LifeTimeInUnit = ((UINT_32)BITS(0U, 7U)); \
		} \
...
{ \
	HAL_MAC_TX_DESC_SET_SEQUENCE_NUMBER(_prHwMacTxDesc, 0U); \
...
{ \
	HAL_MAC_TX_DESC_SET_PN(_prHwMacTxDesc, 0U, 0U); \
...
#define HAL_MAC_TX_DESC_IS_CR_FIXED_RATE_MODE(_prHwMacTxDesc)	\
	(((_prHwMacTxDesc)->ucAntID \
	& ((UINT_8)TX_DESC_FIXED_RATE_MODE))?TRUE:FALSE)
#define HAL_MAC_TX_DESC_SET_FIXED_RATE_MODE_TO_DESC(_prHwMacTxDesc) \
	((_prHwMacTxDesc)->ucAntID \
	&= ~(UINT_8)TX_DESC_FIXED_RATE_MODE)
...
#define HAL_MAC_TX_DESC_SET_FIX_RATE(_BssInfo) \
	(((_BssInfo->u2HwDefaultFixedRateCode << 2U) \
	& ((UINT_16)TX_DESC_FIXDE_RATE_MASK)) << 16U)
...
BOOLEAN nicTxFillMsduInfo(IN P_ADAPTER_T prAdapter,
