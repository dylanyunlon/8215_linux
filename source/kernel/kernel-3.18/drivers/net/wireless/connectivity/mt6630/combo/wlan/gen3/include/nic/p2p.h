...
#define P2P_MAXIMUM_CLIENT_COUNT                    10U
#define P2P_MAXIMUM_NOA_COUNT                       8U
#if (CFG_SUPPORT_SOFTAP_WPA3 == 1)
#define P2P_MAX_AKM_SUITES                          2U
#endif
...
struct _P2P_SPECIFIC_BSS_INFO_T {
	...
	// Autochips Add
	UINT_16 ucDeviceLength;
	UINT_8 ucDeviceElement[ELEM_MAX_LEN_APPLE_ID];
	// Add end
};
