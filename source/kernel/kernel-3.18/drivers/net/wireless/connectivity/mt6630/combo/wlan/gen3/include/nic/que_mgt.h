...
#define QM_INIT_TIME_TO_UPDATE_QUE_LEN  60U
#define QM_INIT_TIME_TO_ADJUST_TC_RSC   3U
/* Factor for Que Len averaging */
#define QM_QUE_LEN_MOVING_AVE_FACTOR    3U

#define QM_MIN_RESERVED_TC0_RESOURCE    0U
#define QM_MIN_RESERVED_TC1_RESOURCE    1U
#define QM_MIN_RESERVED_TC2_RESOURCE    0U
#define QM_MIN_RESERVED_TC3_RESOURCE    0U
/* Resource for TC4 is not adjustable */
#define QM_MIN_RESERVED_TC4_RESOURCE    2U
#define QM_MIN_RESERVED_TC5_RESOURCE    0U

#define QM_GUARANTEED_TC0_RESOURCE      4U
#define QM_GUARANTEED_TC1_RESOURCE      4U
#define QM_GUARANTEED_TC2_RESOURCE      9U
#define QM_GUARANTEED_TC3_RESOURCE      11U
/* Resource for TC4 is not adjustable */
#define QM_GUARANTEED_TC4_RESOURCE      2U
#define QM_GUARANTEED_TC5_RESOURCE      4U

#define QM_EXTRA_RESERVED_RESOURCE_WHEN_BUSY    0U
...
#define NUM_OF_PER_STA_TX_QUEUES    6U
...
/* Per-STA */
#define TX_QUEUE_INDEX_AC0          0U
#define TX_QUEUE_INDEX_AC1          1U
#define TX_QUEUE_INDEX_AC2          2U
#define TX_QUEUE_INDEX_AC3          3U
#define TX_QUEUE_INDEX_MGMT         4U
#define TX_QUEUE_INDEX_NON_QOS      5U

#define QM_DEFAULT_USER_PRIORITY    0

#define QM_STA_FORWARD_COUNT_UNLIMITED      (0xFFFFFFFFU)
 ...
 *
 *  Indeed, even if network subqueue is not stopped when no MSDU resource,
 *  the new arriving skb will be queued in prGlueInfo->rTxQueue and not
 *  be dropped.
 */
#define QM_FWD_PKT_QUE_HIGH_THRESHOLD  \
	(CFG_TX_MAX_PKT_NUM - CFG_TX_STOP_NETIF_PER_QUEUE_THRESHOLD)

/* Pending Forwarding Frame Threshold for Low Priority Packet (BE/BK)
 *
 *   For TGn AP 4.2.25 STEP 6, 11n STA transmits RTP1_BE and RTP2_VI
 *   streams to legacy STA, the bandwidth is full and large amounts of
 *   forwarding packets are pending in driver, we shoulddrop the packet
 *   by priority, retain VI as much as possible.
 */
...
/* 1 WMM-related */
/* WMM FLAGS */
#define WMM_FLAG_SUPPORT_WMM                BIT(0U)
#define WMM_FLAG_SUPPORT_WMMSA              BIT(1U)
#define WMM_FLAG_AC_PARAM_PRESENT           BIT(2U)
#define WMM_FLAG_SUPPORT_UAPSD              BIT(3U)

/* WMM Admission Control Mandatory FLAGS */
#define ACM_FLAG_ADM_NOT_REQUIRED           0
#define ACM_FLAG_ADM_GRANTED                BIT(0U)
#define ACM_FLAG_ADM_REQUIRED               BIT(1U)

/* WMM Power Saving FLAGS */
#define AC_FLAG_TRIGGER_ENABLED             BIT(1U)
#define AC_FLAG_DELIVERY_ENABLED            BIT(2U)
...
// Autochips Add
#define ELEM_MAX_LEN_APPLE_DEVICE           48
// Add end

/* WMM-2.2.1 WMM QoS Info field */
#define WMM_QOS_INFO_PARAM_SET_CNT          BITS(0U, 3U)	/* Sent by AP */
#define WMM_QOS_INFO_UAPSD                  BIT(7U)

#define WMM_QOS_INFO_VO_UAPSD               BIT(0U)	/* Sent by non-AP STA */
#define WMM_QOS_INFO_VI_UAPSD               BIT(1U)
#define WMM_QOS_INFO_BK_UAPSD               BIT(2U)
#define WMM_QOS_INFO_BE_UAPSD               BIT(3U)
#define WMM_QOS_INFO_MAX_SP_LEN_MASK        BITS(5U, 6U)
#define WMM_QOS_INFO_MAX_SP_ALL             0
#define WMM_QOS_INFO_MAX_SP_2               BIT(5U)
#define WMM_QOS_INFO_MAX_SP_4               BIT(6U)
#define WMM_QOS_INFO_MAX_SP_6               BITS(5U, 6U)
...
#define WMM_ACIAIFSN_AIFSN                  BITS(0U, 3U)
#define WMM_ACIAIFSN_ACM                    BIT(4U)
#define WMM_ACIAIFSN_ACI                    BITS(5U, 6U)
#define WMM_ACIAIFSN_ACI_OFFSET             5

/* -- definitions for ACI field */
#define WMM_ACI_AC_BE                       0
#define WMM_ACI_AC_BK                       BIT(5U)
#define WMM_ACI_AC_VI                       BIT(6U)
#define WMM_ACI_AC_VO                       BITS(5U, 6U)

#define WMM_ACI(_AC)                        (_AC << WMM_ACIAIFSN_ACI_OFFSET)

/* -- definitions for ECWmin/ECWmax field */
#define WMM_ECW_WMIN_MASK                   BITS(0U, 3U)
#define WMM_ECW_WMAX_MASK                   BITS(4U, 7U)
#define WMM_ECW_WMAX_OFFSET                 4U

#define TXM_DEFAULT_FLUSH_QUEUE_GUARD_TIME              0	/* Unit: 64 us */

#define QM_RX_BA_ENTRY_MISS_TIMEOUT_MS      (200U)
#if CFG_RX_BA_REORDERING_ENHANCEMENT
#define QM_RX_MAX_FW_DROP_SSN_SIZE	8U
#define QM_SSN_MASK	0xFFF0U
#endif

#if CFG_M0VE_BA_TO_DRIVER
/* MQM internal control bitmap per-bit usage (for operations on g_prMqm->u4FlagBitmap) */
#define MQM_FLAG_TSPEC_NEGO_ADD_IN_PROGRESS 0U
#define MQM_FLAG_IDLE_TX_BA_TIMER_STARTED   1U
#define MQM_FLAG_IDLE_RX_BA_TIMER_STARTED   2U

#define MQM_IDLE_RX_BA_DETECTION			0U
#define MQM_IDLE_RX_BA_CHECK_INTERVAL       5000U	/* in msec */
#define MQM_DEL_IDLE_RXBA_THRESHOLD_BK      6U
#define MQM_DEL_IDLE_RXBA_THRESHOLD_BE      12U
#define MQM_DEL_IDLE_RXBA_THRESHOLD_VI      6U
#define MQM_DEL_IDLE_RXBA_THRESHOLD_VO      6U
...
#define QM_GET_PREVIOUS_SSN(_u2CurrSSN) \
	((UINT_16) ((_u2CurrSSN) == 0U \
	? (MAX_SEQ_NO_COUNT - 1U) : ((_u2CurrSSN) - 1U)))
...
BOOLEAN qmAmsduAttackDetection(IN P_ADAPTER_T prAdapter,
...
#endif
extern const ENUM_WMM_ACI_T aucTid2ACI[TX_DESC_TID_NUM];
