...
#define TX_MODE_CCK             0x00U
#define TX_MODE_OFDM            0x40U
#define TX_MODE_HT_MM           0x80U
#define TX_MODE_HT_GF           0xC0U
#define TX_MODE_VHT             0x100U

#define RATE_CCK_SHORT_PREAMBLE 0x4U

#define PHY_RATE_1M             0x0U
#define PHY_RATE_2M             0x1U
#define PHY_RATE_5_5M           0x2U
#define PHY_RATE_11M            0x3U
#define PHY_RATE_6M             0xBU
#define PHY_RATE_9M             0xFU
#define PHY_RATE_12M            0xAU
#define PHY_RATE_18M            0xEU
#define PHY_RATE_24M            0x9U
#define PHY_RATE_36M            0xDU
#define PHY_RATE_48M            0x8U
#define PHY_RATE_54M            0xCU

#define PHY_RATE_MCS0           0x0U
#define PHY_RATE_MCS1           0x1U
#define PHY_RATE_MCS2           0x2U
#define PHY_RATE_MCS3           0x3U
#define PHY_RATE_MCS4           0x4U
#define PHY_RATE_MCS5           0x5U
#define PHY_RATE_MCS6           0x6U
#define PHY_RATE_MCS7           0x7U
#define PHY_RATE_MCS8           0x8U
#define PHY_RATE_MCS9           0x9U
#define PHY_RATE_MCS32          0x20U
...
#define RATE_NSTS_MASK	BITS(9U, 10U)
#define RATE_NSTS_OFFSET	9U
#define RATE_TX_MODE_MASK                           BITS(6U, 8U)
#define RATE_TX_MODE_OFFSET                         6U
#define RATE_CODE_GET_TX_MODE(_ucRateCode)          ((_ucRateCode & RATE_TX_MODE_MASK) >> RATE_TX_MODE_OFFSET)
#define RATE_PHY_RATE_MASK                          BITS(0U, 5U)
#define RATE_PHY_RATE_OFFSET                        0U
#define RATE_CODE_GET_PHY_RATE(_ucRateCode) \
	(((_ucRateCode) & (UINT_16)RATE_PHY_RATE_MASK) >> RATE_PHY_RATE_OFFSET)
#define RATE_PHY_RATE_SHORT_PREAMBLE                BIT(2U)
#define RATE_CODE_IS_SHORT_PREAMBLE(_ucRateCode)    ((_ucRateCode & RATE_PHY_RATE_SHORT_PREAMBLE) ? TRUE : FALSE)

#define CHNL_LIST_SZ_2G         14U
#define CHNL_LIST_SZ_5G         14U

/*! CNM(STA_RECORD_T) related definition */
#define CFG_STA_REC_NUM         27U

/* PHY TYPE bit definitions */
/* HR/DSSS PHY (clause 18) BIT(PHY_TYPE_HR_DSSS_INDEX) */
#define PHY_TYPE_BIT_HR_DSSS    BIT(0U)
/* ERP PHY (clause 19)BIT(PHY_TYPE_ERP_INDEX) */
#define PHY_TYPE_BIT_ERP        BIT(1U)
/* OFDM 5 GHz PHY (clause 17) BIT(PHY_TYPE_OFDM_INDEX) */
#define PHY_TYPE_BIT_OFDM       BIT(3U)
/* HT PHY (clause 20) BIT(PHY_TYPE_HT_INDEX) */
#define PHY_TYPE_BIT_HT         BIT(4U)
/* HT PHY (clause 22)BIT(PHY_TYPE_VHT_INDEX) */
#define PHY_TYPE_BIT_VHT        BIT(5U)
...
/* Bit 0: 1M */
#define RATE_SET_BIT_1M         BIT((UINT_8)RATE_1M_SW_INDEX)
/* Bit 1: 2M */
#define RATE_SET_BIT_2M         BIT((UINT_8)RATE_2M_SW_INDEX)
/* Bit 2: 5.5M */
#define RATE_SET_BIT_5_5M       BIT((UINT_8)RATE_5_5M_SW_INDEX)
/* Bit 3: 11M */
#define RATE_SET_BIT_11M        BIT((UINT_8)RATE_11M_SW_INDEX)
/* Bit 4: 22M */
#define RATE_SET_BIT_22M        BIT((UINT_8)RATE_22M_SW_INDEX)
/* Bit 5: 33M */
#define RATE_SET_BIT_33M        BIT((UINT_8)RATE_33M_SW_INDEX)
/* Bit 6: 6M */
#define RATE_SET_BIT_6M         BIT((UINT_8)RATE_6M_SW_INDEX)
/* Bit 7: 9M */
#define RATE_SET_BIT_9M         BIT((UINT_8)RATE_9M_SW_INDEX)
/* Bit 8: 12M */
#define RATE_SET_BIT_12M        BIT((UINT_8)RATE_12M_SW_INDEX)
/* Bit 9: 18M */
#define RATE_SET_BIT_18M        BIT((UINT_8)RATE_18M_SW_INDEX)
/* Bit 10: 24M */
#define RATE_SET_BIT_24M        BIT((UINT_8)RATE_24M_SW_INDEX)
/* Bit 11: 36M */
#define RATE_SET_BIT_36M        BIT((UINT_8)RATE_36M_SW_INDEX)
/* Bit 12: 48M */
#define RATE_SET_BIT_48M        BIT((UINT_8)RATE_48M_SW_INDEX)
/* Bit 13: 54M */
#define RATE_SET_BIT_54M        BIT((UINT_8)RATE_54M_SW_INDEX)
/* Bit 14: BSS Selector */
#define RATE_SET_BIT_HT_PHY     BIT((UINT_8)RATE_HT_PHY_SW_INDEX)
...
// Autochips modify it from 2 to 5
#define TX_AUTH_ASSOCI_RETRY_LIMIT                  5
...
typedef enum _ENUM_STA_TYPE_INDEX_T {
	...
	STA_TYPE_P2P_INDEX = 1,
	STA_TYPE_BOW_INDEX = 2,
	STA_TYPE_INDEX_NUM = 3
...
#define STA_TYPE_LEGACY_MASK                BIT(0U)
#define STA_TYPE_P2P_MASK                   BIT(1U)
#define STA_TYPE_BOW_MASK                   BIT(2U)
#define STA_TYPE_ADHOC_MASK                 BIT(4U)
#define STA_TYPE_CLIENT_MASK                BIT(5U)
#define STA_TYPE_AP_MASK                    BIT(6U)
#define STA_TYPE_DLS_MASK                   BIT(7U)
...
#define IS_STA_LEGACY_TYPE(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8)STA_TYPE_LEGACY_MASK) != 0U)
#define IS_STA_P2P_TYPE(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8)STA_TYPE_P2P_MASK) != 0U)
#define IS_STA_BOW_TYPE(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8) STA_TYPE_BOW_MASK) != 0U)
#define IS_ADHOC_STA(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8)STA_TYPE_ADHOC_MASK) != 0U)
#define IS_CLIENT_STA(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8)STA_TYPE_CLIENT_MASK) != 0U)
#define IS_AP_STA(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8)STA_TYPE_AP_MASK) != 0U)
#define IS_DLS_STA(_prStaRec) \
	((((UINT_8)(_prStaRec)->eStaType) & (UINT_8)STA_TYPE_DLS_MASK) != 0U)
...
#define MAX_NUM_SUPPORTED_CIPHER_SUITES 8U
#if CFG_SUPPORT_802_11W
#if (CFG_SUPPORT_WPA3 == 1)
#define MAX_NUM_SUPPORTED_AKM_SUITES    10U	/* max number of supported AKM suites */
#else
/* max number of supported AKM suites */
#define MAX_NUM_SUPPORTED_AKM_SUITES    8U
#endif
#else
/* max number of supported AKM suites */
#define MAX_NUM_SUPPORTED_AKM_SUITES    6U
#endif
...
/* max number of supported AKM suites */
#define MAX_NUM_SUPPORTED_WAPI_AKM_SUITES    1U
/* max number of supported cipher suites */
#define MAX_NUM_SUPPORTED_WAPI_CIPHER_SUITES 1U
...
#define WLAN_GET_FIELD_BE16(_memAddr_p, _value_p) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		*(PUINT_16)(_value_p) = ((UINT_16)__cp[0] << 8U) \
			| ((UINT_16)__cp[1]); \
	}
...
#define WLAN_GET_FIELD_BE24(_memAddr_p, _value_p) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		*(PUINT_32)(_value_p) = ((UINT_32)__cp[0] << 16U) \
			| ((UINT_32)__cp[1] << 8U) \
			| ((UINT_32)__cp[2]); \
	}
...
#define WLAN_GET_FIELD_BE32(_memAddr_p, _value_p) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		*(PUINT_32)(_value_p) = ((UINT_32)__cp[0] << 24U) \
			| ((UINT_32)__cp[1] << 16U) \
			| ((UINT_32)__cp[2] << 8U) \
			| ((UINT_32)__cp[3]); \
	}
...
#define WLAN_SET_FIELD_16(_memAddr_p, _value) \
	{ \
		...
		__cp[1] = (UINT_8)((UINT_32)(_value) >> 8U); \
	}

#define WLAN_SET_FIELD_BE16(_memAddr_p, _value) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		__cp[0] = (UINT_8)((UINT_32)(_value) >> 8U); \
...
#define WLAN_SET_FIELD_32(_memAddr_p, _value) \
	{ \
		...
		__cp[0] = (UINT_8)(_value); \
		__cp[1] = (UINT_8)((UINT_32)(_value) >> 8U); \
		__cp[2] = (UINT_8)((UINT_32)(_value) >> 16U); \
		__cp[3] = (UINT_8)((UINT_32)(_value) >> 24U); \
	}

#define WLAN_SET_FIELD_BE24(_memAddr_p, _value) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		__cp[0] = (UINT_8)((UINT_32)(_value) >> 16U); \
		__cp[1] = (UINT_8)((UINT_32)(_value) >> 8U); \
...
#define WLAN_SET_FIELD_BE32(_memAddr_p, _value) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		__cp[0] = (UINT_8)((_value) >> 24U); \
		__cp[1] = (UINT_8)((_value) >> 16U); \
		__cp[2] = (UINT_8)((_value) >> 8U); \
