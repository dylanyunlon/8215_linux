...
#define MAX_IE_LENGTH       (600U)
#define MAX_WSC_IE_LENGTH   (400U)
...
#define BEACON_TIMEOUT_DUE_2_NO_TX_DONE_EVENT 0x8U
...
#define NLO_CHANNEL_TYPE_SPECIFIED	0U
#define NLO_CHANNEL_TYPE_DUAL_BAND	1U
#define NLO_CHANNEL_TYPE_2G4_ONLY	2U
#define NLO_CHANNEL_TYPE_5G_ONLY	3U
...
typedef struct _CMD_802_11_KEY {
	...
	UINT_8 ucKeyLen;
	UINT_8 ucWlanIndex;
#if CFG_SUPPORT_802_11W || (CFG_SUPPORT_SOFTAP_WPA3 == 1)
