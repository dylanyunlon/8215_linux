...
********************************************************************************
*/
#define BOWCMD_STATUS_SUCCESS       0U
#define BOWCMD_STATUS_FAILURE       1U
#define BOWCMD_STATUS_UNACCEPTED    2U
#define BOWCMD_STATUS_INVALID       3U
#define BOWCMD_STATUS_TIMEOUT       4U

#define BOW_WILDCARD_SSID               "AMP"
#define BOW_WILDCARD_SSID_LEN       3U
#define BOW_SSID_LEN                            21U

 /* 0: query, 1: setup, 2: destroy */
#define BOW_QUERY_CMD                   0U
#define BOW_SETUP_CMD                   1U
#define BOW_DESTROY_CMD               2U

#define BOW_INITIATOR                   0U
#define BOW_RESPONDER                  1U
