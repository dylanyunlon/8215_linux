...
#define MAX_NUM_GROUP_ADDR       32U

#define TX_CS_TCP_UDP_GEN        BIT(1U)
#define TX_CS_IP_GEN             BIT(0U)

#define CSUM_OFFLOAD_EN_TX_TCP      BIT(0U)
#define CSUM_OFFLOAD_EN_TX_UDP      BIT(1U)
#define CSUM_OFFLOAD_EN_TX_IP       BIT(2U)
#define CSUM_OFFLOAD_EN_RX_TCP      BIT(3U)
#define CSUM_OFFLOAD_EN_RX_UDP      BIT(4U)
#define CSUM_OFFLOAD_EN_RX_IPv4     BIT(5U)
#define CSUM_OFFLOAD_EN_RX_IPv6     BIT(6U)
#define CSUM_OFFLOAD_EN_TX_MASK     BITS(0U, 2U)
#define CSUM_OFFLOAD_EN_ALL         BITS(0U, 6U)

/* TCP, UDP, IP Checksum */
#define RX_CS_TYPE_UDP           BIT(7U)
#define RX_CS_TYPE_TCP           BIT(6U)
#define RX_CS_TYPE_IPv6          BIT(5U)
#define RX_CS_TYPE_IPv4          BIT(4U)

#define RX_CS_STATUS_UDP         BIT(3U)
#define RX_CS_STATUS_TCP         BIT(2U)
#define RX_CS_STATUS_IP          BIT(0U)

#define CSUM_NOT_SUPPORTED      0x0U

#define TXPWR_USE_PDSLOPE 0

/* NVRAM error code definitions */
#define NVRAM_ERROR_VERSION_MISMATCH        BIT(1U)
#define NVRAM_ERROR_INVALID_TXPWR           BIT(2U)
#define NVRAM_ERROR_INVALID_DPD             BIT(3U)
#define NVRAM_ERROR_INVALID_MAC_ADDR        BIT(4U)
#if CFG_SUPPORT_PWR_LIMIT_COUNTRY
#define NVRAM_POWER_LIMIT_TABLE_INVALID     BIT(5U)
#endif

#define NUM_TC_RESOURCE_TO_STATISTICS       4

#define WLAN_CFG_ARGV_MAX 8
#define WLAN_CFG_ENTRY_NUM_MAX 128U
#define WLAN_CFG_KEY_LEN_MAX 32U	/* include \x00  EOL */
#define WLAN_CFG_VALUE_LEN_MAX 32U	/* include \x00 EOL */
#define WLAN_CFG_FLAG_SKIP_CB BIT(0U)
#define WLAN_CFG_FILE_BUF_SIZE 2048

#define WLAN_CFG_SET_CHIP_LEN_MAX 10U
#define WLAN_CFG_SET_DEBUG_LEVEL_LEN_MAX 10U
#define WLAN_CFG_SET_SW_CTRL_LEN_MAX 10

#define WLAN_OID_TIMEOUT_THRESHOLD 3000	/* OID timeout (in ms) */

#define WLAN_OID_TIMEOUT_THRESHOLD_IN_RESETTING      300	/* OID timeout during chip-resetting  (in ms) */

#define WLAN_OID_NO_ACK_THRESHOLD                   5U
...
#define WLAN_TX_STATS_LOG_TIMEOUT                   30000U
#define WLAN_TX_STATS_LOG_DURATION                  1500U
/*******************************************************************************
*                             D A T A   T Y P E S
********************************************************************************
*/
...
#define DEBUG_MSG_SIZE_MAX 1200U
enum {
...
#define CHIP_CONFIG_RESP_SIZE 320U
enum {
...
#define BUILD_SIGN(ch0, ch1, ch2, ch3) \
	((UINT_32)(UINT_8)(ch0) | ((UINT_32)(UINT_8)(ch1) << 8U) |   \
	((UINT_32)(UINT_8)(ch2) << 16U) | ((UINT_32)(UINT_8)(ch3) << 24U))
...
#define IS_FEATURE_ENABLED(_ucFeature) \
	(((_ucFeature) == (UINT_8)FEATURE_ENABLED) \
	|| ((_ucFeature) == (UINT_8)FEATURE_FORCE_ENABLED))
#define IS_FEATURE_FORCE_ENABLED(_ucFeature) \
	((_ucFeature) == (UINT_8)FEATURE_FORCE_ENABLED)
#define IS_FEATURE_DISABLED(_ucFeature) \
	((_ucFeature) == (UINT_8)FEATURE_DISABLED)
...
wlanQueryInformation(IN P_ADAPTER_T prAdapter,
		...
		IN PVOID pvInfoBuf, IN UINT_32 u4InfoBufLen,
...
BOOLEAN wlanTxLifetimeIsTargetMsdu(IN P_ADAPTER_T prAdapter,
	IN P_MSDU_INFO_T prMsduInfo);
...
wlanCfgParseAddEntry(IN P_ADAPTER_T prAdapter,
	PUINT_8 pucKeyHead, PUINT_8 pucKeyTail,
	PUINT_8 pucValueHead, PUINT_8 pucValueTail);
...
WLAN_STATUS wlanCfgParse(IN P_ADAPTER_T prAdapter,
	PUINT_8 pucConfigBuf, UINT_32 u4ConfigBufLen);

WLAN_STATUS wlanQueryNicCapability(IN P_ADAPTER_T prAdapter);

extern INT_32 wlanUpdateDfsChannelTable(P_GLUE_INFO_T prGlueInfo,
					UINT_8 ucCurrChNo);
