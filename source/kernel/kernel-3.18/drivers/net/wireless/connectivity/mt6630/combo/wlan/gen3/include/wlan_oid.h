...
#define PARAM_MAX_LEN_RATES                     8U
#define PARAM_MAX_LEN_RATES_EX                  16

#define PARAM_AUTH_REQUEST_REAUTH               0x01
#define PARAM_AUTH_REQUEST_KEYUPDATE            0x02
#define PARAM_AUTH_REQUEST_PAIRWISE_ERROR       0x06U
#define PARAM_AUTH_REQUEST_GROUP_ERROR          0x0EU
...
#define PARAM_PACKET_FILTER_DIRECTED            0x00000001U
#define PARAM_PACKET_FILTER_MULTICAST           0x00000002U
#define PARAM_PACKET_FILTER_ALL_MULTICAST       0x00000004U
#define PARAM_PACKET_FILTER_BROADCAST           0x00000008U
#define PARAM_PACKET_FILTER_PROMISCUOUS         0x00000020U
#define PARAM_PACKET_FILTER_ALL_LOCAL           0x00000080U
#if CFG_ENABLE_WIFI_DIRECT_CFG_80211
#if (CFG_SUPPORT_SOFTAP_WPA3 == 0)
#define PARAM_PACKET_FILTER_P2P_MASK             0xC0000000U
#else
#define PARAM_PACKET_FILTER_P2P_MASK            0xF0000000U
#define PARAM_PACKET_FILTER_AUTH                0x20000000
#define PARAM_PACKET_FILTER_ASSOC_REQ           0x10000000
#endif
#define PARAM_PACKET_FILTER_PROBE_REQ           0x80000000U
#define PARAM_PACKET_FILTER_ACTION_FRAME      0x40000000U
#endif
...
#define MU_CMD_NEED_TO_RESPONSE(u4MuCmdId) \
	(u4MuCmdId == (UINT_32)MU_GET_CALC_INIT_MCS || \
	u4MuCmdId == (UINT_32)MU_HQA_GET_QD || \
	u4MuCmdId == (UINT_32)MU_HQA_GET_CALC_LQ)
...
#define PARAM_PROTOCOL_ID_DEFAULT       0x00U
#define PARAM_PROTOCOL_ID_TCP_IP        0x02U
#define PARAM_PROTOCOL_ID_IPX           0x06U
#define PARAM_PROTOCOL_ID_NBF           0x07U
#define PARAM_PROTOCOL_ID_MAX           0x0FU
#define PARAM_PROTOCOL_ID_MASK          0x0FU
...
WLAN_STATUS
wlanoidFlushPmkid(IN P_ADAPTER_T prAdapter, IN PVOID pvSetBuffer, IN UINT_32 u4SetBufferLen,
...
#if (CFG_SUPPORT_WPA3 == 1)
uint32_t
wlanoidExternalAuthDone(IN struct _ADAPTER_T *prAdapter, IN void *pvSetBuffer, IN UINT_32 u4SetBufferLen,
