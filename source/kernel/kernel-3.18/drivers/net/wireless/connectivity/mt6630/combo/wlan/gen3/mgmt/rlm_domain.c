...
static DOMAIN_INFO_ENTRY arSupportedRegDomain[] = {
	{
	 (PUINT_16) g_u2CountryGroup0,
	 (UINT_32)sizeof(g_u2CountryGroup0) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	  ,			/* CH_SET_UNII_LOW_NA */
	  {118U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	  ,			/* CH_SET_UNII_MID_NA */
	  {121U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	  ,			/* CH_SET_UNII_WW_NA */
	  {125U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	  ,			/* CH_SET_UNII_UPPER_NA */
	  {0U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	 }
	}
	,
	{
	 (PUINT_16) g_u2CountryGroup1,
	 (UINT_32)sizeof(g_u2CountryGroup1) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 11U, 0U}
	  ,			/* CH_SET_2G4_1_11 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	  ,			/* CH_SET_UNII_LOW_36_48 */
	  {118U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 52U, 4U, 1U}
	  ,			/* CH_SET_UNII_MID_52_64 */
	  {121U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 100U, 12U, 1U}
	  ,			/* CH_SET_UNII_WW_100_144 */
	  {125U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 149U, 5U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup2) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup3) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	  ...
	  {121U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 100U, 12U, 1U}
	  ,			/* CH_SET_UNII_WW_100_144 */
	  {125U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 149U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup4) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup5) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	  ...
	  {118U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 52U, 4U, 1U}
	  ,			/* CH_SET_UNII_MID_52_64 */
	  {121U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 100U, 11U, 1U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup6) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {82U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 14U, 1U, 0U}
	  ,			/* CH_SET_2G4_14_14 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	  ,			/* CH_SET_UNII_LOW_36_48 */
	  {118U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 52U, 4U, 1U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup7) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup8) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	  ...
	  {118U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 52U, 4U, 1U}
	  ,			/* CH_SET_UNII_MID_52_64 */
	  {121U, (UINT_8)BAND_NULL, 0, 0, 0, 0U}
	  ,			/* CH_SET_UNII_WW_NA */
	  {125U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 149U, 4U, 0U}
	  ,			/* CH_SET_UNII_UPPER_149_161 */
	  {0U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup9) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup10) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup11) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup12) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup13) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup14) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_NULL, 0U, 0U, 0U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup15) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 1U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup16) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 11U, 0U}
	  ,			/* CH_SET_2G4_1_11 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup17) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 11U, 0U}
	  ,			/* CH_SET_2G4_1_11 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup18) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 11U, 0U}
	  ,			/* CH_SET_2G4_1_11 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	  ...
	  {118U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 52U, 4U, 1U}
	  ,			/* CH_SET_UNII_MID_52_64 */
	  {121U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 100U, 5U, 1U}
	  ,			/* CH_SET_UNII_WW_100_116 */
	  {121U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 132U, 4U, 1U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup19) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
	...
	,
	{
	 ...
	 (UINT_32)sizeof(g_u2CountryGroup20) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 13U, 0U}
	  ,			/* CH_SET_2G4_1_13 */
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 4U, 0U}
...
static DOMAIN_INFO_ENTRY arSupportedRegDomain_Passive[] = {
	{
	 (PUINT_16) g_u2CountryGroup0_Passive,
	 (UINT_32)sizeof(g_u2CountryGroup0_Passive) / 2U,
	 {
	  {81U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 1U, 0U, 0U}
	  ,			/* CH_SET_2G4_1_14_NA */
	  {82U, (UINT_8)BAND_2G4, (UINT_8)CHNL_SPAN_5, 14U, 0U, 0U}
	  ,
	  {115U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 36U, 0U, 0U}
	  ,			/* CH_SET_UNII_LOW_NA */
	  {118U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 52U, 4U, 1U}
	  ,			/* CH_SET_UNII_MID_52_64 */
	  {121U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 100U, 11U, 1U}
	  ,			/* CH_SET_UNII_WW_100_140 */
	  {125U, (UINT_8)BAND_5G, (UINT_8)CHNL_SPAN_20, 149U, 0U, 0U}
	  ,			/* CH_SET_UNII_UPPER_NA */
	 }
	}
	,
...
static SUBBAND_CHANNEL_T g_rRlmSubBands[] = {
...
#define REG_DOMAIN_GROUP_NUM  \
	(sizeof(arSupportedRegDomain) / sizeof(DOMAIN_INFO_ENTRY))
	...
	*/
	if (prRegInfo->eRegChannelListMap == REG_CH_MAP_TBL_IDX &&
	    prRegInfo->ucRegChannelListIndex < (UINT_8)REG_DOMAIN_GROUP_NUM) {
		/* by given table idx */
		DBGLOG(RLM, TRACE, "ucRegChannelListIndex=%d\n", prRegInfo->ucRegChannelListIndex);
		prDomainInfo =
			&arSupportedRegDomain[prRegInfo->ucRegChannelListIndex];
		...
		for (i = 0U; i < (UINT_16)REG_DOMAIN_GROUP_NUM; i++) {
			prDomainInfo = &arSupportedRegDomain[i];

			if ((prDomainInfo->u4CountryNum > 0U &&
				prDomainInfo->pu2CountryGroup != NULL) ||
			    prDomainInfo->u4CountryNum == 0U) {
				for (j = 0U;
			  ...
			  UINT_8 ucMaxChannelNum, PUINT_8 pucNumOfChannel, P_RF_CHANNEL_INFO_T paucChannelList)
{
	...
	ucNum = 0U;
	for (i = 0U; i < MAX_SUBBAND_NUM; i++) {
		prSubband = &prDomainInfo->rSubBand[i];

		if ((prSubband->ucBand == (UINT_8)BAND_NULL) ||
			(prSubband->ucBand >= (UINT_8)BAND_NUM) ||
		    ((prSubband->ucBand == (UINT_8)BAND_5G) &&
		...
		if ((eSpecificBand == BAND_NULL) ||
			(prSubband->ucBand == (UINT_8)eSpecificBand)) {
			for (j = 0U; j < prSubband->ucNumChannels; j++) {
				if (ucNum >= ucMaxChannelNum)
					break;
				paucChannelList[ucNum].eDFS = prSubband->fgDfs;
				paucChannelList[ucNum].eBand =
					(ENUM_BAND_T)prSubband->ucBand;
			  ...
			  UINT_8 ucMaxChannelNum, PUINT_8 pucNumOfChannel, P_RF_CHANNEL_INFO_T paucChannelList)
{
	...
	for (i = 0U; i < MAX_SUBBAND_NUM; i++) {
		...
		if (prSubband->ucBand == (UINT_8)BAND_5G) {
...
VOID rlmDomainSendDomainInfoCmd(P_ADAPTER_T prAdapter)
{
	...
	prCmd = cnmMemAlloc(prAdapter, RAM_TYPE_BUF,
			(UINT_32)sizeof(CMD_SET_DOMAIN_INFO_T));
	if (prCmd == NULL) {
	...
	prCmd->aucReserved[0] = 0U;
	prCmd->aucReserved[1] = 0U;
	...
	wlanSendSetQueryCmd(prAdapter, /* prAdapter */
			    (UINT_8)CMD_ID_SET_DOMAIN_INFO, /* ucCID */
			    TRUE,  /* fgSetQuery */
			    FALSE, /* fgNeedResp */
			    FALSE, /* fgIsOid */
...
#define REG_DOMAIN_PASSIVE_GROUP_NUM \
	(sizeof(arSupportedRegDomain_Passive) / sizeof(DOMAIN_INFO_ENTRY))
	...
	for (i = 0U; i < (UINT_8)REG_DOMAIN_PASSIVE_GROUP_NUM; i++) {
		prDomainInfo = &arSupportedRegDomain_Passive[i];

		for (j = 0U; j < prDomainInfo->u4CountryNum; j++) {
			if (prDomainInfo->pu2CountryGroup[j] == u2TargetCountryCode)
				break;
		}
		if (j < prDomainInfo->u4CountryNum)
	...
	if (i >= (UINT_8)REG_DOMAIN_PASSIVE_GROUP_NUM)
		prDomainInfo =
		&arSupportedRegDomain_Passive[REG_DOMAIN_PASSIVE_DEF_IDX];
...
BOOLEAN rlmDomainIsLegalChannel(P_ADAPTER_T prAdapter, ENUM_BAND_T eBand, UINT_8 ucChannel)
{
	...
	for (i = 0U; i < MAX_SUBBAND_NUM; i++) {
		...
		if (prSubband->ucBand == (UINT_8)eBand) {
			for (j = 0U; j < prSubband->ucNumChannels; j++) {
...
UINT_32 rlmDomainSupOperatingClassIeFill(PUINT_8 pBuf)
{
	 ...
	 */
	UINT_32 u4IeLen;
	UINT_8 aucClass[12] = { 0x01U, 0x02U, 0x03U, 0x05U, 0x16U,
		0x17U, 0x19U, 0x1bU, 0x1cU, 0x1eU, 0x20U, 0x21U };
	...
	SUP_OPERATING_CLASS_IE(pBuf)->ucLength = (UINT_8)sizeof(aucClass) + 1U;
	SUP_OPERATING_CLASS_IE(pBuf)->ucCur = 0x0cU;	/* 0x51 */
	kalMemCopy(SUP_OPERATING_CLASS_IE(pBuf)->ucSup, aucClass, sizeof(aucClass));
	u4IeLen = (UINT_32)SUP_OPERATING_CLASS_IE(pBuf)->ucLength + 2U;
	pBuf += u4IeLen;

	COUNTRY_IE(pBuf)->ucId = ELEM_ID_COUNTRY_INFO;
	COUNTRY_IE(pBuf)->ucLength = 6U;
	COUNTRY_IE(pBuf)->aucCountryStr[0] = 0x55U;
	COUNTRY_IE(pBuf)->aucCountryStr[1] = 0x53U;
	COUNTRY_IE(pBuf)->aucCountryStr[2] = 0x20U;
	COUNTRY_IE(pBuf)->arCountryStr[0].ucFirstChnlNum = 1U;
	COUNTRY_IE(pBuf)->arCountryStr[0].ucNumOfChnl = 11U;
	COUNTRY_IE(pBuf)->arCountryStr[0].cMaxTxPwrLv = 0x1e;
	u4IeLen += (UINT_32)COUNTRY_IE(pBuf)->ucLength + 2U;
...
BOOLEAN rlmDomainCheckChannelEntryValid(P_ADAPTER_T prAdapter, UINT_8 ucCentralCh)
{
	...
	for (i = (UINT_8)POWER_LIMIT_2G4;
		i < (UINT_8)POWER_LIMIT_SUBAND_NUM; i++) {
		if ((ucCentralCh >= g_rRlmSubBands[i].ucStartCh) &&
			(ucCentralCh <= g_rRlmSubBands[i].ucEndCh))
			ucTemp = (ucCentralCh - g_rRlmSubBands[i].ucStartCh) %
				g_rRlmSubBands[i].ucInterval;
	}
...
UINT_8 rlmDomainGetCenterChannel(ENUM_BAND_T eBand, UINT_8 ucPriChannel, ENUM_CHNL_EXT_T eExtend)
{
	...
	if (eExtend == CHNL_EXT_SCA)
		ucCenterChannel = ucPriChannel + 2U;
			  ...
			  ENUM_CHANNEL_WIDTH_T eChannelWidth, UINT_8 ucChannelS1, UINT_8 ucChannelS2)
{
	...
	if (eChannelWidth == CW_20_40MHZ) {
		...
		switch (eExtend) {
		case CHNL_EXT_SCA:
			ucUpperChannel = ucPriChannel + 4U;
			ucLowerChannel = ucPriChannel;
			break;
		case CHNL_EXT_SCB:
			ucUpperChannel = ucPriChannel;
			ucLowerChannel = ucPriChannel - 4U;
			break;
		default:
			ucUpperChannel = ucPriChannel;
			ucLowerChannel = ucPriChannel;
...
rlmDomainCheckPowerLimitValid(P_ADAPTER_T prAdapter,
			      COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION rTblCfg,
			      UINT_8 ucPwrLimitNum)
{
	...
	for (i = 0U; i < ucPwrLimitNum; i++) {
		if (i < (UINT_8)PWR_LIMIT_NUM) {
			prPwrLimit = &rTblCfg.aucPwrLimit[i];
			if ((*prPwrLimit > MAX_TX_POWER) ||
				(*prPwrLimit < MIN_TX_POWER)) {
				return FALSE;
			}
		} else {
			DBGLOG(RLM, WARN, "Wrong Limit Number!!!\n");
			break;
		}
	}
	return fgValid;
...
{
	UINT_8 i, j, cfgTblSize, defTblSize;
	...
	for (i = 0U; i < cfgTblSize; i++) {
		...
		/*Power Limit Check */
		fgPowerLimitValid = rlmDomainCheckPowerLimitValid(prAdapter,
					g_rRlmPowerLimitConfiguration[i],
					(UINT_8)PWR_LIMIT_NUM);
...
UINT_16 rlmDomainPwrLimitDefaultTableDecision(P_ADAPTER_T prAdapter, UINT_16 u2CountryCode)
{
	...
	tblSize = (UINT_16)(sizeof(g_rRlmPowerLimitDefault) /
		sizeof(COUNTRY_POWER_LIMIT_TABLE_DEFAULT));
	/*Default Table Index */
	for (i = 0U; i < tblSize; i++) {
		WLAN_GET_FIELD_BE16(&g_rRlmPowerLimitDefault[i].aucCountryCode[0], &u2CountryCodeTable);

		if (u2CountryCodeTable == u2CountryCode ||
			u2CountryCodeTable == COUNTRY_CODE_NULL) {
			u2TableIndex = i;
...
*/
/*----------------------------------------------------------------------------*/
static VOID rlmDomainBuildCmdByDefaultTable(
	...
	UINT_16 u2DefaultTableIndex)
{
	...
	for (i = (UINT_8)POWER_LIMIT_2G4;
		...
		if (prPwrLimitSubBand->aucPwrLimitSubBand[i] < MAX_TX_POWER) {
			for (k = g_rRlmSubBands[i].ucStartCh;
				k <= g_rRlmSubBands[i].ucEndCh;
			    k += g_rRlmSubBands[i].ucInterval) {
...
*/
/*----------------------------------------------------------------------------*/
static VOID rlmDomainBuildCmdByConfigTable(P_ADAPTER_T prAdapter,
	P_CMD_SET_COUNTRY_CHANNEL_POWER_LIMIT_T prCmd)
{
	UINT_8 i, k, tblSize;
	UINT_16 u2CountryCodeTable = COUNTRY_CODE_NULL;
	...
	tblSize = (UINT_8)(sizeof(g_rRlmPowerLimitConfiguration) /
			sizeof(COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION));
	...
	for (i = 0U; i < tblSize; i++) {
		...
		if (u2CountryCodeTable == COUNTRY_CODE_NULL) {
			...
			if (prCmd->ucNum == 0U) {
				...
				((prCmd->u2CountryCode & 0xff00U) >> 8U),
				(prCmd->u2CountryCode & 0x00ffU),
				prCmdPwrLimit->ucCentralCh,
...
VOID rlmDomainSendPwrLimitCmd(P_ADAPTER_T prAdapter)
{
	...
	u4SetCmdTableMaxSize =
	    (UINT_32)sizeof(CMD_SET_COUNTRY_CHANNEL_POWER_LIMIT_T) +
	    MAX_CMD_SUPPORT_CHANNEL_NUM *
	    (UINT_32)sizeof(CMD_CHANNEL_POWER_LIMIT);
	...
	if (prCmd->ucNum <= MAX_CMD_SUPPORT_CHANNEL_NUM) {
		wlanSendSetQueryCmd(prAdapter, /* prAdapter */
			     (UINT_8)CMD_ID_SET_COUNTRY_POWER_LIMIT, /* ucCID */
			     TRUE,  /* fgSetQuery */
			     FALSE, /* fgNeedResp */
			     FALSE, /* fgIsOid */
			     NULL,  /* pfCmdDoneHandler */
