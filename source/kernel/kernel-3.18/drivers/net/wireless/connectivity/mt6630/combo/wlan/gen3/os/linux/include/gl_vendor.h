...
typedef enum {
	...
	WIFI_SUBCMD_GET_ROAMING_CAPABILITIES,
	WIFI_SUBCMD_SET_ROAMING = 0x0009,
	WIFI_SUBCMD_CONFIG_ROAMING = 0x000a,
	WIFI_SUBCMD_ENABLE_ROAMING
...
#define REPORT_EVENTS_EACH_SCAN        (1U << 0U)
#define REPORT_EVENTS_FULL_RESULTS     (1U << 1U)
#define REPORT_EVENTS_NO_BATCH         (1U << 2U)

#define GSCAN_MAX_REPORT_THRESHOLD   1024000
#define GSCAN_MAX_CHANNELS                 8
#define GSCAN_MAX_BUCKETS                  8U
...
#define PSCAN_MAX_AP_CACHE_PER_SCAN       16U
 ...
 * } while (0)
 */
#define NLA_PUT(_skb, attrtype, attrlen, _data) \
	mtk_cfg80211_NLA_PUT(_skb, attrtype, attrlen, _data)

#define NLA_PUT_TYPE(_skb, type, attrtype, _value) \
	mtk_cfg80211_nla_put_type(_skb, type, attrtype, _value)

#define NLA_PUT_U8(_skb, attrtype, _value) \
	NLA_PUT_TYPE(_skb, NLA_PUT_DATE_U8, attrtype, _value)

#define NLA_PUT_U16(_skb, attrtype, _value) \
	NLA_PUT_TYPE(_skb, NLA_PUT_DATE_U16, attrtype, _value)

#define NLA_PUT_U32(_skb, attrtype, _value) \
	NLA_PUT_TYPE(_skb, NLA_PUT_DATE_U32, attrtype, _value)

#define NLA_PUT_U64(_skb, attrtype, _value) \
	NLA_PUT_TYPE(_skb, NLA_PUT_DATE_U64, attrtype, _value)

#endif

#define NLA_ALIGN_VENDOR(len) \
	(((len) + 4U - 1U) & (~(4U - 1U)))

#define NLA_HDRLEN_VENDOR \
	NLA_ALIGN_VENDOR((UINT_32)sizeof(struct nlattr))
