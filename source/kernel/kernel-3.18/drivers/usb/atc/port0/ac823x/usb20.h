...
#define U2PHYDTM1  (((unsigned long)atc_musb->xceiv->io_priv)+0x800 + 0x6c)
#else
...
#if defined(CONFIG_ATC_FAN5405_SUPPORT) \
|| defined(CONFIG_ATC_BQ24158_SUPPORT) \
|| defined(CONFIG_ATC_NCP1851_SUPPORT) \
|| defined(CONFIG_ATC_BQ24196_SUPPORT) \
|| defined(CONFIG_ATC_BQ24296_SUPPORT) \
|| defined(CONFIG_ATC_NCP1854_SUPPORT)
#define SWITCH_CHARGER 1
#endif

#if defined(CONFIG_ATC_FPGA)
...
extern CHARGER_TYPE ac_charger_type_detection(void);
...
extern int MUC_ResetPhy(void *pBase);
...
/* switch charger API*/
#ifdef CONFIG_ATC_FAN5405_SUPPORT
...
#elif defined(CONFIG_ATC_NCP1851_SUPPORT) || defined(CONFIG_ATC_BQ24196_SUPPORT)
extern void tbl_charger_otg_vbus(kal_uint32 mode);
#elif defined(CONFIG_ATC_BQ24261_SUPPORT)
extern void bq24261_set_en_boost(kal_uint32 val);
#elif defined(CONFIG_ATC_BQ24296_SUPPORT)
...
#elif defined CONFIG_ATC_NCP1854_SUPPORT
...
extern CHARGER_TYPE ac_get_charger_type(void);
