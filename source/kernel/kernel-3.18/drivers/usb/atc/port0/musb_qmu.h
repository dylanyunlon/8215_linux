...
extern void musb_kick_H_CmdQ(struct musb *musb, int is_in, struct musb_qh *qh);
...
extern void musb_g_advance_schedule(struct musb *musb, struct urb *urb, struct musb_hw_ep *hw_ep, int is_in);
