...
void h_usb_phy_poweron(void)
{
}

void h_usb_phy_savecurrent(void)
{
}

void h_usb_phy_recover(void)
{
}

void h_usb_phy_context_save(void)
{
}

void h_usb_phy_context_restore(void)
{
}
