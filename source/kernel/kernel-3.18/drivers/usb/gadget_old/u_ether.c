...
#define ETHER_BUILD_KO
/*
 * Because of strange code ported by songlin, When build g_ther with ko,
 * There are so much errors happened.
 * So the macro is listed for it.
 * u_ether.c is included by ehter.c directly....(ERROR!!)
 * Modified by Joshua @ 28/10/2015.
 */
