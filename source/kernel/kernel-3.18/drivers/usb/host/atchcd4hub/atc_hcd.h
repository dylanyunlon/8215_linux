...
//    #define PHYEP_MAPPING_MULTI_LOCALEP	1
#endif
...
#define SIMULATE_USB_INSERT
#define REPORT_USB_STATE
...
//USB+00A4h USB Level 1 Interrupt Mask Register USB_L1INTM#define MGC_M_HDRC_L1INTM_TX_INT_UNMASK	           (1<<  0)  //Endpoint Tx Interrupt UNMASK#define MGC_M_HDRC_L1INTM_RX_INT_UNMASK	           (1<<  1)  //	Endpoint Rx Interrupt UNMASK#define MGC_M_HDRC_L1INTM_USBCOM_INT_UNMASK	       (1<<  2)  //	USB Common Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DMA_INT_UNMASK	       (1<<  3)  //	DMA Interrupt UNMASK#define MGC_M_HDRC_L1INTM_PSR_INT_UNMASK	       (1<<  4)  //	Packet Sequence Recorder Interrupt UNMASK#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_TX_INT_UNMASK	           (1<<  0)  //Endpoint Tx Interrupt UNMASK#define MGC_M_HDRC_L1INTM_RX_INT_UNMASK	           (1<<  1)  //	Endpoint Rx Interrupt UNMASK#define MGC_M_HDRC_L1INTM_USBCOM_INT_UNMASK	       (1<<  2)  //	USB Common Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DMA_INT_UNMASK	       (1<<  3)  //	DMA Interrupt UNMASK#define MGC_M_HDRC_L1INTM_PSR_INT_UNMASK	       (1<<  4)  //	Packet Sequence Recorder Interrupt UNMASK#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_RX_INT_UNMASK	           (1<<  1)  //	Endpoint Rx Interrupt UNMASK#define MGC_M_HDRC_L1INTM_USBCOM_INT_UNMASK	       (1<<  2)  //	USB Common Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DMA_INT_UNMASK	       (1<<  3)  //	DMA Interrupt UNMASK#define MGC_M_HDRC_L1INTM_PSR_INT_UNMASK	       (1<<  4)  //	Packet Sequence Recorder Interrupt UNMASK#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_USBCOM_INT_UNMASK	       (1<<  2)  //	USB Common Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DMA_INT_UNMASK	       (1<<  3)  //	DMA Interrupt UNMASK#define MGC_M_HDRC_L1INTM_PSR_INT_UNMASK	       (1<<  4)  //	Packet Sequence Recorder Interrupt UNMASK#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_DMA_INT_UNMASK	       (1<<  3)  //	DMA Interrupt UNMASK#define MGC_M_HDRC_L1INTM_PSR_INT_UNMASK	       (1<<  4)  //	Packet Sequence Recorder Interrupt UNMASK#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_PSR_INT_UNMASK	       (1<<  4)  //	Packet Sequence Recorder Interrupt UNMASK#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_QINT_UNMASK	           (1<<  5)  //	USBQ Interrupt UNMASK, only valid while USBQ is available
#define MGC_M_HDRC_L1INTM_QSW_INT_UNMASK	       (1<<  6)  //	USBQ HIF Command Interrupt UNMASK, only valid while WiMAX Q is available.#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_DPDM_INT_UNMASK	       (1<<  7)  //	DPDM Interrupt UNMASK#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_VBUSVALID_INT_UNMASK	   (1<<  8)  //	VBUSVALID Interrupt UNMASK#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
#define MGC_M_HDRC_L1INTM_IDDIG_INT_UNMASK	       (1<<  9)  //	IDDIG Interrupt UNMASK#define MGC_M_HDRC_L1INTM_DRVVBUS_INT_UNMASK	   (1<< 10)  //	DRVVBUS interrupt UNMASK
...
#define MGC_M_RXCSR_H_FLUSHFIFO   0x0010
...
#define MUSB_MAX_ERR_RETRIES         3


#define USB_EVENTS_UNLINK_INVALID_URB (0x1<<0)
#define USB_EVENTS_CHECK_CONNECT      (0x1<<1)
#define USB_EVENTS_RESET_OFF          (0x1<<2)
#define USB_RESUME_CHECK_STATUS		  (1<<3)
...
typedef struct
{
    ...
    uint8_t bIsOccupy;  
    uint8_t bUseTxRxFifo;
//add for queue mode
    uint8_t used_num;
    void* regs;
    uint8_t ep_q_configed;
    uint8_t ep_q_used;
...
extern int MGC_DequeueEndurb(MGC_LinuxLocalEnd * pEnd, struct urb *pUrb);

extern void MGC_CallbackUrb(MGC_LinuxCd * pThis, struct urb *pUrb);
