	...
	__acquires(&xhci->lock)
{
	...
	case COMP_STALL:
		...
		xhci_warn(xhci, "cxk Stalled endpoint\n");
		ep->ep_state |= EP_HALTED;
		status = -EPIPE;
		break;
	case COMP_TRB_ERR:
	...
	case COMP_TX_ERR:
		...
		xhci_warn(xhci, "cxk Transfer error on endpoint\n");
		status = -EPROTO;
		break;
	case COMP_BABBLE:
	...
	case COMP_MISSED_INT:
		...
		xhci_warn(xhci, "cxk Miss service interval error, set skip flag\n");
		goto cleanup;
	case COMP_PING_ERR:
		ep->skip = true;
