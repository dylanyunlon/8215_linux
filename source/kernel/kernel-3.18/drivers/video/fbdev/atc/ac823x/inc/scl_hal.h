...
extern void vSclHalSetMode(__u32 u4Input, __u32 u4Output);
extern void vSclHalSetMasterMode(bool fgEnable, __u32 u4Input, __u32 u4Output);
extern void vSclHalSetMasterSrc(__u32 u4Input, __u32 u4Output);
