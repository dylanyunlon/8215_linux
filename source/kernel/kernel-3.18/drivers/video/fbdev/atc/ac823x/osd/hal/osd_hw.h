...
EXTERN __s32 _OSD_RGN_SetDataAddr(__u32 u4Region, unsigned long u4Value);
...
EXTERN __s32 _OSD_RGN_GetHandle(unsigned long u4Addr, __u32 *pu4OsdRegion);
EXTERN __s32 _OSD_RGN_GetAddress(__u32 u4Region , unsigned long *pu4Addr);
