...
#if MASTER_MODE_ENABLE
	{
		{0x5A, 0x0e, 0x0e}, /* OSD5 - remove for 8317*/
		{0x5A, 0x0e, 0x0e}, /* OSD4*/
		{0x5A, 0x0e, 0x0e}, /* OSD3*/
		{0x5A, 0x0e, 0x0e}, /* OSD2*/
		{0x5A, 0x0e, 0x0e}, /* OSD1*/
...
__s32 OSD_BASE_SetDisplayMode_InVsync(__u32 u4DisplayMode)
{
	...
	if((g_rPanelSetting.u4PanelWidth != _u4LCDWidth) || (g_rPanelSetting.u4PanelHeight != _u4LCDHeight))
	{
		...
		FB_PRINT(FB_LOG_LVL_ERR, "OSD", "not suport this solution now,u4PanelWidth&height=[%d,%d]\r\n",
			g_rPanelSetting.u4PanelWidth, g_rPanelSetting.u4PanelHeight);

	}

	FB_PRINT(FB_LOG_LVL_ERR, "OSD", "_u4DispMode=%d,u4OsdH&Vtotal=%d,%d,rOsdStartPos=[0x%x,0x%x]\r\n",
