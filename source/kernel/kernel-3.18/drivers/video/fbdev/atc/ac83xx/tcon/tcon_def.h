...
#define vWritePLVDS(dAddr, dVal)  *(volatile DWRD *)(IO_BASE_ADDRESS + PLVDSANA_REG_OFFSET + dAddr) = dVal 
#define dReadPLVDS(dAddr)         *(volatile DWRD *)(IO_BASE_ADDRESS + PLVDSANA_REG_OFFSET + dAddr)
#define vWritePLVDSMsk(dAddr, dVal, dMsk) vWritePLVDS((dAddr), (dReadPLVDS(dAddr) & (~(dMsk))) | ((dVal) & (dMsk)))
