...
#define PLVDSANA_REG_OFFSET   0xA6000 
...
//0xa6000 LVDS
#define RW_LVDSA_CTL1 (0x00)
    #define RG_LVDSA_TVO_PRE (0x7<<28)
    #define RG_LVDSA_TVO     (0xF<<0)
#define RW_LVDSA_CTL2 (0x04) 
    #define RG_LVDSA_SEL_MERGE (0x1<<29)
