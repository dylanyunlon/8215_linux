...
void SetPlaneRgnDAL(__u32 u4Plane, __u32 u4Rgn)
{
	_au4PlaneRgn[u4Plane] = u4Rgn;
}
EXPORT_SYMBOL(SetPlaneRgnDAL);




#ifndef DAL_USE
void HalFlushInvalidateDCachee(void)
{
	/*TODO: falls*/
...
void *x_alloc_aligned_dma_mem(__u32 u4Size, __u32 u4Align)
{
	...
	/*AddPaVatoMapTableDal(pa, (__u32)pVa, u4Size);*/
...
void  x_free_aligned_nc_mem_dal(void *pUser)
{
	/*TODO: falls*/
	/*FreePhysMem(pUser);*/
	ASSERT(0);
...
void *x_alloc_aligned_nc_mem_dal(__u32 u4Size, __u32 u4Align)
{
	unsigned int pa;
	void *u4Va;
