...
#define MMC_CAP2_SDIO_IRQ_NOTHREAD (1 << 17)
	...
	// Max Xia Add
#define MMC_CAP2_FUNC_EMMC		(1 << 30)	/* Host is configed for eMMC Only */
	...
	bool	sw_wp_enable;
#endif
	void	(*before_suspend)(struct mmc_host *host);
	void	(*after_resume)(struct mmc_host *host, int force);
	void	(*remove_bad_sd)(struct mmc_host *host, bool mark_bad);
