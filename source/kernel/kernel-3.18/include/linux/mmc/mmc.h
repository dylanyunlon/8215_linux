...
#define ATC_MMC_LOG_FFL(pr_level, fmt, args...)   			\
	pr_level("[MMC]%s():"fmt", @%s:%d\n", __FUNCTION__, ##args, FILE_ONLY, __LINE__)

#define ATC_MMC_LOG(pr_level, fmt, args...)				\
	pr_level("[MMC]"fmt"\n", ##args)
...
#define EXT_CSD_PART_CONFIG_BOOT_PART_MASK (0x7<<3)
#define EXT_CSD_PART_CONFIG_BOOT_PART_BOOT_DISABLE  (0x0<<3)
#define EXT_CSD_PART_CONFIG_BOOT_PART_BOOT1_ENABLE  (0x1<<3)
#define EXT_CSD_PART_CONFIG_BOOT_PART_BOOT2_ENABLE  (0x2<<3)
#define EXT_CSD_PART_CONFIG_BOOT_PART_USER_ENABLE  (0x7<<3)
