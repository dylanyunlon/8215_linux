...
#define CONFIG_MTK_RAM_CONSOLE_SIZE      ram_console_size_get()
#define CONFIG_MTK_RAM_CONSOLE_DRAM_SIZE ram_console_size_get()
#define CONFIG_MTK_RAM_CONSOLE_ADDR      ram_console_base_get()
#define CONFIG_MTK_RAM_CONSOLE_DRAM_ADDR ram_console_base_get()

#define MRDUMP_MINI_BUF_PADDR (CONFIG_MTK_RAM_CONSOLE_ADDR + 0xf0000)
