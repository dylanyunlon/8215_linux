...
#define AUD_IOCTRL_ID_START             ((__u32)0x800)
...
#define DEFINE_AUD_IOCTRL(ID)                               \
    CTL_CODE(((__u32)FILE_DEVICE_UNKNOWN), ID, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_AUDIO_GET_FRONT_TYPE                          \
    DEFINE_AUD_IOCTRL((AUD_IOCTRL_ID_START + ((__u32)0x3F)))
