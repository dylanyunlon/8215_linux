...
/**
*	@brief	Read reserved data.
*
*	   @param  pbData -- Buffer to reserved data.
*	   @param  offset -- offset in reserved area (in bytes).
*        @param  u4Size -- size of data (in bytes).
*
*        @return	 reture the read size of reserved area data if succeed or return 0.
*
*
*	@see
*	  @note
...
*       @return  return MZ_SUCCESS if succeed or other values if failure.
*
*	@see
*	  @note
**/
unsigned int MetaZone_WriteReserved_Offset(char *pbData,unsigned int offset, unsigned int u4Size);
