...
Window {
    id: bluetoothCallNavigation
    objectName: "bluetoothCallNavigation"
    flags: Qt.Window | Qt.FramelessWindowHint
    width: hideCallPage ? 320 : 819
    height: hideCallPage ? (bluetoothcallList.count > 3 ? 128 : 56 + bluetoothcallList.count * 30) : 480
    ...
    property bool   autoAnswerTimerRepeatState: true;
    ...
    Timer{
        ...
        onTriggered: {
            ...
            if (acceptCallState == needAccept) {
                console.log("[BluetoothCallNavigation]autoAnswerTimer.stop()");
    ...
    Rectangle {
        ...
        Row {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        switch (acceptCallState) {
                            case needAccept:
                            console.log("[BluetoothCallNavigation] bluetoothCallPage.acceptPhoneCall");
                            ...
                            if (showPauseButton) {
                                ...
                                console.log("[BluetoothCallNavigation] bluetoothCallPage.switchHold");
                            }
                            else {
                                bluetoothCallPage.switchAudioSource(!audioSourceInHF);
                                console.log("[BluetoothCallNavigation] bluetoothCallPage.switchAudioSource");
                            }
                            break;

                            case needAcceptAndHold:
                            console.log("[BluetoothCallNavigation] termiante and accept");
                            bluetoothCallPage.holdPhoneCall(terminateAndAcceptAction);
                            break;
                        }
            ...
            OpacityBtn {
                ...
                onClicked: {
                    console.log("[BluetoothCallNavigation] bluetoothCallPage.terminatePhoneCall");
    ...
    Rectangle {
        ...
        ListView {
            ...
            anchors.topMargin: 4
            width: 320
            height: bluetoothcallList2.count > 3 ? 90 : bluetoothcallList2.count * 30
            clip: true
            model:bluetoothCallListModel
            delegate: bluetoothCallDelegate
        }
    ...
    Component {
         ...
         OpacityBtn {
            ...
            onClicked: {
                console.log("[BluetoothCallNavigation] merge");
                bluetoothCallPage.holdPhoneCall(mergeCallAction);
            }
    ...
    Component {
        ...
        OpacityBtn {
            ...
            onClicked: {
                console.log("[BluetoothCallNavigation] switch");
                bluetoothCallPage.holdPhoneCall(switchCallAction);
            }
 ...
 Component {
    ...
    Connections {
        ...
        onBluetoothCallPageChanged: {
            console.log(" [BluetoothCallNavigation] onBluetoothCallPageChanged, wayland callPageState: "+ m_callPageState);
        }
    }

    function showHoldButton(flag) {
        console.log(" [BluetoothCallNavigation] showHoldButton " + flag);
        if (flag) {
             swapLoader.width = 117;
             mergeLoader.width = 117;
             callmenu.width = 404 + 127*2
        } else {
             swapLoader.width = 0;
             mergeLoader.width = 0;
             callmenu.width = 404
    ...
    Connections {
        target: bluetoothCallPage
        onCallListChanged: {
            console.log(" [BluetoothCallNavigation] onCallListChanged");
            ...
            if (bluetoothCallListModel.rowCount() == 1) {
                ...
                tempAcceptCallState = (bluetoothCallListModel.get(0, call_status) == qsTr("incoming")) ? needAccept : notNeedAccept;
            }

            if (bluetoothCallListModel.rowCount() > 1) {
                if (bluetoothCallListModel.hasWattingCall())
                    tempAcceptCallState = needAcceptAndHold;
                if (tempAcceptCallState != needAcceptAndHold && bluetoothCallListModel.hasHoldCall())
    ...
    Connections {
        target: bluetoothCallPage
        onScoStateChanged : {
            console.log(" [BluetoothCallNavigation] onScoStateChanged ");
            audioSourceInHF = m_audioSourceInHF;
            console.log(" [BluetoothCallNavigation] audioSourceInHF = "+audioSourceInHF);
        }
    }
    ...
    Connections {
        ...
        onTriggerAutoAnswerTimer : {
            console.log(" [BluetoothCallNavigation] onTriggerAutoAnswerTimer ");
