...
/* gbuf_mark_clipped_text and gbuf_add_ustr removed:
 * terminal UI functions not needed for embedded musicplayer.
 * They depend on clipped_text_internal, u_str_width, u_skip_chars,
 * u_copy_chars, u_str_print_size from the curses UI subsystem.
 */
