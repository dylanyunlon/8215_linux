...
class RawString;
typedef bool (*FORMULAFUNC)(const RawString &strSrc, int &nHead, int &nTail);
...
public:
    ...
    RawString(const wchar_t *wstr);
    RawString(const unsigned char *str, int strLen);
    RawString & operator=(const RawString &rhs);
    bool operator==(const RawString &rhs) const;
    bool operator!=(const RawString &rhs) const;
    RawString operator+(const RawString &rhs);
    const RawString & operator+=(const RawString &rhs);
    const RawString & operator+=(const char *str);
    const RawString & operator+=(unsigned char ch);
    const RawString & operator+=(const wchar_t *wstr);
