...
#define ATC_SINK_BUFFER_LOCK(atcsinkbuf)   pthread_mutex_lock(&((ATCVSINKBUFFER *)atcsinkbuf)->lock)
#define ATC_SINK_BUFFER_UNLOCK(atcsinkbuf)   pthread_mutex_unlock(&((ATCVSINKBUFFER *)atcsinkbuf)->lock)
