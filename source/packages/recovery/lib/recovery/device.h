...
class Device {
  public:
    ...
    enum ImageDir { IMG_DIR_SD,IMG_DIR_UDISK};
    virtual ImageDir GetImageDir() { return (IMG_DIR_SD);};

    enum BuiltinAction { NO_ACTION, REBOOT, APPLY_EXT, APPLY_CACHE,
                         APPLY_ADB_SIDELOAD, WIPE_DATA, WIPE_CACHE, CHG_IMG_DIR, 
                         UPDATE_KERNEL, UPDATE_ROOTFS, UPDATE_RECOVERY, 
                         UPDATE_METAZONE, UPDATE_LOGO, UPDATE_DVP, UPDATE_ARM2,
                         UPDATE_UBOOT, UPDATE_OTA, UPDATE_SYSTEM, UPDATE_AUTO};
    ...
    static const int typeEventIdle = 0;
    static const int typeEventKey = 1;
    static const int typeEventTouch = 2;
};
