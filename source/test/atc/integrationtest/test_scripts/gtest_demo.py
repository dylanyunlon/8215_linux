...
cmd = 'adb push test_suite/integrationtest/bin/demo_integrationtest /data '
print(cmd)
res = os.system(cmd)
if res != 0:
    exit(res)

cmd = 'adb shell "chmod -R 777 /data/demo_integrationtest"'
print(cmd)
res = os.system(cmd)
if res != 0:
    exit(res)

cmd = 'adb shell "mkdir -p /data/integrationtest/demo_integrationtest"'
print(cmd)
res = os.system(cmd)
...
cmd = 'adb shell "/data/demo_integrationtest --gtest_output=xml:/data/integrationtest/demo_integrationtest/GTest_Result_Demo_Test.xml" >log/demo_integrationtest.log 2>&1'
print(cmd)
res = os.system(cmd)

cmd = 'adb pull /data/integrationtest/demo_integrationtest/ result/'
print(cmd)
res = os.system(cmd)
if res != 0:
    exit(res)
...
resultxmlfilepath = os.path.abspath("result/demo_integrationtest/GTest_Result_Demo_Test.xml")
