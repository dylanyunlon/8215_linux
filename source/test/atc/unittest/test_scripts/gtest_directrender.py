...
cmd = 'adb push test_suite/unittest/bin/directrender_unittest /data '
print(cmd)
res = os.system(cmd)
if res != 0:
    exit(res)

cmd = 'adb shell "chmod -R 777 /data/directrender_unittest"'
print(cmd)
res = os.system(cmd)
if res != 0:
    exit(res)

cmd = 'adb shell "mkdir -p /data/unittest/directrender_unittest"'
print(cmd)
res = os.system(cmd)
...
cmd = 'adb shell "/data/directrender_unittest --gtest_output=xml:/data/unittest/directrender_unittest/GTest_Result_Directrender_Test.xml" >log/directrender_unittest.log 2>&1'
print(cmd)
res = os.system(cmd)

cmd = 'adb pull /data/unittest/directrender_unittest/ result/'
print(cmd)
res = os.system(cmd)
if res != 0:
    exit(res)
...
resultxmlfilepath = os.path.abspath("result/directrender_unittest/GTest_Result_Directrender_Test.xml")
